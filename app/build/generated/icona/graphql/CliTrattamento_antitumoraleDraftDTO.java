...
/**
 * A data structure for a draft object of class Trattamento_antitumorale.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliTrattamento_antitumoraleDraftDTO implements java.io.Serializable {
    ...
    private CliFarmaco_antitumoraleDraftRoleRefsDTO farmaco_antitumorale_;
    private String tipo_trattamento_antitumorale_;

    public CliTrattamento_antitumoraleDraftDTO() {
    }
    ...
    public CliFarmaco_antitumoraleDraftRoleRefsDTO getFarmaco_antitumorale_() {
        return farmaco_antitumorale_;
    }
    public void setFarmaco_antitumorale_(CliFarmaco_antitumoraleDraftRoleRefsDTO farmaco_antitumorale_) {
        this.farmaco_antitumorale_ = farmaco_antitumorale_;
    }

    public String getTipo_trattamento_antitumorale_() {
        return tipo_trattamento_antitumorale_;
    }
    public void setTipo_trattamento_antitumorale_(String tipo_trattamento_antitumorale_) {
    ...
    public static CliTrattamento_antitumoraleDraftDTO.Builder builder() {
        return new CliTrattamento_antitumoraleDraftDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setFarmaco_antitumorale_(CliFarmaco_antitumoraleDraftRoleRefsDTO farmaco_antitumorale_) {
            this.farmaco_antitumorale_ = farmaco_antitumorale_;
            return this;
        }

        public Builder setTipo_trattamento_antitumorale_(String tipo_trattamento_antitumorale_) {
            this.tipo_trattamento_antitumorale_ = tipo_trattamento_antitumorale_;
            return this;
        }


        public CliTrattamento_antitumoraleDraftDTO build() {
            CliTrattamento_antitumoraleDraftDTO result = new CliTrattamento_antitumoraleDraftDTO();

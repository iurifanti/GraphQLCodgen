...
/**
 * Represents a collection of objects of class Range_BMI.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliRange_BMIPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliRange_BMIDTO> items;
    ...
    public CliRange_BMIPageDTO() {
    }


    /**
     * An array containing the actual objects of class Range_BMI.
     */
    public java.util.List<CliRange_BMIDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Range_BMI.
     */
    public void setItems(java.util.List<CliRange_BMIDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Range_BMI present in the database.
     */
    ...
    public static CliRange_BMIPageDTO.Builder builder() {
        return new CliRange_BMIPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Range_BMI.
         */
        public Builder setItems(java.util.List<CliRange_BMIDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliRange_BMIPageDTO build() {
            CliRange_BMIPageDTO result = new CliRange_BMIPageDTO();

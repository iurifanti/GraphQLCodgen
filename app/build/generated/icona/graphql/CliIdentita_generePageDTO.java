...
/**
 * Represents a collection of objects of class Identita_genere.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliIdentita_generePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliIdentita_genereDTO> items;
    ...
    public CliIdentita_generePageDTO() {
    }


    /**
     * An array containing the actual objects of class Identita_genere.
     */
    public java.util.List<CliIdentita_genereDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Identita_genere.
     */
    public void setItems(java.util.List<CliIdentita_genereDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Identita_genere present in the database.
     */
    ...
    public static CliIdentita_generePageDTO.Builder builder() {
        return new CliIdentita_generePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Identita_genere.
         */
        public Builder setItems(java.util.List<CliIdentita_genereDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliIdentita_generePageDTO build() {
            CliIdentita_generePageDTO result = new CliIdentita_generePageDTO();

...
/**
 * A data structure for objects of Questionario_PRO_app.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliQuestionario_PRO_appCreateDTO implements java.io.Serializable {
    ...
    private java.util.List<CliRispostaCreateDTO> risposta_;
    @javax.validation.constraints.NotNull
    private String studio_questionario_;

    public CliQuestionario_PRO_appCreateDTO() {
    }
    ...
    public java.util.List<CliRispostaCreateDTO> getRisposta_() {
        return risposta_;
    }
    public void setRisposta_(java.util.List<CliRispostaCreateDTO> risposta_) {
    ...
    public static CliQuestionario_PRO_appCreateDTO.Builder builder() {
        return new CliQuestionario_PRO_appCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setRisposta_(java.util.List<CliRispostaCreateDTO> risposta_) {
            this.risposta_ = risposta_;
            return this;
        }
        ...
        public CliQuestionario_PRO_appCreateDTO build() {
            CliQuestionario_PRO_appCreateDTO result = new CliQuestionario_PRO_appCreateDTO();

...
/**
 * Represents a collection of objects of class Farmaco_antitumorale.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliFarmaco_antitumoralePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliFarmaco_antitumoraleDTO> items;
    ...
    public CliFarmaco_antitumoralePageDTO() {
    }


    /**
     * An array containing the actual objects of class Farmaco_antitumorale.
     */
    public java.util.List<CliFarmaco_antitumoraleDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Farmaco_antitumorale.
     */
    public void setItems(java.util.List<CliFarmaco_antitumoraleDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Farmaco_antitumorale present in the database.
     */
    ...
    public static CliFarmaco_antitumoralePageDTO.Builder builder() {
        return new CliFarmaco_antitumoralePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Farmaco_antitumorale.
         */
        public Builder setItems(java.util.List<CliFarmaco_antitumoraleDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliFarmaco_antitumoralePageDTO build() {
            CliFarmaco_antitumoralePageDTO result = new CliFarmaco_antitumoralePageDTO();

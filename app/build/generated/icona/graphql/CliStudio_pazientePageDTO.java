...
/**
 * Represents a collection of objects of class Studio_paziente.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliStudio_pazientePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliStudio_pazienteDTO> items;
    ...
    public CliStudio_pazientePageDTO() {
    }


    /**
     * An array containing the actual objects of class Studio_paziente.
     */
    public java.util.List<CliStudio_pazienteDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Studio_paziente.
     */
    public void setItems(java.util.List<CliStudio_pazienteDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Studio_paziente present in the database.
     */
    ...
    public static CliStudio_pazientePageDTO.Builder builder() {
        return new CliStudio_pazientePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Studio_paziente.
         */
        public Builder setItems(java.util.List<CliStudio_pazienteDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliStudio_pazientePageDTO build() {
            CliStudio_pazientePageDTO result = new CliStudio_pazientePageDTO();

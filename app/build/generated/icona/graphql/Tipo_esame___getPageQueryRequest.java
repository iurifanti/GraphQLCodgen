...
public class Tipo_esame___getPageQueryRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Tipo_esame___getPage";
    ...
    public Tipo_esame___getPageQueryRequest() {
    }

    public Tipo_esame___getPageQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Tipo_esame___getPageQueryRequest.Builder builder() {
        return new Tipo_esame___getPageQueryRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Tipo_esame___getPageQueryRequest build() {
            Tipo_esame___getPageQueryRequest obj = new Tipo_esame___getPageQueryRequest($alias);

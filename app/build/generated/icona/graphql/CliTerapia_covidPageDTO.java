...
/**
 * Represents a collection of objects of class Terapia_covid.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliTerapia_covidPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliTerapia_covidDTO> items;
    ...
    public CliTerapia_covidPageDTO() {
    }


    /**
     * An array containing the actual objects of class Terapia_covid.
     */
    public java.util.List<CliTerapia_covidDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Terapia_covid.
     */
    public void setItems(java.util.List<CliTerapia_covidDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Terapia_covid present in the database.
     */
    ...
    public static CliTerapia_covidPageDTO.Builder builder() {
        return new CliTerapia_covidPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Terapia_covid.
         */
        public Builder setItems(java.util.List<CliTerapia_covidDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliTerapia_covidPageDTO build() {
            CliTerapia_covidPageDTO result = new CliTerapia_covidPageDTO();

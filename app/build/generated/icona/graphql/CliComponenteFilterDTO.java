...
/**
 * Define a specific filter for objects of type Componente.
...
public class CliComponenteFilterDTO implements java.io.Serializable {
    ...
    private String classe___eq;
    private String classe___ne;
    private Boolean classe___null;
    private Boolean classe___not___null;
    private java.util.List<String> classe___in;
    private java.util.List<String> classe___not___in;
    private String classe___lt;
    private String classe___lte;
    private String classe___gt;
    private String classe___gte;
    private String classe___contains;
    private String classe___not___contains;
    private String classe___starts_with;
    private String classe___not___starts_with;
    private String classe___ends_with;
    private String classe___not___ends_with;
    ...
    private Integer codice_classe___eq;
    private Integer codice_classe___ne;
    private Boolean codice_classe___null;
    private Boolean codice_classe___not___null;
    private java.util.List<Integer> codice_classe___in;
    private java.util.List<Integer> codice_classe___not___in;
    private Integer codice_classe___lt;
    private Integer codice_classe___lte;
    private Integer codice_classe___gt;
    private Integer codice_classe___gte;
    private String desc___eq;
    private String desc___ne;
    private Boolean desc___null;
    private Boolean desc___not___null;
    private java.util.List<String> desc___in;
    private java.util.List<String> desc___not___in;
    private String desc___lt;
    private String desc___lte;
    private String desc___gt;
    private String desc___gte;
    private String desc___contains;
    private String desc___not___contains;
    private String desc___starts_with;
    private String desc___not___starts_with;
    private String desc___ends_with;
    private String desc___not___ends_with;
    ...
    private java.util.List<CliComponenteFilterDTO> AND;
    private java.util.List<CliComponenteFilterDTO> OR;
    private CliComponenteFilterDTO NOT;

    public CliComponenteFilterDTO() {
    }
    ...
    public String getClasse___eq() {
        return classe___eq;
    }
    public void setClasse___eq(String classe___eq) {
        this.classe___eq = classe___eq;
    }

    public String getClasse___ne() {
        return classe___ne;
    }
    public void setClasse___ne(String classe___ne) {
        this.classe___ne = classe___ne;
    }

    public Boolean getClasse___null() {
        return classe___null;
    }
    public void setClasse___null(Boolean classe___null) {
        this.classe___null = classe___null;
    }

    public Boolean getClasse___not___null() {
        return classe___not___null;
    }
    public void setClasse___not___null(Boolean classe___not___null) {
        this.classe___not___null = classe___not___null;
    }

    public java.util.List<String> getClasse___in() {
        return classe___in;
    }
    public void setClasse___in(java.util.List<String> classe___in) {
        this.classe___in = classe___in;
    }

    public java.util.List<String> getClasse___not___in() {
        return classe___not___in;
    }
    public void setClasse___not___in(java.util.List<String> classe___not___in) {
        this.classe___not___in = classe___not___in;
    }

    public String getClasse___lt() {
        return classe___lt;
    }
    public void setClasse___lt(String classe___lt) {
        this.classe___lt = classe___lt;
    }

    public String getClasse___lte() {
        return classe___lte;
    }
    public void setClasse___lte(String classe___lte) {
        this.classe___lte = classe___lte;
    }

    public String getClasse___gt() {
        return classe___gt;
    }
    public void setClasse___gt(String classe___gt) {
        this.classe___gt = classe___gt;
    }

    public String getClasse___gte() {
        return classe___gte;
    }
    public void setClasse___gte(String classe___gte) {
        this.classe___gte = classe___gte;
    }

    public String getClasse___contains() {
        return classe___contains;
    }
    public void setClasse___contains(String classe___contains) {
        this.classe___contains = classe___contains;
    }

    public String getClasse___not___contains() {
        return classe___not___contains;
    }
    public void setClasse___not___contains(String classe___not___contains) {
        this.classe___not___contains = classe___not___contains;
    }

    public String getClasse___starts_with() {
        return classe___starts_with;
    }
    public void setClasse___starts_with(String classe___starts_with) {
        this.classe___starts_with = classe___starts_with;
    }

    public String getClasse___not___starts_with() {
        return classe___not___starts_with;
    }
    public void setClasse___not___starts_with(String classe___not___starts_with) {
        this.classe___not___starts_with = classe___not___starts_with;
    }

    public String getClasse___ends_with() {
        return classe___ends_with;
    }
    public void setClasse___ends_with(String classe___ends_with) {
        this.classe___ends_with = classe___ends_with;
    }

    public String getClasse___not___ends_with() {
        return classe___not___ends_with;
    }
    public void setClasse___not___ends_with(String classe___not___ends_with) {
        this.classe___not___ends_with = classe___not___ends_with;
    }
    ...
    public Integer getCodice_classe___eq() {
        return codice_classe___eq;
    }
    public void setCodice_classe___eq(Integer codice_classe___eq) {
        this.codice_classe___eq = codice_classe___eq;
    }

    public Integer getCodice_classe___ne() {
        return codice_classe___ne;
    }
    public void setCodice_classe___ne(Integer codice_classe___ne) {
        this.codice_classe___ne = codice_classe___ne;
    }

    public Boolean getCodice_classe___null() {
        return codice_classe___null;
    }
    public void setCodice_classe___null(Boolean codice_classe___null) {
        this.codice_classe___null = codice_classe___null;
    }

    public Boolean getCodice_classe___not___null() {
        return codice_classe___not___null;
    }
    public void setCodice_classe___not___null(Boolean codice_classe___not___null) {
        this.codice_classe___not___null = codice_classe___not___null;
    }

    public java.util.List<Integer> getCodice_classe___in() {
        return codice_classe___in;
    }
    public void setCodice_classe___in(java.util.List<Integer> codice_classe___in) {
        this.codice_classe___in = codice_classe___in;
    }

    public java.util.List<Integer> getCodice_classe___not___in() {
        return codice_classe___not___in;
    }
    public void setCodice_classe___not___in(java.util.List<Integer> codice_classe___not___in) {
        this.codice_classe___not___in = codice_classe___not___in;
    }

    public Integer getCodice_classe___lt() {
        return codice_classe___lt;
    }
    public void setCodice_classe___lt(Integer codice_classe___lt) {
        this.codice_classe___lt = codice_classe___lt;
    }

    public Integer getCodice_classe___lte() {
        return codice_classe___lte;
    }
    public void setCodice_classe___lte(Integer codice_classe___lte) {
        this.codice_classe___lte = codice_classe___lte;
    }

    public Integer getCodice_classe___gt() {
        return codice_classe___gt;
    }
    public void setCodice_classe___gt(Integer codice_classe___gt) {
        this.codice_classe___gt = codice_classe___gt;
    }

    public Integer getCodice_classe___gte() {
        return codice_classe___gte;
    }
    public void setCodice_classe___gte(Integer codice_classe___gte) {
        this.codice_classe___gte = codice_classe___gte;
    }

    public String getDesc___eq() {
        return desc___eq;
    }
    public void setDesc___eq(String desc___eq) {
        this.desc___eq = desc___eq;
    }

    public String getDesc___ne() {
        return desc___ne;
    }
    public void setDesc___ne(String desc___ne) {
        this.desc___ne = desc___ne;
    }

    public Boolean getDesc___null() {
        return desc___null;
    }
    public void setDesc___null(Boolean desc___null) {
        this.desc___null = desc___null;
    }

    public Boolean getDesc___not___null() {
        return desc___not___null;
    }
    public void setDesc___not___null(Boolean desc___not___null) {
        this.desc___not___null = desc___not___null;
    }

    public java.util.List<String> getDesc___in() {
        return desc___in;
    }
    public void setDesc___in(java.util.List<String> desc___in) {
        this.desc___in = desc___in;
    }

    public java.util.List<String> getDesc___not___in() {
        return desc___not___in;
    }
    public void setDesc___not___in(java.util.List<String> desc___not___in) {
        this.desc___not___in = desc___not___in;
    }

    public String getDesc___lt() {
        return desc___lt;
    }
    public void setDesc___lt(String desc___lt) {
        this.desc___lt = desc___lt;
    }

    public String getDesc___lte() {
        return desc___lte;
    }
    public void setDesc___lte(String desc___lte) {
        this.desc___lte = desc___lte;
    }

    public String getDesc___gt() {
        return desc___gt;
    }
    public void setDesc___gt(String desc___gt) {
        this.desc___gt = desc___gt;
    }

    public String getDesc___gte() {
        return desc___gte;
    }
    public void setDesc___gte(String desc___gte) {
        this.desc___gte = desc___gte;
    }

    public String getDesc___contains() {
        return desc___contains;
    }
    public void setDesc___contains(String desc___contains) {
        this.desc___contains = desc___contains;
    }

    public String getDesc___not___contains() {
        return desc___not___contains;
    }
    public void setDesc___not___contains(String desc___not___contains) {
        this.desc___not___contains = desc___not___contains;
    }

    public String getDesc___starts_with() {
        return desc___starts_with;
    }
    public void setDesc___starts_with(String desc___starts_with) {
        this.desc___starts_with = desc___starts_with;
    }

    public String getDesc___not___starts_with() {
        return desc___not___starts_with;
    }
    public void setDesc___not___starts_with(String desc___not___starts_with) {
        this.desc___not___starts_with = desc___not___starts_with;
    }

    public String getDesc___ends_with() {
        return desc___ends_with;
    }
    public void setDesc___ends_with(String desc___ends_with) {
        this.desc___ends_with = desc___ends_with;
    }

    public String getDesc___not___ends_with() {
        return desc___not___ends_with;
    }
    public void setDesc___not___ends_with(String desc___not___ends_with) {
        this.desc___not___ends_with = desc___not___ends_with;
    }
    ...
    public java.util.List<CliComponenteFilterDTO> getAND() {
        return AND;
    }
    public void setAND(java.util.List<CliComponenteFilterDTO> AND) {
        this.AND = AND;
    }

    public java.util.List<CliComponenteFilterDTO> getOR() {
        return OR;
    }
    public void setOR(java.util.List<CliComponenteFilterDTO> OR) {
        this.OR = OR;
    }

    public CliComponenteFilterDTO getNOT() {
        return NOT;
    }
    public void setNOT(CliComponenteFilterDTO NOT) {
        this.NOT = NOT;
    }
    ...
    public String toString() {
        ...
        if (classe___eq != null) {
            joiner.add("classe___eq: " + GraphQLRequestSerializer.getEntry(classe___eq));
        }
        if (classe___ne != null) {
            joiner.add("classe___ne: " + GraphQLRequestSerializer.getEntry(classe___ne));
        }
        if (classe___null != null) {
            joiner.add("classe___null: " + GraphQLRequestSerializer.getEntry(classe___null));
        }
        if (classe___not___null != null) {
            joiner.add("classe___not___null: " + GraphQLRequestSerializer.getEntry(classe___not___null));
        }
        if (classe___in != null) {
            joiner.add("classe___in: " + GraphQLRequestSerializer.getEntry(classe___in));
        }
        if (classe___not___in != null) {
            joiner.add("classe___not___in: " + GraphQLRequestSerializer.getEntry(classe___not___in));
        }
        if (classe___lt != null) {
            joiner.add("classe___lt: " + GraphQLRequestSerializer.getEntry(classe___lt));
        }
        if (classe___lte != null) {
            joiner.add("classe___lte: " + GraphQLRequestSerializer.getEntry(classe___lte));
        }
        if (classe___gt != null) {
            joiner.add("classe___gt: " + GraphQLRequestSerializer.getEntry(classe___gt));
        }
        if (classe___gte != null) {
            joiner.add("classe___gte: " + GraphQLRequestSerializer.getEntry(classe___gte));
        }
        if (classe___contains != null) {
            joiner.add("classe___contains: " + GraphQLRequestSerializer.getEntry(classe___contains));
        }
        if (classe___not___contains != null) {
            joiner.add("classe___not___contains: " + GraphQLRequestSerializer.getEntry(classe___not___contains));
        }
        if (classe___starts_with != null) {
            joiner.add("classe___starts_with: " + GraphQLRequestSerializer.getEntry(classe___starts_with));
        }
        if (classe___not___starts_with != null) {
            joiner.add("classe___not___starts_with: " + GraphQLRequestSerializer.getEntry(classe___not___starts_with));
        }
        if (classe___ends_with != null) {
            joiner.add("classe___ends_with: " + GraphQLRequestSerializer.getEntry(classe___ends_with));
        }
        if (classe___not___ends_with != null) {
            joiner.add("classe___not___ends_with: " + GraphQLRequestSerializer.getEntry(classe___not___ends_with));
        }
        if (codice___eq != null) {
        ...
        if (codice_classe___eq != null) {
            joiner.add("codice_classe___eq: " + GraphQLRequestSerializer.getEntry(codice_classe___eq));
        }
        if (codice_classe___ne != null) {
            joiner.add("codice_classe___ne: " + GraphQLRequestSerializer.getEntry(codice_classe___ne));
        }
        if (codice_classe___null != null) {
            joiner.add("codice_classe___null: " + GraphQLRequestSerializer.getEntry(codice_classe___null));
        }
        if (codice_classe___not___null != null) {
            joiner.add("codice_classe___not___null: " + GraphQLRequestSerializer.getEntry(codice_classe___not___null));
        }
        if (codice_classe___in != null) {
            joiner.add("codice_classe___in: " + GraphQLRequestSerializer.getEntry(codice_classe___in));
        }
        if (codice_classe___not___in != null) {
            joiner.add("codice_classe___not___in: " + GraphQLRequestSerializer.getEntry(codice_classe___not___in));
        }
        if (codice_classe___lt != null) {
            joiner.add("codice_classe___lt: " + GraphQLRequestSerializer.getEntry(codice_classe___lt));
        }
        if (codice_classe___lte != null) {
            joiner.add("codice_classe___lte: " + GraphQLRequestSerializer.getEntry(codice_classe___lte));
        }
        if (codice_classe___gt != null) {
            joiner.add("codice_classe___gt: " + GraphQLRequestSerializer.getEntry(codice_classe___gt));
        }
        if (codice_classe___gte != null) {
            joiner.add("codice_classe___gte: " + GraphQLRequestSerializer.getEntry(codice_classe___gte));
        }
        if (desc___eq != null) {
            joiner.add("desc___eq: " + GraphQLRequestSerializer.getEntry(desc___eq));
        }
        if (desc___ne != null) {
            joiner.add("desc___ne: " + GraphQLRequestSerializer.getEntry(desc___ne));
        }
        if (desc___null != null) {
            joiner.add("desc___null: " + GraphQLRequestSerializer.getEntry(desc___null));
        }
        if (desc___not___null != null) {
            joiner.add("desc___not___null: " + GraphQLRequestSerializer.getEntry(desc___not___null));
        }
        if (desc___in != null) {
            joiner.add("desc___in: " + GraphQLRequestSerializer.getEntry(desc___in));
        }
        if (desc___not___in != null) {
            joiner.add("desc___not___in: " + GraphQLRequestSerializer.getEntry(desc___not___in));
        }
        if (desc___lt != null) {
            joiner.add("desc___lt: " + GraphQLRequestSerializer.getEntry(desc___lt));
        }
        if (desc___lte != null) {
            joiner.add("desc___lte: " + GraphQLRequestSerializer.getEntry(desc___lte));
        }
        if (desc___gt != null) {
            joiner.add("desc___gt: " + GraphQLRequestSerializer.getEntry(desc___gt));
        }
        if (desc___gte != null) {
            joiner.add("desc___gte: " + GraphQLRequestSerializer.getEntry(desc___gte));
        }
        if (desc___contains != null) {
            joiner.add("desc___contains: " + GraphQLRequestSerializer.getEntry(desc___contains));
        }
        if (desc___not___contains != null) {
            joiner.add("desc___not___contains: " + GraphQLRequestSerializer.getEntry(desc___not___contains));
        }
        if (desc___starts_with != null) {
            joiner.add("desc___starts_with: " + GraphQLRequestSerializer.getEntry(desc___starts_with));
        }
        if (desc___not___starts_with != null) {
            joiner.add("desc___not___starts_with: " + GraphQLRequestSerializer.getEntry(desc___not___starts_with));
        }
        if (desc___ends_with != null) {
            joiner.add("desc___ends_with: " + GraphQLRequestSerializer.getEntry(desc___ends_with));
        }
        if (desc___not___ends_with != null) {
            joiner.add("desc___not___ends_with: " + GraphQLRequestSerializer.getEntry(desc___not___ends_with));
        }
        if (nome___eq != null) {
    ...
    public static CliComponenteFilterDTO.Builder builder() {
        return new CliComponenteFilterDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setClasse___eq(String classe___eq) {
            this.classe___eq = classe___eq;
            return this;
        }

        public Builder setClasse___ne(String classe___ne) {
            this.classe___ne = classe___ne;
            return this;
        }

        public Builder setClasse___null(Boolean classe___null) {
            this.classe___null = classe___null;
            return this;
        }

        public Builder setClasse___not___null(Boolean classe___not___null) {
            this.classe___not___null = classe___not___null;
            return this;
        }

        public Builder setClasse___in(java.util.List<String> classe___in) {
            this.classe___in = classe___in;
            return this;
        }

        public Builder setClasse___not___in(java.util.List<String> classe___not___in) {
            this.classe___not___in = classe___not___in;
            return this;
        }

        public Builder setClasse___lt(String classe___lt) {
            this.classe___lt = classe___lt;
            return this;
        }

        public Builder setClasse___lte(String classe___lte) {
            this.classe___lte = classe___lte;
            return this;
        }

        public Builder setClasse___gt(String classe___gt) {
            this.classe___gt = classe___gt;
            return this;
        }

        public Builder setClasse___gte(String classe___gte) {
            this.classe___gte = classe___gte;
            return this;
        }

        public Builder setClasse___contains(String classe___contains) {
            this.classe___contains = classe___contains;
            return this;
        }

        public Builder setClasse___not___contains(String classe___not___contains) {
            this.classe___not___contains = classe___not___contains;
            return this;
        }

        public Builder setClasse___starts_with(String classe___starts_with) {
            this.classe___starts_with = classe___starts_with;
            return this;
        }

        public Builder setClasse___not___starts_with(String classe___not___starts_with) {
            this.classe___not___starts_with = classe___not___starts_with;
            return this;
        }

        public Builder setClasse___ends_with(String classe___ends_with) {
            this.classe___ends_with = classe___ends_with;
            return this;
        }

        public Builder setClasse___not___ends_with(String classe___not___ends_with) {
            this.classe___not___ends_with = classe___not___ends_with;
            return this;
        }
        ...
        public Builder setCodice_classe___eq(Integer codice_classe___eq) {
            this.codice_classe___eq = codice_classe___eq;
            return this;
        }

        public Builder setCodice_classe___ne(Integer codice_classe___ne) {
            this.codice_classe___ne = codice_classe___ne;
            return this;
        }

        public Builder setCodice_classe___null(Boolean codice_classe___null) {
            this.codice_classe___null = codice_classe___null;
            return this;
        }

        public Builder setCodice_classe___not___null(Boolean codice_classe___not___null) {
            this.codice_classe___not___null = codice_classe___not___null;
            return this;
        }

        public Builder setCodice_classe___in(java.util.List<Integer> codice_classe___in) {
            this.codice_classe___in = codice_classe___in;
            return this;
        }

        public Builder setCodice_classe___not___in(java.util.List<Integer> codice_classe___not___in) {
            this.codice_classe___not___in = codice_classe___not___in;
            return this;
        }

        public Builder setCodice_classe___lt(Integer codice_classe___lt) {
            this.codice_classe___lt = codice_classe___lt;
            return this;
        }

        public Builder setCodice_classe___lte(Integer codice_classe___lte) {
            this.codice_classe___lte = codice_classe___lte;
            return this;
        }

        public Builder setCodice_classe___gt(Integer codice_classe___gt) {
            this.codice_classe___gt = codice_classe___gt;
            return this;
        }

        public Builder setCodice_classe___gte(Integer codice_classe___gte) {
            this.codice_classe___gte = codice_classe___gte;
            return this;
        }

        public Builder setDesc___eq(String desc___eq) {
            this.desc___eq = desc___eq;
            return this;
        }

        public Builder setDesc___ne(String desc___ne) {
            this.desc___ne = desc___ne;
            return this;
        }

        public Builder setDesc___null(Boolean desc___null) {
            this.desc___null = desc___null;
            return this;
        }

        public Builder setDesc___not___null(Boolean desc___not___null) {
            this.desc___not___null = desc___not___null;
            return this;
        }

        public Builder setDesc___in(java.util.List<String> desc___in) {
            this.desc___in = desc___in;
            return this;
        }

        public Builder setDesc___not___in(java.util.List<String> desc___not___in) {
            this.desc___not___in = desc___not___in;
            return this;
        }

        public Builder setDesc___lt(String desc___lt) {
            this.desc___lt = desc___lt;
            return this;
        }

        public Builder setDesc___lte(String desc___lte) {
            this.desc___lte = desc___lte;
            return this;
        }

        public Builder setDesc___gt(String desc___gt) {
            this.desc___gt = desc___gt;
            return this;
        }

        public Builder setDesc___gte(String desc___gte) {
            this.desc___gte = desc___gte;
            return this;
        }

        public Builder setDesc___contains(String desc___contains) {
            this.desc___contains = desc___contains;
            return this;
        }

        public Builder setDesc___not___contains(String desc___not___contains) {
            this.desc___not___contains = desc___not___contains;
            return this;
        }

        public Builder setDesc___starts_with(String desc___starts_with) {
            this.desc___starts_with = desc___starts_with;
            return this;
        }

        public Builder setDesc___not___starts_with(String desc___not___starts_with) {
            this.desc___not___starts_with = desc___not___starts_with;
            return this;
        }

        public Builder setDesc___ends_with(String desc___ends_with) {
            this.desc___ends_with = desc___ends_with;
            return this;
        }

        public Builder setDesc___not___ends_with(String desc___not___ends_with) {
            this.desc___not___ends_with = desc___not___ends_with;
            return this;
        }
        ...
        public Builder setAND(java.util.List<CliComponenteFilterDTO> AND) {
            this.AND = AND;
            return this;
        }

        public Builder setOR(java.util.List<CliComponenteFilterDTO> OR) {
            this.OR = OR;
            return this;
        }

        public Builder setNOT(CliComponenteFilterDTO NOT) {
            this.NOT = NOT;
            return this;
        }


        public CliComponenteFilterDTO build() {
            CliComponenteFilterDTO result = new CliComponenteFilterDTO();
            ...
            result.setClasse___eq(this.classe___eq);
            result.setClasse___ne(this.classe___ne);
            result.setClasse___null(this.classe___null);
            result.setClasse___not___null(this.classe___not___null);
            result.setClasse___in(this.classe___in);
            result.setClasse___not___in(this.classe___not___in);
            result.setClasse___lt(this.classe___lt);
            result.setClasse___lte(this.classe___lte);
            result.setClasse___gt(this.classe___gt);
            result.setClasse___gte(this.classe___gte);
            result.setClasse___contains(this.classe___contains);
            result.setClasse___not___contains(this.classe___not___contains);
            result.setClasse___starts_with(this.classe___starts_with);
            result.setClasse___not___starts_with(this.classe___not___starts_with);
            result.setClasse___ends_with(this.classe___ends_with);
            result.setClasse___not___ends_with(this.classe___not___ends_with);
            ...
            result.setCodice_classe___eq(this.codice_classe___eq);
            result.setCodice_classe___ne(this.codice_classe___ne);
            result.setCodice_classe___null(this.codice_classe___null);
            result.setCodice_classe___not___null(this.codice_classe___not___null);
            result.setCodice_classe___in(this.codice_classe___in);
            result.setCodice_classe___not___in(this.codice_classe___not___in);
            result.setCodice_classe___lt(this.codice_classe___lt);
            result.setCodice_classe___lte(this.codice_classe___lte);
            result.setCodice_classe___gt(this.codice_classe___gt);
            result.setCodice_classe___gte(this.codice_classe___gte);
            result.setDesc___eq(this.desc___eq);
            result.setDesc___ne(this.desc___ne);
            result.setDesc___null(this.desc___null);
            result.setDesc___not___null(this.desc___not___null);
            result.setDesc___in(this.desc___in);
            result.setDesc___not___in(this.desc___not___in);
            result.setDesc___lt(this.desc___lt);
            result.setDesc___lte(this.desc___lte);
            result.setDesc___gt(this.desc___gt);
            result.setDesc___gte(this.desc___gte);
            result.setDesc___contains(this.desc___contains);
            result.setDesc___not___contains(this.desc___not___contains);
            result.setDesc___starts_with(this.desc___starts_with);
            result.setDesc___not___starts_with(this.desc___not___starts_with);
            result.setDesc___ends_with(this.desc___ends_with);
            result.setDesc___not___ends_with(this.desc___not___ends_with);

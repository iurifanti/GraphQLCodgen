...
/**
 * Represents a collection of objects of class Codice_studio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliCodice_studioPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliCodice_studioDTO> items;
    ...
    public CliCodice_studioPageDTO() {
    }


    /**
     * An array containing the actual objects of class Codice_studio.
     */
    public java.util.List<CliCodice_studioDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Codice_studio.
     */
    public void setItems(java.util.List<CliCodice_studioDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Codice_studio present in the database.
     */
    ...
    public static CliCodice_studioPageDTO.Builder builder() {
        return new CliCodice_studioPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Codice_studio.
         */
        public Builder setItems(java.util.List<CliCodice_studioDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliCodice_studioPageDTO build() {
            CliCodice_studioPageDTO result = new CliCodice_studioPageDTO();

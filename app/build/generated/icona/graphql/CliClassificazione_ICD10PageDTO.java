...
/**
 * Represents a collection of objects of class Classificazione_ICD10.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliClassificazione_ICD10PageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliClassificazione_ICD10DTO> items;
    ...
    public CliClassificazione_ICD10PageDTO() {
    }


    /**
     * An array containing the actual objects of class Classificazione_ICD10.
     */
    public java.util.List<CliClassificazione_ICD10DTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Classificazione_ICD10.
     */
    public void setItems(java.util.List<CliClassificazione_ICD10DTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Classificazione_ICD10 present in the database.
     */
    ...
    public static CliClassificazione_ICD10PageDTO.Builder builder() {
        return new CliClassificazione_ICD10PageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Classificazione_ICD10.
         */
        public Builder setItems(java.util.List<CliClassificazione_ICD10DTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliClassificazione_ICD10PageDTO build() {
            CliClassificazione_ICD10PageDTO result = new CliClassificazione_ICD10PageDTO();

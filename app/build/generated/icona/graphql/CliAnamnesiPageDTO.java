...
/**
 * Represents a collection of objects of class Anamnesi.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliAnamnesiPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliAnamnesiDTO> items;
    ...
    public CliAnamnesiPageDTO() {
    }


    /**
     * An array containing the actual objects of class Anamnesi.
     */
    public java.util.List<CliAnamnesiDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Anamnesi.
     */
    public void setItems(java.util.List<CliAnamnesiDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Anamnesi present in the database.
     */
    ...
    public static CliAnamnesiPageDTO.Builder builder() {
        return new CliAnamnesiPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Anamnesi.
         */
        public Builder setItems(java.util.List<CliAnamnesiDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliAnamnesiPageDTO build() {
            CliAnamnesiPageDTO result = new CliAnamnesiPageDTO();

...
/**
 * A data structure for a draft update objects of class Markers_HDV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliMarkers_HDVDraftUpdateBulkDTO implements java.io.Serializable {
    ...
    private CliMetodica_genoma_HCV_HBVRoleRefDTO metodica_genoma_HDV;
    private CliUnita_di_misura_viremiaRoleRefDTO unita_di_misura_viremia_;

    public CliMarkers_HDVDraftUpdateBulkDTO() {
    }
    ...
    public CliMetodica_genoma_HCV_HBVRoleRefDTO getMetodica_genoma_HDV() {
        return metodica_genoma_HDV;
    }
    public void setMetodica_genoma_HDV(CliMetodica_genoma_HCV_HBVRoleRefDTO metodica_genoma_HDV) {
        this.metodica_genoma_HDV = metodica_genoma_HDV;
    }

    public CliUnita_di_misura_viremiaRoleRefDTO getUnita_di_misura_viremia_() {
        return unita_di_misura_viremia_;
    }
    public void setUnita_di_misura_viremia_(CliUnita_di_misura_viremiaRoleRefDTO unita_di_misura_viremia_) {
    ...
    public static CliMarkers_HDVDraftUpdateBulkDTO.Builder builder() {
        return new CliMarkers_HDVDraftUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setMetodica_genoma_HDV(CliMetodica_genoma_HCV_HBVRoleRefDTO metodica_genoma_HDV) {
            this.metodica_genoma_HDV = metodica_genoma_HDV;
            return this;
        }

        public Builder setUnita_di_misura_viremia_(CliUnita_di_misura_viremiaRoleRefDTO unita_di_misura_viremia_) {
            this.unita_di_misura_viremia_ = unita_di_misura_viremia_;
            return this;
        }


        public CliMarkers_HDVDraftUpdateBulkDTO build() {
            CliMarkers_HDVDraftUpdateBulkDTO result = new CliMarkers_HDVDraftUpdateBulkDTO();

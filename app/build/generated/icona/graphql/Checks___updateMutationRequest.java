...
public class Checks___updateMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Checks___update";
    ...
    public Checks___updateMutationRequest() {
    }

    public Checks___updateMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliChecksUpdateDTO data) {
    ...
    public static Checks___updateMutationRequest.Builder builder() {
        return new Checks___updateMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliChecksUpdateDTO data;
        ...
        public Builder setData(CliChecksUpdateDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Checks___updateMutationRequest build() {
            Checks___updateMutationRequest obj = new Checks___updateMutationRequest($alias);
            obj.setData(data);

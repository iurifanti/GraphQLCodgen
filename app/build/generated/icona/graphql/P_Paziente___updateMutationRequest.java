...
public class P_Paziente___updateMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "P_Paziente___update";
    ...
    public P_Paziente___updateMutationRequest() {
    }

    public P_Paziente___updateMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliP_PazienteUpdateDTO data) {
    ...
    public static P_Paziente___updateMutationRequest.Builder builder() {
        return new P_Paziente___updateMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliP_PazienteUpdateDTO data;
        ...
        public Builder setData(CliP_PazienteUpdateDTO data) {
            this.data = data;
            return this;
        }
        ...
        public P_Paziente___updateMutationRequest build() {
            P_Paziente___updateMutationRequest obj = new P_Paziente___updateMutationRequest($alias);
            obj.setData(data);

...
/**
 * Represents a collection of objects of class Gravidanza.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliGravidanzaPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliGravidanzaDTO> items;
    ...
    public CliGravidanzaPageDTO() {
    }


    /**
     * An array containing the actual objects of class Gravidanza.
     */
    public java.util.List<CliGravidanzaDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Gravidanza.
     */
    public void setItems(java.util.List<CliGravidanzaDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Gravidanza present in the database.
     */
    ...
    public static CliGravidanzaPageDTO.Builder builder() {
        return new CliGravidanzaPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Gravidanza.
         */
        public Builder setItems(java.util.List<CliGravidanzaDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliGravidanzaPageDTO build() {
            CliGravidanzaPageDTO result = new CliGravidanzaPageDTO();

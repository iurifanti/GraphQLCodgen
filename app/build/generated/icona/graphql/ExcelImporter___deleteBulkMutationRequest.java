...
public class ExcelImporter___deleteBulkMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "ExcelImporter___deleteBulk";
    ...
    public ExcelImporter___deleteBulkMutationRequest() {
    }

    public ExcelImporter___deleteBulkMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static ExcelImporter___deleteBulkMutationRequest.Builder builder() {
        return new ExcelImporter___deleteBulkMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public ExcelImporter___deleteBulkMutationRequest build() {
            ExcelImporter___deleteBulkMutationRequest obj = new ExcelImporter___deleteBulkMutationRequest($alias);

...
/**
 * Represents a collection of objects of class Tipo_trattamento_antitumorale.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliTipo_trattamento_antitumoralePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliTipo_trattamento_antitumoraleDTO> items;
    ...
    public CliTipo_trattamento_antitumoralePageDTO() {
    }


    /**
     * An array containing the actual objects of class Tipo_trattamento_antitumorale.
     */
    public java.util.List<CliTipo_trattamento_antitumoraleDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Tipo_trattamento_antitumorale.
     */
    public void setItems(java.util.List<CliTipo_trattamento_antitumoraleDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Tipo_trattamento_antitumorale present in the database.
     */
    ...
    public static CliTipo_trattamento_antitumoralePageDTO.Builder builder() {
        return new CliTipo_trattamento_antitumoralePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Tipo_trattamento_antitumorale.
         */
        public Builder setItems(java.util.List<CliTipo_trattamento_antitumoraleDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliTipo_trattamento_antitumoralePageDTO build() {
            CliTipo_trattamento_antitumoralePageDTO result = new CliTipo_trattamento_antitumoralePageDTO();

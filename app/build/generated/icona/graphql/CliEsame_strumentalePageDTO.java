...
/**
 * Represents a collection of objects of class Esame_strumentale.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliEsame_strumentalePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliEsame_strumentaleDTO> items;
    ...
    public CliEsame_strumentalePageDTO() {
    }


    /**
     * An array containing the actual objects of class Esame_strumentale.
     */
    public java.util.List<CliEsame_strumentaleDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Esame_strumentale.
     */
    public void setItems(java.util.List<CliEsame_strumentaleDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Esame_strumentale present in the database.
     */
    ...
    public static CliEsame_strumentalePageDTO.Builder builder() {
        return new CliEsame_strumentalePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Esame_strumentale.
         */
        public Builder setItems(java.util.List<CliEsame_strumentaleDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliEsame_strumentalePageDTO build() {
            CliEsame_strumentalePageDTO result = new CliEsame_strumentalePageDTO();

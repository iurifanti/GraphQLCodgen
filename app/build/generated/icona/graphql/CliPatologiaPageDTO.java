...
/**
 * Represents a collection of objects of class Patologia.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliPatologiaPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliPatologiaDTO> items;
    ...
    public CliPatologiaPageDTO() {
    }


    /**
     * An array containing the actual objects of class Patologia.
     */
    public java.util.List<CliPatologiaDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Patologia.
     */
    public void setItems(java.util.List<CliPatologiaDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Patologia present in the database.
     */
    ...
    public static CliPatologiaPageDTO.Builder builder() {
        return new CliPatologiaPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Patologia.
         */
        public Builder setItems(java.util.List<CliPatologiaDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliPatologiaPageDTO build() {
            CliPatologiaPageDTO result = new CliPatologiaPageDTO();

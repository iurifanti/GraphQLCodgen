...
/**
 * Represents a collection of objects of class Nazione.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliNazionePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliNazioneDTO> items;
    ...
    public CliNazionePageDTO() {
    }


    /**
     * An array containing the actual objects of class Nazione.
     */
    public java.util.List<CliNazioneDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Nazione.
     */
    public void setItems(java.util.List<CliNazioneDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Nazione present in the database.
     */
    ...
    public static CliNazionePageDTO.Builder builder() {
        return new CliNazionePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Nazione.
         */
        public Builder setItems(java.util.List<CliNazioneDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliNazionePageDTO build() {
            CliNazionePageDTO result = new CliNazionePageDTO();

...
/**
 * Represents a collection of objects of class Motivazioni_seconda_dose.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliMotivazioni_seconda_dosePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliMotivazioni_seconda_doseDTO> items;
    ...
    public CliMotivazioni_seconda_dosePageDTO() {
    }


    /**
     * An array containing the actual objects of class Motivazioni_seconda_dose.
     */
    public java.util.List<CliMotivazioni_seconda_doseDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Motivazioni_seconda_dose.
     */
    public void setItems(java.util.List<CliMotivazioni_seconda_doseDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Motivazioni_seconda_dose present in the database.
     */
    ...
    public static CliMotivazioni_seconda_dosePageDTO.Builder builder() {
        return new CliMotivazioni_seconda_dosePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Motivazioni_seconda_dose.
         */
        public Builder setItems(java.util.List<CliMotivazioni_seconda_doseDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliMotivazioni_seconda_dosePageDTO build() {
            CliMotivazioni_seconda_dosePageDTO result = new CliMotivazioni_seconda_dosePageDTO();

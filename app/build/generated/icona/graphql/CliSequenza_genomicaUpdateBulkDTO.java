...
/**
 * A data structure for objects of class Sequenza_genomica.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliSequenza_genomicaUpdateBulkDTO implements java.io.Serializable {
    ...
    private CliMutazioneRoleObjectsDTO mutazione;
    private CliPazienteRoleRefDTO paziente;

    public CliSequenza_genomicaUpdateBulkDTO() {
    }
    ...
    public CliMutazioneRoleObjectsDTO getMutazione() {
        return mutazione;
    }
    public void setMutazione(CliMutazioneRoleObjectsDTO mutazione) {
    ...
    public static CliSequenza_genomicaUpdateBulkDTO.Builder builder() {
        return new CliSequenza_genomicaUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setMutazione(CliMutazioneRoleObjectsDTO mutazione) {
            this.mutazione = mutazione;
            return this;
        }
        ...
        public CliSequenza_genomicaUpdateBulkDTO build() {
            CliSequenza_genomicaUpdateBulkDTO result = new CliSequenza_genomicaUpdateBulkDTO();

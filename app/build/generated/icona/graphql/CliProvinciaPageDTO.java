...
/**
 * Represents a collection of objects of class Provincia.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliProvinciaPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliProvinciaDTO> items;
    ...
    public CliProvinciaPageDTO() {
    }


    /**
     * An array containing the actual objects of class Provincia.
     */
    public java.util.List<CliProvinciaDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Provincia.
     */
    public void setItems(java.util.List<CliProvinciaDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Provincia present in the database.
     */
    ...
    public static CliProvinciaPageDTO.Builder builder() {
        return new CliProvinciaPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Provincia.
         */
        public Builder setItems(java.util.List<CliProvinciaDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliProvinciaPageDTO build() {
            CliProvinciaPageDTO result = new CliProvinciaPageDTO();

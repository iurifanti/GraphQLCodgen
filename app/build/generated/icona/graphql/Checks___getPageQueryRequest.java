...
public class Checks___getPageQueryRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Checks___getPage";
    ...
    public Checks___getPageQueryRequest() {
    }

    public Checks___getPageQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Checks___getPageQueryRequest.Builder builder() {
        return new Checks___getPageQueryRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Checks___getPageQueryRequest build() {
            Checks___getPageQueryRequest obj = new Checks___getPageQueryRequest($alias);

...
public class CliEventoDraftRoleObjectsDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    private java.util.List<CliEventoDraftDTO> save;
    private java.util.List<String> delete;
    private Boolean deleteAll;

    public CliEventoDraftRoleObjectsDTO() {
    }


    public java.util.List<CliEventoDraftDTO> getSave() {
        return save;
    }
    public void setSave(java.util.List<CliEventoDraftDTO> save) {
        this.save = save;
    }
    ...
    public static CliEventoDraftRoleObjectsDTO.Builder builder() {
        return new CliEventoDraftRoleObjectsDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setSave(java.util.List<CliEventoDraftDTO> save) {
            this.save = save;
            return this;
        }
        ...
        public CliEventoDraftRoleObjectsDTO build() {
            CliEventoDraftRoleObjectsDTO result = new CliEventoDraftRoleObjectsDTO();

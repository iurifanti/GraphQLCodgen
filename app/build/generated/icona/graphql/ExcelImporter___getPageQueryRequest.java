...
public class ExcelImporter___getPageQueryRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "ExcelImporter___getPage";
    ...
    public ExcelImporter___getPageQueryRequest() {
    }

    public ExcelImporter___getPageQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static ExcelImporter___getPageQueryRequest.Builder builder() {
        return new ExcelImporter___getPageQueryRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public ExcelImporter___getPageQueryRequest build() {
            ExcelImporter___getPageQueryRequest obj = new ExcelImporter___getPageQueryRequest($alias);

...
public class Checks___saveMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Checks___save";
    ...
    public Checks___saveMutationRequest() {
    }

    public Checks___saveMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Checks___saveMutationRequest.Builder builder() {
        return new Checks___saveMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Checks___saveMutationRequest build() {
            Checks___saveMutationRequest obj = new Checks___saveMutationRequest($alias);
            obj.setData(data);

...
/**
 * Represents a collection of objects of class Farmaco_ATC.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliFarmaco_ATCPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliFarmaco_ATCDTO> items;
    ...
    public CliFarmaco_ATCPageDTO() {
    }


    /**
     * An array containing the actual objects of class Farmaco_ATC.
     */
    public java.util.List<CliFarmaco_ATCDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Farmaco_ATC.
     */
    public void setItems(java.util.List<CliFarmaco_ATCDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Farmaco_ATC present in the database.
     */
    ...
    public static CliFarmaco_ATCPageDTO.Builder builder() {
        return new CliFarmaco_ATCPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Farmaco_ATC.
         */
        public Builder setItems(java.util.List<CliFarmaco_ATCDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliFarmaco_ATCPageDTO build() {
            CliFarmaco_ATCPageDTO result = new CliFarmaco_ATCPageDTO();

...
/**
 * Represents a collection of objects of class Risposta.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliRispostaPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliRispostaDTO> items;
    ...
    public CliRispostaPageDTO() {
    }


    /**
     * An array containing the actual objects of class Risposta.
     */
    public java.util.List<CliRispostaDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Risposta.
     */
    public void setItems(java.util.List<CliRispostaDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Risposta present in the database.
     */
    ...
    public static CliRispostaPageDTO.Builder builder() {
        return new CliRispostaPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Risposta.
         */
        public Builder setItems(java.util.List<CliRispostaDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliRispostaPageDTO build() {
            CliRispostaPageDTO result = new CliRispostaPageDTO();

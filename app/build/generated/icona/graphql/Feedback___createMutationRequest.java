...
public class Feedback___createMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Feedback___create";
    ...
    public Feedback___createMutationRequest() {
    }

    public Feedback___createMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliFeedbackCreateDTO data) {
    ...
    public static Feedback___createMutationRequest.Builder builder() {
        return new Feedback___createMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliFeedbackCreateDTO data;
        ...
        public Builder setData(CliFeedbackCreateDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Feedback___createMutationRequest build() {
            Feedback___createMutationRequest obj = new Feedback___createMutationRequest($alias);
            obj.setData(data);

...
public class Gruppo___updateMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Gruppo___update";
    ...
    public Gruppo___updateMutationRequest() {
    }

    public Gruppo___updateMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliGruppoUpdateDTO data) {
    ...
    public static Gruppo___updateMutationRequest.Builder builder() {
        return new Gruppo___updateMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliGruppoUpdateDTO data;
        ...
        public Builder setData(CliGruppoUpdateDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Gruppo___updateMutationRequest build() {
            Gruppo___updateMutationRequest obj = new Gruppo___updateMutationRequest($alias);
            obj.setData(data);

...
public class CliGenotipo_HCVCursorDTO implements java.io.Serializable {
    ...
    public CliGenotipo_HCVCursorDTO() {
    }
    ...
    public static CliGenotipo_HCVCursorDTO.Builder builder() {
        return new CliGenotipo_HCVCursorDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public CliGenotipo_HCVCursorDTO build() {
            CliGenotipo_HCVCursorDTO result = new CliGenotipo_HCVCursorDTO();

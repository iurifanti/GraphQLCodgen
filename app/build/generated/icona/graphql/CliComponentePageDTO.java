...
/**
 * Represents a collection of objects of class Componente.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliComponentePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliComponenteDTO> items;
    ...
    public CliComponentePageDTO() {
    }


    /**
     * An array containing the actual objects of class Componente.
     */
    public java.util.List<CliComponenteDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Componente.
     */
    public void setItems(java.util.List<CliComponenteDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Componente present in the database.
     */
    ...
    public static CliComponentePageDTO.Builder builder() {
        return new CliComponentePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Componente.
         */
        public Builder setItems(java.util.List<CliComponenteDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliComponentePageDTO build() {
            CliComponentePageDTO result = new CliComponentePageDTO();

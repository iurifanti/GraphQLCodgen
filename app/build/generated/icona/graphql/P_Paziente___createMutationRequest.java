...
public class P_Paziente___createMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "P_Paziente___create";
    ...
    public P_Paziente___createMutationRequest() {
    }

    public P_Paziente___createMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliP_PazienteCreateDTO data) {
    ...
    public static P_Paziente___createMutationRequest.Builder builder() {
        return new P_Paziente___createMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliP_PazienteCreateDTO data;
        ...
        public Builder setData(CliP_PazienteCreateDTO data) {
            this.data = data;
            return this;
        }
        ...
        public P_Paziente___createMutationRequest build() {
            P_Paziente___createMutationRequest obj = new P_Paziente___createMutationRequest($alias);
            obj.setData(data);

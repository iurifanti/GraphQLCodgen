...
public class Feedback___updateMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Feedback___update";
    ...
    public Feedback___updateMutationRequest() {
    }

    public Feedback___updateMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliFeedbackUpdateDTO data) {
    ...
    public static Feedback___updateMutationRequest.Builder builder() {
        return new Feedback___updateMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliFeedbackUpdateDTO data;
        ...
        public Builder setData(CliFeedbackUpdateDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Feedback___updateMutationRequest build() {
            Feedback___updateMutationRequest obj = new Feedback___updateMutationRequest($alias);
            obj.setData(data);

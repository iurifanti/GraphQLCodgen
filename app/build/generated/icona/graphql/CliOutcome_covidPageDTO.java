...
/**
 * Represents a collection of objects of class Outcome_covid.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliOutcome_covidPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliOutcome_covidDTO> items;
    ...
    public CliOutcome_covidPageDTO() {
    }


    /**
     * An array containing the actual objects of class Outcome_covid.
     */
    public java.util.List<CliOutcome_covidDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Outcome_covid.
     */
    public void setItems(java.util.List<CliOutcome_covidDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Outcome_covid present in the database.
     */
    ...
    public static CliOutcome_covidPageDTO.Builder builder() {
        return new CliOutcome_covidPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Outcome_covid.
         */
        public Builder setItems(java.util.List<CliOutcome_covidDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliOutcome_covidPageDTO build() {
            CliOutcome_covidPageDTO result = new CliOutcome_covidPageDTO();

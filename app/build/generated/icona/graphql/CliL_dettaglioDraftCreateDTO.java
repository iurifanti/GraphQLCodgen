...
/**
 * A data structure for draft create objects of class L_dettaglio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliL_dettaglioDraftCreateDTO implements java.io.Serializable {
    ...
    private String tempo_visita_;

    public CliL_dettaglioDraftCreateDTO() {
    }
    ...
    public String getTempo_visita_() {
        return tempo_visita_;
    }
    public void setTempo_visita_(String tempo_visita_) {
    ...
    public static CliL_dettaglioDraftCreateDTO.Builder builder() {
        return new CliL_dettaglioDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setTempo_visita_(String tempo_visita_) {
            this.tempo_visita_ = tempo_visita_;
            return this;
        }


        public CliL_dettaglioDraftCreateDTO build() {
            CliL_dettaglioDraftCreateDTO result = new CliL_dettaglioDraftCreateDTO();

...
/**
 * A data structure for draft create objects of class Markers_HCV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliMarkers_HCVDraftCreateDTO implements java.io.Serializable {
    ...
    private String genotipo_HCV;
    private String metodica_genoma_HCV;
    private String unita_di_misura_viremia;

    public CliMarkers_HCVDraftCreateDTO() {
    }
    ...
    public String getGenotipo_HCV() {
        return genotipo_HCV;
    }
    public void setGenotipo_HCV(String genotipo_HCV) {
        this.genotipo_HCV = genotipo_HCV;
    }

    public String getMetodica_genoma_HCV() {
        return metodica_genoma_HCV;
    }
    public void setMetodica_genoma_HCV(String metodica_genoma_HCV) {
        this.metodica_genoma_HCV = metodica_genoma_HCV;
    }

    public String getUnita_di_misura_viremia() {
        return unita_di_misura_viremia;
    }
    public void setUnita_di_misura_viremia(String unita_di_misura_viremia) {
    ...
    public static CliMarkers_HCVDraftCreateDTO.Builder builder() {
        return new CliMarkers_HCVDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setGenotipo_HCV(String genotipo_HCV) {
            this.genotipo_HCV = genotipo_HCV;
            return this;
        }

        public Builder setMetodica_genoma_HCV(String metodica_genoma_HCV) {
            this.metodica_genoma_HCV = metodica_genoma_HCV;
            return this;
        }

        public Builder setUnita_di_misura_viremia(String unita_di_misura_viremia) {
            this.unita_di_misura_viremia = unita_di_misura_viremia;
            return this;
        }


        public CliMarkers_HCVDraftCreateDTO build() {
            CliMarkers_HCVDraftCreateDTO result = new CliMarkers_HCVDraftCreateDTO();

...
public class Modalita_somministrazione___saveMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Modalita_somministrazione___save";
    ...
    public Modalita_somministrazione___saveMutationRequest() {
    }

    public Modalita_somministrazione___saveMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Modalita_somministrazione___saveMutationRequest.Builder builder() {
        return new Modalita_somministrazione___saveMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Modalita_somministrazione___saveMutationRequest build() {
            Modalita_somministrazione___saveMutationRequest obj = new Modalita_somministrazione___saveMutationRequest($alias);
            obj.setData(data);

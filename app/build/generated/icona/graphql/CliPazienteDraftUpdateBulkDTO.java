...
/**
 * A data structure for a draft update objects of class Paziente.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliPazienteDraftUpdateBulkDTO implements java.io.Serializable {
    ...
    private CliAnamnesiDraftUpdateRoleObjectDTO anamnesi;
    private CliC_dettaglioDraftUpdateRoleObjectDTO c_dettaglio_;
    private CliCampione_oldRoleRefsDTO campione_old;
    private CliCentroRoleRefDTO centro_appartenenza_attuale;
    private CliChecksRoleRefsDTO checks_;
    private CliCodice_studioDraftUpdateRoleObjectsDTO codice_studio_;
    private CliCondizione_lavorativaRoleRefDTO condizione_lavorativa;
    private CliControllo_clinicoDraftUpdateRoleObjectsDTO controllo_clinico;
    private CliDropoutDraftUpdateRoleObjectsDTO dropout;
    private CliEsame_strumentaleDraftUpdateRoleObjectsDTO esame_strumentale_;
    private CliEtniaRoleRefDTO etnia;
    private CliEventoDraftUpdateRoleObjectsDTO evento;
    private CliEvento_epaticoDraftUpdateRoleObjectsDTO evento_epatico_;
    private CliFattore_di_rischioRoleRefDTO fattore_di_rischio;
    private CliGilbertRoleRefDTO gilbert_;
    private CliGravidanzaDraftUpdateRoleObjectsDTO gravidanza_;
    private CliIdentita_genereRoleRefDTO identita_genere_;
    private CliL_dettaglioDraftUpdateRoleObjectsDTO l_dettaglio_;
    private CliMarkers_HBVDraftUpdateRoleObjectsDTO markers_HBV;
    private CliMarkers_HCVDraftUpdateRoleObjectsDTO markers_HCV;
    private CliMarkers_HDVDraftUpdateRoleObjectsDTO markers_HDV_;
    private CliMarkers_HIVDraftUpdateRoleObjectsDTO markers_HIV;
    private CliMarkers_altriDraftUpdateRoleObjectsDTO markers_altri_;
    private CliNazioneRoleRefDTO nazione_;
    private CliQuestionario_PRODraftUpdateRoleObjectsDTO questionario_PRO_;
    private CliQuestionario_PRO_appDraftUpdateRoleObjectsDTO questionario_PRO_app;
    private CliRegioneRoleRefDTO regione_;
    private CliRicoveroDraftUpdateRoleObjectsDTO ricovero;
    private CliSVRDraftUpdateRoleObjectsDTO sVR_;
    private CliSequenza_genomicaRoleRefsDTO sequenza_genomica;
    private CliStudio_questionarioRoleRefsDTO studio_questionario_;
    private CliTerapia_ARVDraftUpdateRoleObjectsDTO terapia_ARV;
    private CliTerapia_altroDraftUpdateRoleObjectsDTO terapia_altro;
    private CliTerapia_altroDraftUpdateRoleObjectsDTO terapia_epatica;
    private CliTrattamento_antitumoraleDraftUpdateRoleObjectsDTO trattamento_antitumorale_;
    private CliV_dettaglioDraftUpdateRoleObjectDTO v_dettaglio_;
    private CliVisita_mpvDraftUpdateRoleObjectsDTO visita_mpv_;

    public CliPazienteDraftUpdateBulkDTO() {
    }
    ...
    public CliAnamnesiDraftUpdateRoleObjectDTO getAnamnesi() {
        return anamnesi;
    }
    public void setAnamnesi(CliAnamnesiDraftUpdateRoleObjectDTO anamnesi) {
        this.anamnesi = anamnesi;
    }

    public CliC_dettaglioDraftUpdateRoleObjectDTO getC_dettaglio_() {
        return c_dettaglio_;
    }
    public void setC_dettaglio_(CliC_dettaglioDraftUpdateRoleObjectDTO c_dettaglio_) {
        this.c_dettaglio_ = c_dettaglio_;
    }

    public CliCampione_oldRoleRefsDTO getCampione_old() {
        return campione_old;
    }
    public void setCampione_old(CliCampione_oldRoleRefsDTO campione_old) {
        this.campione_old = campione_old;
    }

    public CliCentroRoleRefDTO getCentro_appartenenza_attuale() {
        return centro_appartenenza_attuale;
    }
    public void setCentro_appartenenza_attuale(CliCentroRoleRefDTO centro_appartenenza_attuale) {
        this.centro_appartenenza_attuale = centro_appartenenza_attuale;
    }

    public CliChecksRoleRefsDTO getChecks_() {
        return checks_;
    }
    public void setChecks_(CliChecksRoleRefsDTO checks_) {
        this.checks_ = checks_;
    }

    public CliCodice_studioDraftUpdateRoleObjectsDTO getCodice_studio_() {
        return codice_studio_;
    }
    public void setCodice_studio_(CliCodice_studioDraftUpdateRoleObjectsDTO codice_studio_) {
        this.codice_studio_ = codice_studio_;
    }

    public CliCondizione_lavorativaRoleRefDTO getCondizione_lavorativa() {
        return condizione_lavorativa;
    }
    public void setCondizione_lavorativa(CliCondizione_lavorativaRoleRefDTO condizione_lavorativa) {
        this.condizione_lavorativa = condizione_lavorativa;
    }

    public CliControllo_clinicoDraftUpdateRoleObjectsDTO getControllo_clinico() {
        return controllo_clinico;
    }
    public void setControllo_clinico(CliControllo_clinicoDraftUpdateRoleObjectsDTO controllo_clinico) {
        this.controllo_clinico = controllo_clinico;
    }

    public CliDropoutDraftUpdateRoleObjectsDTO getDropout() {
        return dropout;
    }
    public void setDropout(CliDropoutDraftUpdateRoleObjectsDTO dropout) {
        this.dropout = dropout;
    }

    public CliEsame_strumentaleDraftUpdateRoleObjectsDTO getEsame_strumentale_() {
        return esame_strumentale_;
    }
    public void setEsame_strumentale_(CliEsame_strumentaleDraftUpdateRoleObjectsDTO esame_strumentale_) {
        this.esame_strumentale_ = esame_strumentale_;
    }

    public CliEtniaRoleRefDTO getEtnia() {
        return etnia;
    }
    public void setEtnia(CliEtniaRoleRefDTO etnia) {
        this.etnia = etnia;
    }

    public CliEventoDraftUpdateRoleObjectsDTO getEvento() {
        return evento;
    }
    public void setEvento(CliEventoDraftUpdateRoleObjectsDTO evento) {
        this.evento = evento;
    }

    public CliEvento_epaticoDraftUpdateRoleObjectsDTO getEvento_epatico_() {
        return evento_epatico_;
    }
    public void setEvento_epatico_(CliEvento_epaticoDraftUpdateRoleObjectsDTO evento_epatico_) {
        this.evento_epatico_ = evento_epatico_;
    }

    public CliFattore_di_rischioRoleRefDTO getFattore_di_rischio() {
        return fattore_di_rischio;
    }
    public void setFattore_di_rischio(CliFattore_di_rischioRoleRefDTO fattore_di_rischio) {
        this.fattore_di_rischio = fattore_di_rischio;
    }

    public CliGilbertRoleRefDTO getGilbert_() {
        return gilbert_;
    }
    public void setGilbert_(CliGilbertRoleRefDTO gilbert_) {
        this.gilbert_ = gilbert_;
    }

    public CliGravidanzaDraftUpdateRoleObjectsDTO getGravidanza_() {
        return gravidanza_;
    }
    public void setGravidanza_(CliGravidanzaDraftUpdateRoleObjectsDTO gravidanza_) {
        this.gravidanza_ = gravidanza_;
    }

    public CliIdentita_genereRoleRefDTO getIdentita_genere_() {
        return identita_genere_;
    }
    public void setIdentita_genere_(CliIdentita_genereRoleRefDTO identita_genere_) {
        this.identita_genere_ = identita_genere_;
    }

    public CliL_dettaglioDraftUpdateRoleObjectsDTO getL_dettaglio_() {
        return l_dettaglio_;
    }
    public void setL_dettaglio_(CliL_dettaglioDraftUpdateRoleObjectsDTO l_dettaglio_) {
        this.l_dettaglio_ = l_dettaglio_;
    }

    public CliMarkers_HBVDraftUpdateRoleObjectsDTO getMarkers_HBV() {
        return markers_HBV;
    }
    public void setMarkers_HBV(CliMarkers_HBVDraftUpdateRoleObjectsDTO markers_HBV) {
        this.markers_HBV = markers_HBV;
    }

    public CliMarkers_HCVDraftUpdateRoleObjectsDTO getMarkers_HCV() {
        return markers_HCV;
    }
    public void setMarkers_HCV(CliMarkers_HCVDraftUpdateRoleObjectsDTO markers_HCV) {
        this.markers_HCV = markers_HCV;
    }

    public CliMarkers_HDVDraftUpdateRoleObjectsDTO getMarkers_HDV_() {
        return markers_HDV_;
    }
    public void setMarkers_HDV_(CliMarkers_HDVDraftUpdateRoleObjectsDTO markers_HDV_) {
        this.markers_HDV_ = markers_HDV_;
    }

    public CliMarkers_HIVDraftUpdateRoleObjectsDTO getMarkers_HIV() {
        return markers_HIV;
    }
    public void setMarkers_HIV(CliMarkers_HIVDraftUpdateRoleObjectsDTO markers_HIV) {
        this.markers_HIV = markers_HIV;
    }

    public CliMarkers_altriDraftUpdateRoleObjectsDTO getMarkers_altri_() {
        return markers_altri_;
    }
    public void setMarkers_altri_(CliMarkers_altriDraftUpdateRoleObjectsDTO markers_altri_) {
        this.markers_altri_ = markers_altri_;
    }

    public CliNazioneRoleRefDTO getNazione_() {
        return nazione_;
    }
    public void setNazione_(CliNazioneRoleRefDTO nazione_) {
        this.nazione_ = nazione_;
    }

    public CliQuestionario_PRODraftUpdateRoleObjectsDTO getQuestionario_PRO_() {
        return questionario_PRO_;
    }
    public void setQuestionario_PRO_(CliQuestionario_PRODraftUpdateRoleObjectsDTO questionario_PRO_) {
        this.questionario_PRO_ = questionario_PRO_;
    }

    public CliQuestionario_PRO_appDraftUpdateRoleObjectsDTO getQuestionario_PRO_app() {
        return questionario_PRO_app;
    }
    public void setQuestionario_PRO_app(CliQuestionario_PRO_appDraftUpdateRoleObjectsDTO questionario_PRO_app) {
        this.questionario_PRO_app = questionario_PRO_app;
    }

    public CliRegioneRoleRefDTO getRegione_() {
        return regione_;
    }
    public void setRegione_(CliRegioneRoleRefDTO regione_) {
        this.regione_ = regione_;
    }

    public CliRicoveroDraftUpdateRoleObjectsDTO getRicovero() {
        return ricovero;
    }
    public void setRicovero(CliRicoveroDraftUpdateRoleObjectsDTO ricovero) {
        this.ricovero = ricovero;
    }

    public CliSVRDraftUpdateRoleObjectsDTO getSVR_() {
        return sVR_;
    }
    public void setSVR_(CliSVRDraftUpdateRoleObjectsDTO sVR_) {
        this.sVR_ = sVR_;
    }

    public CliSequenza_genomicaRoleRefsDTO getSequenza_genomica() {
        return sequenza_genomica;
    }
    public void setSequenza_genomica(CliSequenza_genomicaRoleRefsDTO sequenza_genomica) {
    ...
    public CliTerapia_ARVDraftUpdateRoleObjectsDTO getTerapia_ARV() {
        return terapia_ARV;
    }
    public void setTerapia_ARV(CliTerapia_ARVDraftUpdateRoleObjectsDTO terapia_ARV) {
        this.terapia_ARV = terapia_ARV;
    }

    public CliTerapia_altroDraftUpdateRoleObjectsDTO getTerapia_altro() {
        return terapia_altro;
    }
    public void setTerapia_altro(CliTerapia_altroDraftUpdateRoleObjectsDTO terapia_altro) {
        this.terapia_altro = terapia_altro;
    }

    public CliTerapia_altroDraftUpdateRoleObjectsDTO getTerapia_epatica() {
        return terapia_epatica;
    }
    public void setTerapia_epatica(CliTerapia_altroDraftUpdateRoleObjectsDTO terapia_epatica) {
        this.terapia_epatica = terapia_epatica;
    }

    public CliTrattamento_antitumoraleDraftUpdateRoleObjectsDTO getTrattamento_antitumorale_() {
        return trattamento_antitumorale_;
    }
    public void setTrattamento_antitumorale_(CliTrattamento_antitumoraleDraftUpdateRoleObjectsDTO trattamento_antitumorale_) {
        this.trattamento_antitumorale_ = trattamento_antitumorale_;
    }

    public CliV_dettaglioDraftUpdateRoleObjectDTO getV_dettaglio_() {
        return v_dettaglio_;
    }
    public void setV_dettaglio_(CliV_dettaglioDraftUpdateRoleObjectDTO v_dettaglio_) {
        this.v_dettaglio_ = v_dettaglio_;
    }

    public CliVisita_mpvDraftUpdateRoleObjectsDTO getVisita_mpv_() {
        return visita_mpv_;
    }
    public void setVisita_mpv_(CliVisita_mpvDraftUpdateRoleObjectsDTO visita_mpv_) {
    ...
    public static CliPazienteDraftUpdateBulkDTO.Builder builder() {
        return new CliPazienteDraftUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setAnamnesi(CliAnamnesiDraftUpdateRoleObjectDTO anamnesi) {
            this.anamnesi = anamnesi;
            return this;
        }

        public Builder setC_dettaglio_(CliC_dettaglioDraftUpdateRoleObjectDTO c_dettaglio_) {
            this.c_dettaglio_ = c_dettaglio_;
            return this;
        }

        public Builder setCampione_old(CliCampione_oldRoleRefsDTO campione_old) {
            this.campione_old = campione_old;
            return this;
        }

        public Builder setCentro_appartenenza_attuale(CliCentroRoleRefDTO centro_appartenenza_attuale) {
            this.centro_appartenenza_attuale = centro_appartenenza_attuale;
            return this;
        }

        public Builder setChecks_(CliChecksRoleRefsDTO checks_) {
            this.checks_ = checks_;
            return this;
        }

        public Builder setCodice_studio_(CliCodice_studioDraftUpdateRoleObjectsDTO codice_studio_) {
            this.codice_studio_ = codice_studio_;
            return this;
        }

        public Builder setCondizione_lavorativa(CliCondizione_lavorativaRoleRefDTO condizione_lavorativa) {
            this.condizione_lavorativa = condizione_lavorativa;
            return this;
        }

        public Builder setControllo_clinico(CliControllo_clinicoDraftUpdateRoleObjectsDTO controllo_clinico) {
            this.controllo_clinico = controllo_clinico;
            return this;
        }

        public Builder setDropout(CliDropoutDraftUpdateRoleObjectsDTO dropout) {
            this.dropout = dropout;
            return this;
        }

        public Builder setEsame_strumentale_(CliEsame_strumentaleDraftUpdateRoleObjectsDTO esame_strumentale_) {
            this.esame_strumentale_ = esame_strumentale_;
            return this;
        }

        public Builder setEtnia(CliEtniaRoleRefDTO etnia) {
            this.etnia = etnia;
            return this;
        }

        public Builder setEvento(CliEventoDraftUpdateRoleObjectsDTO evento) {
            this.evento = evento;
            return this;
        }

        public Builder setEvento_epatico_(CliEvento_epaticoDraftUpdateRoleObjectsDTO evento_epatico_) {
            this.evento_epatico_ = evento_epatico_;
            return this;
        }

        public Builder setFattore_di_rischio(CliFattore_di_rischioRoleRefDTO fattore_di_rischio) {
            this.fattore_di_rischio = fattore_di_rischio;
            return this;
        }

        public Builder setGilbert_(CliGilbertRoleRefDTO gilbert_) {
            this.gilbert_ = gilbert_;
            return this;
        }

        public Builder setGravidanza_(CliGravidanzaDraftUpdateRoleObjectsDTO gravidanza_) {
            this.gravidanza_ = gravidanza_;
            return this;
        }

        public Builder setIdentita_genere_(CliIdentita_genereRoleRefDTO identita_genere_) {
            this.identita_genere_ = identita_genere_;
            return this;
        }

        public Builder setL_dettaglio_(CliL_dettaglioDraftUpdateRoleObjectsDTO l_dettaglio_) {
            this.l_dettaglio_ = l_dettaglio_;
            return this;
        }

        public Builder setMarkers_HBV(CliMarkers_HBVDraftUpdateRoleObjectsDTO markers_HBV) {
            this.markers_HBV = markers_HBV;
            return this;
        }

        public Builder setMarkers_HCV(CliMarkers_HCVDraftUpdateRoleObjectsDTO markers_HCV) {
            this.markers_HCV = markers_HCV;
            return this;
        }

        public Builder setMarkers_HDV_(CliMarkers_HDVDraftUpdateRoleObjectsDTO markers_HDV_) {
            this.markers_HDV_ = markers_HDV_;
            return this;
        }

        public Builder setMarkers_HIV(CliMarkers_HIVDraftUpdateRoleObjectsDTO markers_HIV) {
            this.markers_HIV = markers_HIV;
            return this;
        }

        public Builder setMarkers_altri_(CliMarkers_altriDraftUpdateRoleObjectsDTO markers_altri_) {
            this.markers_altri_ = markers_altri_;
            return this;
        }

        public Builder setNazione_(CliNazioneRoleRefDTO nazione_) {
            this.nazione_ = nazione_;
            return this;
        }

        public Builder setQuestionario_PRO_(CliQuestionario_PRODraftUpdateRoleObjectsDTO questionario_PRO_) {
            this.questionario_PRO_ = questionario_PRO_;
            return this;
        }

        public Builder setQuestionario_PRO_app(CliQuestionario_PRO_appDraftUpdateRoleObjectsDTO questionario_PRO_app) {
            this.questionario_PRO_app = questionario_PRO_app;
            return this;
        }

        public Builder setRegione_(CliRegioneRoleRefDTO regione_) {
            this.regione_ = regione_;
            return this;
        }

        public Builder setRicovero(CliRicoveroDraftUpdateRoleObjectsDTO ricovero) {
            this.ricovero = ricovero;
            return this;
        }

        public Builder setSVR_(CliSVRDraftUpdateRoleObjectsDTO sVR_) {
            this.sVR_ = sVR_;
            return this;
        }

        public Builder setSequenza_genomica(CliSequenza_genomicaRoleRefsDTO sequenza_genomica) {
            this.sequenza_genomica = sequenza_genomica;
            return this;
        }
        ...
        public Builder setTerapia_ARV(CliTerapia_ARVDraftUpdateRoleObjectsDTO terapia_ARV) {
            this.terapia_ARV = terapia_ARV;
            return this;
        }

        public Builder setTerapia_altro(CliTerapia_altroDraftUpdateRoleObjectsDTO terapia_altro) {
            this.terapia_altro = terapia_altro;
            return this;
        }

        public Builder setTerapia_epatica(CliTerapia_altroDraftUpdateRoleObjectsDTO terapia_epatica) {
            this.terapia_epatica = terapia_epatica;
            return this;
        }

        public Builder setTrattamento_antitumorale_(CliTrattamento_antitumoraleDraftUpdateRoleObjectsDTO trattamento_antitumorale_) {
            this.trattamento_antitumorale_ = trattamento_antitumorale_;
            return this;
        }

        public Builder setV_dettaglio_(CliV_dettaglioDraftUpdateRoleObjectDTO v_dettaglio_) {
            this.v_dettaglio_ = v_dettaglio_;
            return this;
        }

        public Builder setVisita_mpv_(CliVisita_mpvDraftUpdateRoleObjectsDTO visita_mpv_) {
            this.visita_mpv_ = visita_mpv_;
            return this;
        }


        public CliPazienteDraftUpdateBulkDTO build() {
            CliPazienteDraftUpdateBulkDTO result = new CliPazienteDraftUpdateBulkDTO();

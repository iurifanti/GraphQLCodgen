...
public enum CliMotivazione_fine_ARVSortDTO {
    ...
    nome_completo___ASC("nome_completo___ASC"),
    nome_completo___DESC("nome_completo___DESC"),
    ...
    visualizzato___ASC("visualizzato___ASC"),
    visualizzato___DESC("visualizzato___DESC");

    private final String graphqlName;

    private CliMotivazione_fine_ARVSortDTO(String graphqlName) {

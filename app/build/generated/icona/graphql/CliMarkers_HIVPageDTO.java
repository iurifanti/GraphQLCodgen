...
/**
 * Represents a collection of objects of class Markers_HIV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliMarkers_HIVPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliMarkers_HIVDTO> items;
    ...
    public CliMarkers_HIVPageDTO() {
    }


    /**
     * An array containing the actual objects of class Markers_HIV.
     */
    public java.util.List<CliMarkers_HIVDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Markers_HIV.
     */
    public void setItems(java.util.List<CliMarkers_HIVDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Markers_HIV present in the database.
     */
    ...
    public static CliMarkers_HIVPageDTO.Builder builder() {
        return new CliMarkers_HIVPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Markers_HIV.
         */
        public Builder setItems(java.util.List<CliMarkers_HIVDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliMarkers_HIVPageDTO build() {
            CliMarkers_HIVPageDTO result = new CliMarkers_HIVPageDTO();

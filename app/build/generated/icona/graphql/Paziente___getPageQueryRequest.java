...
public class Paziente___getPageQueryRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Paziente___getPage";
    ...
    public Paziente___getPageQueryRequest() {
    }

    public Paziente___getPageQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Paziente___getPageQueryRequest.Builder builder() {
        return new Paziente___getPageQueryRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Paziente___getPageQueryRequest build() {
            Paziente___getPageQueryRequest obj = new Paziente___getPageQueryRequest($alias);

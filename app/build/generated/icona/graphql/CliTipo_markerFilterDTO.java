...
/**
 * Define a specific filter for objects of type Tipo_marker.
...
public class CliTipo_markerFilterDTO implements java.io.Serializable {
    ...
    private java.util.List<CliTipo_markerFilterDTO> AND;
    private java.util.List<CliTipo_markerFilterDTO> OR;
    private CliTipo_markerFilterDTO NOT;

    public CliTipo_markerFilterDTO() {
    }
    ...
    public java.util.List<CliTipo_markerFilterDTO> getAND() {
        return AND;
    }
    public void setAND(java.util.List<CliTipo_markerFilterDTO> AND) {
        this.AND = AND;
    }

    public java.util.List<CliTipo_markerFilterDTO> getOR() {
        return OR;
    }
    public void setOR(java.util.List<CliTipo_markerFilterDTO> OR) {
        this.OR = OR;
    }

    public CliTipo_markerFilterDTO getNOT() {
        return NOT;
    }
    public void setNOT(CliTipo_markerFilterDTO NOT) {
        this.NOT = NOT;
    }
    ...
    public static CliTipo_markerFilterDTO.Builder builder() {
        return new CliTipo_markerFilterDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setAND(java.util.List<CliTipo_markerFilterDTO> AND) {
            this.AND = AND;
            return this;
        }

        public Builder setOR(java.util.List<CliTipo_markerFilterDTO> OR) {
            this.OR = OR;
            return this;
        }

        public Builder setNOT(CliTipo_markerFilterDTO NOT) {
            this.NOT = NOT;
            return this;
        }


        public CliTipo_markerFilterDTO build() {
            CliTipo_markerFilterDTO result = new CliTipo_markerFilterDTO();

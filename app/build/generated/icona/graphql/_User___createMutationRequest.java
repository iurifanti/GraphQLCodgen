...
public class _User___createMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "_User___create";
    ...
    public _User___createMutationRequest() {
    }

    public _User___createMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(Cli_UserCreateDTO data) {
    ...
    public static _User___createMutationRequest.Builder builder() {
        return new _User___createMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private Cli_UserCreateDTO data;
        ...
        public Builder setData(Cli_UserCreateDTO data) {
            this.data = data;
            return this;
        }
        ...
        public _User___createMutationRequest build() {
            _User___createMutationRequest obj = new _User___createMutationRequest($alias);
            obj.setData(data);

...
/**
 * A data structure for draft create objects of class Markers_HIV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliMarkers_HIVDraftCreateDTO implements java.io.Serializable {
    ...
    private String metodica_HIVRNA;

    public CliMarkers_HIVDraftCreateDTO() {
    }
    ...
    public String getMetodica_HIVRNA() {
        return metodica_HIVRNA;
    }
    public void setMetodica_HIVRNA(String metodica_HIVRNA) {
    ...
    public static CliMarkers_HIVDraftCreateDTO.Builder builder() {
        return new CliMarkers_HIVDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setMetodica_HIVRNA(String metodica_HIVRNA) {
            this.metodica_HIVRNA = metodica_HIVRNA;
            return this;
        }


        public CliMarkers_HIVDraftCreateDTO build() {
            CliMarkers_HIVDraftCreateDTO result = new CliMarkers_HIVDraftCreateDTO();

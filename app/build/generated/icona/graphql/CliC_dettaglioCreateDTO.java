...
/**
 * A data structure for objects of C_dettaglio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliC_dettaglioCreateDTO implements java.io.Serializable {
    ...
    private java.util.List<CliEventoCreateDTO> evento_covid;
    @javax.validation.constraints.NotNull
    private String livello_ventilazione_covid_;
    private String outcome_covid_;
    private java.util.List<CliTerapia_covidCreateDTO> terapia_covid_;

    public CliC_dettaglioCreateDTO() {
    }
    ...
    public java.util.List<CliEventoCreateDTO> getEvento_covid() {
        return evento_covid;
    }
    public void setEvento_covid(java.util.List<CliEventoCreateDTO> evento_covid) {
    ...
    public java.util.List<CliTerapia_covidCreateDTO> getTerapia_covid_() {
        return terapia_covid_;
    }
    public void setTerapia_covid_(java.util.List<CliTerapia_covidCreateDTO> terapia_covid_) {
    ...
    public static CliC_dettaglioCreateDTO.Builder builder() {
        return new CliC_dettaglioCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setEvento_covid(java.util.List<CliEventoCreateDTO> evento_covid) {
            this.evento_covid = evento_covid;
            return this;
        }
        ...
        public Builder setTerapia_covid_(java.util.List<CliTerapia_covidCreateDTO> terapia_covid_) {
            this.terapia_covid_ = terapia_covid_;
            return this;
        }


        public CliC_dettaglioCreateDTO build() {
            CliC_dettaglioCreateDTO result = new CliC_dettaglioCreateDTO();

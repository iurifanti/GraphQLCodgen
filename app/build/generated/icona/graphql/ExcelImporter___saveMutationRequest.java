...
public class ExcelImporter___saveMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "ExcelImporter___save";
    ...
    public ExcelImporter___saveMutationRequest() {
    }

    public ExcelImporter___saveMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static ExcelImporter___saveMutationRequest.Builder builder() {
        return new ExcelImporter___saveMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public ExcelImporter___saveMutationRequest build() {
            ExcelImporter___saveMutationRequest obj = new ExcelImporter___saveMutationRequest($alias);
            obj.setData(data);

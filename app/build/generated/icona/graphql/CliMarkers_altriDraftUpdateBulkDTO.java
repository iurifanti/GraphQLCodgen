...
/**
 * A data structure for a draft update objects of class Markers_altri.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliMarkers_altriDraftUpdateBulkDTO implements java.io.Serializable {
    ...
    private CliTipo_markerRoleRefDTO tipo_marker_;

    public CliMarkers_altriDraftUpdateBulkDTO() {
    }
    ...
    public CliTipo_markerRoleRefDTO getTipo_marker_() {
        return tipo_marker_;
    }
    public void setTipo_marker_(CliTipo_markerRoleRefDTO tipo_marker_) {
    ...
    public static CliMarkers_altriDraftUpdateBulkDTO.Builder builder() {
        return new CliMarkers_altriDraftUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setTipo_marker_(CliTipo_markerRoleRefDTO tipo_marker_) {
            this.tipo_marker_ = tipo_marker_;
            return this;
        }


        public CliMarkers_altriDraftUpdateBulkDTO build() {
            CliMarkers_altriDraftUpdateBulkDTO result = new CliMarkers_altriDraftUpdateBulkDTO();

...
/**
 * Represents a collection of objects of class Condizione_lavorativa.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliCondizione_lavorativaPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliCondizione_lavorativaDTO> items;
    ...
    public CliCondizione_lavorativaPageDTO() {
    }


    /**
     * An array containing the actual objects of class Condizione_lavorativa.
     */
    public java.util.List<CliCondizione_lavorativaDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Condizione_lavorativa.
     */
    public void setItems(java.util.List<CliCondizione_lavorativaDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Condizione_lavorativa present in the database.
     */
    ...
    public static CliCondizione_lavorativaPageDTO.Builder builder() {
        return new CliCondizione_lavorativaPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Condizione_lavorativa.
         */
        public Builder setItems(java.util.List<CliCondizione_lavorativaDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliCondizione_lavorativaPageDTO build() {
            CliCondizione_lavorativaPageDTO result = new CliCondizione_lavorativaPageDTO();

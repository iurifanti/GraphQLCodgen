...
/**
 * Represents a collection of objects of class Dose_mpv.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliDose_mpvPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliDose_mpvDTO> items;
    ...
    public CliDose_mpvPageDTO() {
    }


    /**
     * An array containing the actual objects of class Dose_mpv.
     */
    public java.util.List<CliDose_mpvDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Dose_mpv.
     */
    public void setItems(java.util.List<CliDose_mpvDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Dose_mpv present in the database.
     */
    ...
    public static CliDose_mpvPageDTO.Builder builder() {
        return new CliDose_mpvPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Dose_mpv.
         */
        public Builder setItems(java.util.List<CliDose_mpvDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliDose_mpvPageDTO build() {
            CliDose_mpvPageDTO result = new CliDose_mpvPageDTO();

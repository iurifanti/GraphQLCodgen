...
/**
 * A data structure for draft create objects of class Esame_strumentale.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliEsame_strumentaleDraftCreateDTO implements java.io.Serializable {
    ...
    private java.util.List<String> esito_biopsia;

    public CliEsame_strumentaleDraftCreateDTO() {
    }
    ...
    public java.util.List<String> getEsito_biopsia() {
        return esito_biopsia;
    }
    public void setEsito_biopsia(java.util.List<String> esito_biopsia) {
    ...
    public static CliEsame_strumentaleDraftCreateDTO.Builder builder() {
        return new CliEsame_strumentaleDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setEsito_biopsia(java.util.List<String> esito_biopsia) {
            this.esito_biopsia = esito_biopsia;
            return this;
        }


        public CliEsame_strumentaleDraftCreateDTO build() {
            CliEsame_strumentaleDraftCreateDTO result = new CliEsame_strumentaleDraftCreateDTO();

...
/**
 * Represents a collection of objects of class Sierologie_covid.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliSierologie_covidPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliSierologie_covidDTO> items;
    ...
    public CliSierologie_covidPageDTO() {
    }


    /**
     * An array containing the actual objects of class Sierologie_covid.
     */
    public java.util.List<CliSierologie_covidDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Sierologie_covid.
     */
    public void setItems(java.util.List<CliSierologie_covidDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Sierologie_covid present in the database.
     */
    ...
    public static CliSierologie_covidPageDTO.Builder builder() {
        return new CliSierologie_covidPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Sierologie_covid.
         */
        public Builder setItems(java.util.List<CliSierologie_covidDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliSierologie_covidPageDTO build() {
            CliSierologie_covidPageDTO result = new CliSierologie_covidPageDTO();

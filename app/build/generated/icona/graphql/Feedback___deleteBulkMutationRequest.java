...
public class Feedback___deleteBulkMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Feedback___deleteBulk";
    ...
    public Feedback___deleteBulkMutationRequest() {
    }

    public Feedback___deleteBulkMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Feedback___deleteBulkMutationRequest.Builder builder() {
        return new Feedback___deleteBulkMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Feedback___deleteBulkMutationRequest build() {
            Feedback___deleteBulkMutationRequest obj = new Feedback___deleteBulkMutationRequest($alias);

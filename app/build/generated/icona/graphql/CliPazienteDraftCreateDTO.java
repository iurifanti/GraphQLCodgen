...
/**
 * A data structure for draft create objects of class Paziente.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliPazienteDraftCreateDTO implements java.io.Serializable {
    ...
    private CliAnamnesiDraftCreateDTO anamnesi;
    private CliC_dettaglioDraftCreateDTO c_dettaglio_;
    ...
    private java.util.List<CliCodice_studioDraftCreateDTO> codice_studio_;
    private String condizione_lavorativa;
    private java.util.List<CliControllo_clinicoDraftCreateDTO> controllo_clinico;
    private java.util.List<CliDropoutDraftCreateDTO> dropout;
    private java.util.List<CliEsame_strumentaleDraftCreateDTO> esame_strumentale_;
    private String etnia;
    private java.util.List<CliEventoDraftCreateDTO> evento;
    private java.util.List<CliEvento_epaticoDraftCreateDTO> evento_epatico_;
    private String fattore_di_rischio;
    private String gilbert_;
    private java.util.List<CliGravidanzaDraftCreateDTO> gravidanza_;
    private String identita_genere_;
    private java.util.List<CliL_dettaglioDraftCreateDTO> l_dettaglio_;
    private java.util.List<CliMarkers_HBVDraftCreateDTO> markers_HBV;
    private java.util.List<CliMarkers_HCVDraftCreateDTO> markers_HCV;
    private java.util.List<CliMarkers_HDVDraftCreateDTO> markers_HDV_;
    private java.util.List<CliMarkers_HIVDraftCreateDTO> markers_HIV;
    private java.util.List<CliMarkers_altriDraftCreateDTO> markers_altri_;
    private String nazione_;
    private java.util.List<CliQuestionario_PRODraftCreateDTO> questionario_PRO_;
    private java.util.List<CliQuestionario_PRO_appDraftCreateDTO> questionario_PRO_app;
    private String regione_;
    private java.util.List<CliRicoveroDraftCreateDTO> ricovero;
    private java.util.List<CliSVRDraftCreateDTO> sVR_;
    private java.util.List<String> sequenza_genomica;
    private java.util.List<String> studio_questionario_;
    private java.util.List<CliTerapia_ARVDraftCreateDTO> terapia_ARV;
    private java.util.List<CliTerapia_altroDraftCreateDTO> terapia_altro;
    private java.util.List<CliTerapia_altroDraftCreateDTO> terapia_epatica;
    private java.util.List<CliTrattamento_antitumoraleDraftCreateDTO> trattamento_antitumorale_;
    private CliV_dettaglioDraftCreateDTO v_dettaglio_;
    private java.util.List<CliVisita_mpvDraftCreateDTO> visita_mpv_;

    public CliPazienteDraftCreateDTO() {
    }
    ...
    public CliAnamnesiDraftCreateDTO getAnamnesi() {
        return anamnesi;
    }
    public void setAnamnesi(CliAnamnesiDraftCreateDTO anamnesi) {
        this.anamnesi = anamnesi;
    }

    public CliC_dettaglioDraftCreateDTO getC_dettaglio_() {
        return c_dettaglio_;
    }
    public void setC_dettaglio_(CliC_dettaglioDraftCreateDTO c_dettaglio_) {
    ...
    public java.util.List<CliCodice_studioDraftCreateDTO> getCodice_studio_() {
        return codice_studio_;
    }
    public void setCodice_studio_(java.util.List<CliCodice_studioDraftCreateDTO> codice_studio_) {
    ...
    public java.util.List<CliControllo_clinicoDraftCreateDTO> getControllo_clinico() {
        return controllo_clinico;
    }
    public void setControllo_clinico(java.util.List<CliControllo_clinicoDraftCreateDTO> controllo_clinico) {
        this.controllo_clinico = controllo_clinico;
    }

    public java.util.List<CliDropoutDraftCreateDTO> getDropout() {
        return dropout;
    }
    public void setDropout(java.util.List<CliDropoutDraftCreateDTO> dropout) {
        this.dropout = dropout;
    }

    public java.util.List<CliEsame_strumentaleDraftCreateDTO> getEsame_strumentale_() {
        return esame_strumentale_;
    }
    public void setEsame_strumentale_(java.util.List<CliEsame_strumentaleDraftCreateDTO> esame_strumentale_) {
    ...
    public java.util.List<CliEventoDraftCreateDTO> getEvento() {
        return evento;
    }
    public void setEvento(java.util.List<CliEventoDraftCreateDTO> evento) {
        this.evento = evento;
    }

    public java.util.List<CliEvento_epaticoDraftCreateDTO> getEvento_epatico_() {
        return evento_epatico_;
    }
    public void setEvento_epatico_(java.util.List<CliEvento_epaticoDraftCreateDTO> evento_epatico_) {
    ...
    public java.util.List<CliGravidanzaDraftCreateDTO> getGravidanza_() {
        return gravidanza_;
    }
    public void setGravidanza_(java.util.List<CliGravidanzaDraftCreateDTO> gravidanza_) {
    ...
    public java.util.List<CliL_dettaglioDraftCreateDTO> getL_dettaglio_() {
        return l_dettaglio_;
    }
    public void setL_dettaglio_(java.util.List<CliL_dettaglioDraftCreateDTO> l_dettaglio_) {
        this.l_dettaglio_ = l_dettaglio_;
    }

    public java.util.List<CliMarkers_HBVDraftCreateDTO> getMarkers_HBV() {
        return markers_HBV;
    }
    public void setMarkers_HBV(java.util.List<CliMarkers_HBVDraftCreateDTO> markers_HBV) {
        this.markers_HBV = markers_HBV;
    }

    public java.util.List<CliMarkers_HCVDraftCreateDTO> getMarkers_HCV() {
        return markers_HCV;
    }
    public void setMarkers_HCV(java.util.List<CliMarkers_HCVDraftCreateDTO> markers_HCV) {
        this.markers_HCV = markers_HCV;
    }

    public java.util.List<CliMarkers_HDVDraftCreateDTO> getMarkers_HDV_() {
        return markers_HDV_;
    }
    public void setMarkers_HDV_(java.util.List<CliMarkers_HDVDraftCreateDTO> markers_HDV_) {
        this.markers_HDV_ = markers_HDV_;
    }

    public java.util.List<CliMarkers_HIVDraftCreateDTO> getMarkers_HIV() {
        return markers_HIV;
    }
    public void setMarkers_HIV(java.util.List<CliMarkers_HIVDraftCreateDTO> markers_HIV) {
        this.markers_HIV = markers_HIV;
    }

    public java.util.List<CliMarkers_altriDraftCreateDTO> getMarkers_altri_() {
        return markers_altri_;
    }
    public void setMarkers_altri_(java.util.List<CliMarkers_altriDraftCreateDTO> markers_altri_) {
    ...
    public java.util.List<CliQuestionario_PRODraftCreateDTO> getQuestionario_PRO_() {
        return questionario_PRO_;
    }
    public void setQuestionario_PRO_(java.util.List<CliQuestionario_PRODraftCreateDTO> questionario_PRO_) {
        this.questionario_PRO_ = questionario_PRO_;
    }

    public java.util.List<CliQuestionario_PRO_appDraftCreateDTO> getQuestionario_PRO_app() {
        return questionario_PRO_app;
    }
    public void setQuestionario_PRO_app(java.util.List<CliQuestionario_PRO_appDraftCreateDTO> questionario_PRO_app) {
    ...
    public java.util.List<CliRicoveroDraftCreateDTO> getRicovero() {
        return ricovero;
    }
    public void setRicovero(java.util.List<CliRicoveroDraftCreateDTO> ricovero) {
        this.ricovero = ricovero;
    }

    public java.util.List<CliSVRDraftCreateDTO> getSVR_() {
        return sVR_;
    }
    public void setSVR_(java.util.List<CliSVRDraftCreateDTO> sVR_) {
        this.sVR_ = sVR_;
    }
    ...
    public java.util.List<CliTerapia_ARVDraftCreateDTO> getTerapia_ARV() {
        return terapia_ARV;
    }
    public void setTerapia_ARV(java.util.List<CliTerapia_ARVDraftCreateDTO> terapia_ARV) {
        this.terapia_ARV = terapia_ARV;
    }

    public java.util.List<CliTerapia_altroDraftCreateDTO> getTerapia_altro() {
        return terapia_altro;
    }
    public void setTerapia_altro(java.util.List<CliTerapia_altroDraftCreateDTO> terapia_altro) {
        this.terapia_altro = terapia_altro;
    }

    public java.util.List<CliTerapia_altroDraftCreateDTO> getTerapia_epatica() {
        return terapia_epatica;
    }
    public void setTerapia_epatica(java.util.List<CliTerapia_altroDraftCreateDTO> terapia_epatica) {
        this.terapia_epatica = terapia_epatica;
    }

    public java.util.List<CliTrattamento_antitumoraleDraftCreateDTO> getTrattamento_antitumorale_() {
        return trattamento_antitumorale_;
    }
    public void setTrattamento_antitumorale_(java.util.List<CliTrattamento_antitumoraleDraftCreateDTO> trattamento_antitumorale_) {
        this.trattamento_antitumorale_ = trattamento_antitumorale_;
    }

    public CliV_dettaglioDraftCreateDTO getV_dettaglio_() {
        return v_dettaglio_;
    }
    public void setV_dettaglio_(CliV_dettaglioDraftCreateDTO v_dettaglio_) {
        this.v_dettaglio_ = v_dettaglio_;
    }

    public java.util.List<CliVisita_mpvDraftCreateDTO> getVisita_mpv_() {
        return visita_mpv_;
    }
    public void setVisita_mpv_(java.util.List<CliVisita_mpvDraftCreateDTO> visita_mpv_) {
    ...
    public static CliPazienteDraftCreateDTO.Builder builder() {
        return new CliPazienteDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setAnamnesi(CliAnamnesiDraftCreateDTO anamnesi) {
            this.anamnesi = anamnesi;
            return this;
        }

        public Builder setC_dettaglio_(CliC_dettaglioDraftCreateDTO c_dettaglio_) {
            this.c_dettaglio_ = c_dettaglio_;
            return this;
        }
        ...
        public Builder setCodice_studio_(java.util.List<CliCodice_studioDraftCreateDTO> codice_studio_) {
            this.codice_studio_ = codice_studio_;
            return this;
        }
        ...
        public Builder setControllo_clinico(java.util.List<CliControllo_clinicoDraftCreateDTO> controllo_clinico) {
            this.controllo_clinico = controllo_clinico;
            return this;
        }

        public Builder setDropout(java.util.List<CliDropoutDraftCreateDTO> dropout) {
            this.dropout = dropout;
            return this;
        }

        public Builder setEsame_strumentale_(java.util.List<CliEsame_strumentaleDraftCreateDTO> esame_strumentale_) {
            this.esame_strumentale_ = esame_strumentale_;
            return this;
        }
        ...
        public Builder setEvento(java.util.List<CliEventoDraftCreateDTO> evento) {
            this.evento = evento;
            return this;
        }

        public Builder setEvento_epatico_(java.util.List<CliEvento_epaticoDraftCreateDTO> evento_epatico_) {
            this.evento_epatico_ = evento_epatico_;
            return this;
        }
        ...
        public Builder setGravidanza_(java.util.List<CliGravidanzaDraftCreateDTO> gravidanza_) {
            this.gravidanza_ = gravidanza_;
            return this;
        }
        ...
        public Builder setL_dettaglio_(java.util.List<CliL_dettaglioDraftCreateDTO> l_dettaglio_) {
            this.l_dettaglio_ = l_dettaglio_;
            return this;
        }

        public Builder setMarkers_HBV(java.util.List<CliMarkers_HBVDraftCreateDTO> markers_HBV) {
            this.markers_HBV = markers_HBV;
            return this;
        }

        public Builder setMarkers_HCV(java.util.List<CliMarkers_HCVDraftCreateDTO> markers_HCV) {
            this.markers_HCV = markers_HCV;
            return this;
        }

        public Builder setMarkers_HDV_(java.util.List<CliMarkers_HDVDraftCreateDTO> markers_HDV_) {
            this.markers_HDV_ = markers_HDV_;
            return this;
        }

        public Builder setMarkers_HIV(java.util.List<CliMarkers_HIVDraftCreateDTO> markers_HIV) {
            this.markers_HIV = markers_HIV;
            return this;
        }

        public Builder setMarkers_altri_(java.util.List<CliMarkers_altriDraftCreateDTO> markers_altri_) {
            this.markers_altri_ = markers_altri_;
            return this;
        }
        ...
        public Builder setQuestionario_PRO_(java.util.List<CliQuestionario_PRODraftCreateDTO> questionario_PRO_) {
            this.questionario_PRO_ = questionario_PRO_;
            return this;
        }

        public Builder setQuestionario_PRO_app(java.util.List<CliQuestionario_PRO_appDraftCreateDTO> questionario_PRO_app) {
            this.questionario_PRO_app = questionario_PRO_app;
            return this;
        }
        ...
        public Builder setRicovero(java.util.List<CliRicoveroDraftCreateDTO> ricovero) {
            this.ricovero = ricovero;
            return this;
        }

        public Builder setSVR_(java.util.List<CliSVRDraftCreateDTO> sVR_) {
            this.sVR_ = sVR_;
            return this;
        }
        ...
        public Builder setTerapia_ARV(java.util.List<CliTerapia_ARVDraftCreateDTO> terapia_ARV) {
            this.terapia_ARV = terapia_ARV;
            return this;
        }

        public Builder setTerapia_altro(java.util.List<CliTerapia_altroDraftCreateDTO> terapia_altro) {
            this.terapia_altro = terapia_altro;
            return this;
        }

        public Builder setTerapia_epatica(java.util.List<CliTerapia_altroDraftCreateDTO> terapia_epatica) {
            this.terapia_epatica = terapia_epatica;
            return this;
        }

        public Builder setTrattamento_antitumorale_(java.util.List<CliTrattamento_antitumoraleDraftCreateDTO> trattamento_antitumorale_) {
            this.trattamento_antitumorale_ = trattamento_antitumorale_;
            return this;
        }

        public Builder setV_dettaglio_(CliV_dettaglioDraftCreateDTO v_dettaglio_) {
            this.v_dettaglio_ = v_dettaglio_;
            return this;
        }

        public Builder setVisita_mpv_(java.util.List<CliVisita_mpvDraftCreateDTO> visita_mpv_) {
            this.visita_mpv_ = visita_mpv_;
            return this;
        }


        public CliPazienteDraftCreateDTO build() {
            CliPazienteDraftCreateDTO result = new CliPazienteDraftCreateDTO();

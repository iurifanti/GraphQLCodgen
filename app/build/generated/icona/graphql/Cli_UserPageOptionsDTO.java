...
public class Cli_UserPageOptionsDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    private Cli_UserFilterDTO filter;
    private String filter_exp;
    private Integer offset;
    private String cursor;
    private Cli_UserCursorDTO fromCursor;
    private Integer next;
    private Integer prev;
    private java.util.List<Cli_UserSortDTO> orderBy = java.util.Arrays.asList(Cli_UserSortDTO._id___ASC);

    public Cli_UserPageOptionsDTO() {
    }


    public Cli_UserFilterDTO getFilter() {
        return filter;
    }
    public void setFilter(Cli_UserFilterDTO filter) {
        this.filter = filter;
    }
    ...
    public Cli_UserCursorDTO getFromCursor() {
        return fromCursor;
    }
    public void setFromCursor(Cli_UserCursorDTO fromCursor) {
    ...
    public java.util.List<Cli_UserSortDTO> getOrderBy() {
        return orderBy;
    }
    public void setOrderBy(java.util.List<Cli_UserSortDTO> orderBy) {
    ...
    public static Cli_UserPageOptionsDTO.Builder builder() {
        return new Cli_UserPageOptionsDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setFilter(Cli_UserFilterDTO filter) {
            this.filter = filter;
            return this;
        }
        ...
        public Builder setFromCursor(Cli_UserCursorDTO fromCursor) {
            this.fromCursor = fromCursor;
            return this;
        }
        ...
        public Builder setOrderBy(java.util.List<Cli_UserSortDTO> orderBy) {
            this.orderBy = orderBy;
            return this;
        }


        public Cli_UserPageOptionsDTO build() {
            Cli_UserPageOptionsDTO result = new Cli_UserPageOptionsDTO();

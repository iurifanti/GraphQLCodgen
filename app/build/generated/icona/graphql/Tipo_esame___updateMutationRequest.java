...
public class Tipo_esame___updateMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Tipo_esame___update";
    ...
    public Tipo_esame___updateMutationRequest() {
    }

    public Tipo_esame___updateMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliTipo_esameUpdateDTO data) {
    ...
    public static Tipo_esame___updateMutationRequest.Builder builder() {
        return new Tipo_esame___updateMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliTipo_esameUpdateDTO data;
        ...
        public Builder setData(CliTipo_esameUpdateDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Tipo_esame___updateMutationRequest build() {
            Tipo_esame___updateMutationRequest obj = new Tipo_esame___updateMutationRequest($alias);
            obj.setData(data);

...
/**
 * Represents a collection of objects of class Motivazione_dropout.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliMotivazione_dropoutPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliMotivazione_dropoutDTO> items;
    ...
    public CliMotivazione_dropoutPageDTO() {
    }


    /**
     * An array containing the actual objects of class Motivazione_dropout.
     */
    public java.util.List<CliMotivazione_dropoutDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Motivazione_dropout.
     */
    public void setItems(java.util.List<CliMotivazione_dropoutDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Motivazione_dropout present in the database.
     */
    ...
    public static CliMotivazione_dropoutPageDTO.Builder builder() {
        return new CliMotivazione_dropoutPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Motivazione_dropout.
         */
        public Builder setItems(java.util.List<CliMotivazione_dropoutDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliMotivazione_dropoutPageDTO build() {
            CliMotivazione_dropoutPageDTO result = new CliMotivazione_dropoutPageDTO();

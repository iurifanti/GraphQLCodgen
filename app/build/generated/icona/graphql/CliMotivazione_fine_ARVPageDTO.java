...
/**
 * Represents a collection of objects of class Motivazione_fine_ARV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliMotivazione_fine_ARVPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliMotivazione_fine_ARVDTO> items;
    ...
    public CliMotivazione_fine_ARVPageDTO() {
    }


    /**
     * An array containing the actual objects of class Motivazione_fine_ARV.
     */
    public java.util.List<CliMotivazione_fine_ARVDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Motivazione_fine_ARV.
     */
    public void setItems(java.util.List<CliMotivazione_fine_ARVDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Motivazione_fine_ARV present in the database.
     */
    ...
    public static CliMotivazione_fine_ARVPageDTO.Builder builder() {
        return new CliMotivazione_fine_ARVPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Motivazione_fine_ARV.
         */
        public Builder setItems(java.util.List<CliMotivazione_fine_ARVDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliMotivazione_fine_ARVPageDTO build() {
            CliMotivazione_fine_ARVPageDTO result = new CliMotivazione_fine_ARVPageDTO();

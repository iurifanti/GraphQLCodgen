...
/**
 * Represents a collection of objects of class Gilbert.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliGilbertPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliGilbertDTO> items;
    ...
    public CliGilbertPageDTO() {
    }


    /**
     * An array containing the actual objects of class Gilbert.
     */
    public java.util.List<CliGilbertDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Gilbert.
     */
    public void setItems(java.util.List<CliGilbertDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Gilbert present in the database.
     */
    ...
    public static CliGilbertPageDTO.Builder builder() {
        return new CliGilbertPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Gilbert.
         */
        public Builder setItems(java.util.List<CliGilbertDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliGilbertPageDTO build() {
            CliGilbertPageDTO result = new CliGilbertPageDTO();

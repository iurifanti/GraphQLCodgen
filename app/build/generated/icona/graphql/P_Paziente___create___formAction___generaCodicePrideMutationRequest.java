...
public class P_Paziente___create___formAction___generaCodicePrideMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "P_Paziente___create___formAction___generaCodicePride";
    ...
    public P_Paziente___create___formAction___generaCodicePrideMutationRequest() {
    }

    public P_Paziente___create___formAction___generaCodicePrideMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public void setFormParam(CliGenera_codice_internoDraftCreateDTO formParam) {
    ...
    public static P_Paziente___create___formAction___generaCodicePrideMutationRequest.Builder builder() {
        return new P_Paziente___create___formAction___generaCodicePrideMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private CliGenera_codice_internoDraftCreateDTO formParam;
        ...
        public Builder setFormParam(CliGenera_codice_internoDraftCreateDTO formParam) {
        ...
        public P_Paziente___create___formAction___generaCodicePrideMutationRequest build() {
            P_Paziente___create___formAction___generaCodicePrideMutationRequest obj = new P_Paziente___create___formAction___generaCodicePrideMutationRequest($alias);
            obj.setData(data);

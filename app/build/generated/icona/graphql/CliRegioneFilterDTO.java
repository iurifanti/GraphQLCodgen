...
/**
 * Define a specific filter for objects of type Regione.
...
public class CliRegioneFilterDTO implements java.io.Serializable {
    ...
    private java.util.List<CliRegioneFilterDTO> AND;
    private java.util.List<CliRegioneFilterDTO> OR;
    private CliRegioneFilterDTO NOT;

    public CliRegioneFilterDTO() {
    }
    ...
    public java.util.List<CliRegioneFilterDTO> getAND() {
        return AND;
    }
    public void setAND(java.util.List<CliRegioneFilterDTO> AND) {
        this.AND = AND;
    }

    public java.util.List<CliRegioneFilterDTO> getOR() {
        return OR;
    }
    public void setOR(java.util.List<CliRegioneFilterDTO> OR) {
        this.OR = OR;
    }

    public CliRegioneFilterDTO getNOT() {
        return NOT;
    }
    public void setNOT(CliRegioneFilterDTO NOT) {
        this.NOT = NOT;
    }
    ...
    public static CliRegioneFilterDTO.Builder builder() {
        return new CliRegioneFilterDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setAND(java.util.List<CliRegioneFilterDTO> AND) {
            this.AND = AND;
            return this;
        }

        public Builder setOR(java.util.List<CliRegioneFilterDTO> OR) {
            this.OR = OR;
            return this;
        }

        public Builder setNOT(CliRegioneFilterDTO NOT) {
            this.NOT = NOT;
            return this;
        }


        public CliRegioneFilterDTO build() {
            CliRegioneFilterDTO result = new CliRegioneFilterDTO();

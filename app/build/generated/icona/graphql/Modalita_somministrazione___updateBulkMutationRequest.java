...
public class Modalita_somministrazione___updateBulkMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Modalita_somministrazione___updateBulk";
    ...
    public Modalita_somministrazione___updateBulkMutationRequest() {
    }

    public Modalita_somministrazione___updateBulkMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliModalita_somministrazioneUpdateBulkDTO data) {
    ...
    public static Modalita_somministrazione___updateBulkMutationRequest.Builder builder() {
        return new Modalita_somministrazione___updateBulkMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliModalita_somministrazioneUpdateBulkDTO data;
        ...
        public Builder setData(CliModalita_somministrazioneUpdateBulkDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Modalita_somministrazione___updateBulkMutationRequest build() {
            Modalita_somministrazione___updateBulkMutationRequest obj = new Modalita_somministrazione___updateBulkMutationRequest($alias);
            obj.setData(data);

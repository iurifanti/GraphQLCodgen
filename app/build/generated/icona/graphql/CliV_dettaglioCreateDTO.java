...
/**
 * A data structure for objects of V_dettaglio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliV_dettaglioCreateDTO implements java.io.Serializable {
    ...
    private java.util.List<CliDose_vaccino_covidCreateDTO> dose_vaccino_covid_;
    ...
    private java.util.List<CliSierologie_covidCreateDTO> sierologie_covid_;
    ...
    public CliV_dettaglioCreateDTO() {
    }
    ...
    public java.util.List<CliDose_vaccino_covidCreateDTO> getDose_vaccino_covid_() {
        return dose_vaccino_covid_;
    }
    public void setDose_vaccino_covid_(java.util.List<CliDose_vaccino_covidCreateDTO> dose_vaccino_covid_) {
    ...
    public java.util.List<CliSierologie_covidCreateDTO> getSierologie_covid_() {
        return sierologie_covid_;
    }
    public void setSierologie_covid_(java.util.List<CliSierologie_covidCreateDTO> sierologie_covid_) {
    ...
    public static CliV_dettaglioCreateDTO.Builder builder() {
        return new CliV_dettaglioCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setDose_vaccino_covid_(java.util.List<CliDose_vaccino_covidCreateDTO> dose_vaccino_covid_) {
            this.dose_vaccino_covid_ = dose_vaccino_covid_;
            return this;
        }
        ...
        public Builder setSierologie_covid_(java.util.List<CliSierologie_covidCreateDTO> sierologie_covid_) {
            this.sierologie_covid_ = sierologie_covid_;
            return this;
        }
        ...
        public CliV_dettaglioCreateDTO build() {
            CliV_dettaglioCreateDTO result = new CliV_dettaglioCreateDTO();

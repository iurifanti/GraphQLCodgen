...
public class Indicazioni_arruolamento_studi___saveMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Indicazioni_arruolamento_studi___save";
    ...
    public Indicazioni_arruolamento_studi___saveMutationRequest() {
    }

    public Indicazioni_arruolamento_studi___saveMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Indicazioni_arruolamento_studi___saveMutationRequest.Builder builder() {
        return new Indicazioni_arruolamento_studi___saveMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Indicazioni_arruolamento_studi___saveMutationRequest build() {
            Indicazioni_arruolamento_studi___saveMutationRequest obj = new Indicazioni_arruolamento_studi___saveMutationRequest($alias);
            obj.setData(data);

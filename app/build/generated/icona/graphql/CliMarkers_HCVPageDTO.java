...
/**
 * Represents a collection of objects of class Markers_HCV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliMarkers_HCVPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliMarkers_HCVDTO> items;
    ...
    public CliMarkers_HCVPageDTO() {
    }


    /**
     * An array containing the actual objects of class Markers_HCV.
     */
    public java.util.List<CliMarkers_HCVDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Markers_HCV.
     */
    public void setItems(java.util.List<CliMarkers_HCVDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Markers_HCV present in the database.
     */
    ...
    public static CliMarkers_HCVPageDTO.Builder builder() {
        return new CliMarkers_HCVPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Markers_HCV.
         */
        public Builder setItems(java.util.List<CliMarkers_HCVDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliMarkers_HCVPageDTO build() {
            CliMarkers_HCVPageDTO result = new CliMarkers_HCVPageDTO();

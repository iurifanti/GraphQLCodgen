...
public enum CliMetodica_HIVRNASortDTO {
    ...
    limite_di_rilevabilita___ASC("limite_di_rilevabilita___ASC"),
    limite_di_rilevabilita___DESC("limite_di_rilevabilita___DESC"),
    limite_superiore___ASC("limite_superiore___ASC"),
    limite_superiore___DESC("limite_superiore___DESC"),
    ...
    private CliMetodica_HIVRNASortDTO(String graphqlName) {

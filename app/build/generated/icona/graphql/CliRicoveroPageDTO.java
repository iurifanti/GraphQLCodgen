...
/**
 * Represents a collection of objects of class Ricovero.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliRicoveroPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliRicoveroDTO> items;
    ...
    public CliRicoveroPageDTO() {
    }


    /**
     * An array containing the actual objects of class Ricovero.
     */
    public java.util.List<CliRicoveroDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Ricovero.
     */
    public void setItems(java.util.List<CliRicoveroDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Ricovero present in the database.
     */
    ...
    public static CliRicoveroPageDTO.Builder builder() {
        return new CliRicoveroPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Ricovero.
         */
        public Builder setItems(java.util.List<CliRicoveroDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliRicoveroPageDTO build() {
            CliRicoveroPageDTO result = new CliRicoveroPageDTO();

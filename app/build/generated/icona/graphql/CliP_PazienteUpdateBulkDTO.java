...
/**
 * A data structure for objects of class P_Paziente.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliP_PazienteUpdateBulkDTO implements java.io.Serializable {
    ...
    private CliQuestionario_PRO_appRoleObjectsDTO questionario_PRO_app_;
    private CliStudio_questionarioRoleRefsDTO studio_questionario_;

    public CliP_PazienteUpdateBulkDTO() {
    }
    ...
    public CliQuestionario_PRO_appRoleObjectsDTO getQuestionario_PRO_app_() {
        return questionario_PRO_app_;
    }
    public void setQuestionario_PRO_app_(CliQuestionario_PRO_appRoleObjectsDTO questionario_PRO_app_) {
    ...
    public static CliP_PazienteUpdateBulkDTO.Builder builder() {
        return new CliP_PazienteUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setQuestionario_PRO_app_(CliQuestionario_PRO_appRoleObjectsDTO questionario_PRO_app_) {
            this.questionario_PRO_app_ = questionario_PRO_app_;
            return this;
        }
        ...
        public CliP_PazienteUpdateBulkDTO build() {
            CliP_PazienteUpdateBulkDTO result = new CliP_PazienteUpdateBulkDTO();

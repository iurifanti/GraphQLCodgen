...
/**
 * Represents a collection of objects of class Farmaco_covid.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliFarmaco_covidPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliFarmaco_covidDTO> items;
    ...
    public CliFarmaco_covidPageDTO() {
    }


    /**
     * An array containing the actual objects of class Farmaco_covid.
     */
    public java.util.List<CliFarmaco_covidDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Farmaco_covid.
     */
    public void setItems(java.util.List<CliFarmaco_covidDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Farmaco_covid present in the database.
     */
    ...
    public static CliFarmaco_covidPageDTO.Builder builder() {
        return new CliFarmaco_covidPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Farmaco_covid.
         */
        public Builder setItems(java.util.List<CliFarmaco_covidDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliFarmaco_covidPageDTO build() {
            CliFarmaco_covidPageDTO result = new CliFarmaco_covidPageDTO();

...
/**
 * Represents a collection of objects of class Combinazioni_accettate_non_ARV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliCombinazioni_accettate_non_ARVPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliCombinazioni_accettate_non_ARVDTO> items;
    ...
    public CliCombinazioni_accettate_non_ARVPageDTO() {
    }


    /**
     * An array containing the actual objects of class Combinazioni_accettate_non_ARV.
     */
    public java.util.List<CliCombinazioni_accettate_non_ARVDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Combinazioni_accettate_non_ARV.
     */
    public void setItems(java.util.List<CliCombinazioni_accettate_non_ARVDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Combinazioni_accettate_non_ARV present in the database.
     */
    ...
    public static CliCombinazioni_accettate_non_ARVPageDTO.Builder builder() {
        return new CliCombinazioni_accettate_non_ARVPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Combinazioni_accettate_non_ARV.
         */
        public Builder setItems(java.util.List<CliCombinazioni_accettate_non_ARVDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliCombinazioni_accettate_non_ARVPageDTO build() {
            CliCombinazioni_accettate_non_ARVPageDTO result = new CliCombinazioni_accettate_non_ARVPageDTO();

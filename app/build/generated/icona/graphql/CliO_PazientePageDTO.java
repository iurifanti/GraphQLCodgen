...
/**
 * Represents a collection of objects of class O_Paziente.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliO_PazientePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliO_PazienteDTO> items;
    ...
    public CliO_PazientePageDTO() {
    }


    /**
     * An array containing the actual objects of class O_Paziente.
     */
    public java.util.List<CliO_PazienteDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class O_Paziente.
     */
    public void setItems(java.util.List<CliO_PazienteDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class O_Paziente present in the database.
     */
    ...
    public static CliO_PazientePageDTO.Builder builder() {
        return new CliO_PazientePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class O_Paziente.
         */
        public Builder setItems(java.util.List<CliO_PazienteDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliO_PazientePageDTO build() {
            CliO_PazientePageDTO result = new CliO_PazientePageDTO();

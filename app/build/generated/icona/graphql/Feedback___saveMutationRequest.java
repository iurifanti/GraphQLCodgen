...
public class Feedback___saveMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Feedback___save";
    ...
    public Feedback___saveMutationRequest() {
    }

    public Feedback___saveMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Feedback___saveMutationRequest.Builder builder() {
        return new Feedback___saveMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Feedback___saveMutationRequest build() {
            Feedback___saveMutationRequest obj = new Feedback___saveMutationRequest($alias);
            obj.setData(data);

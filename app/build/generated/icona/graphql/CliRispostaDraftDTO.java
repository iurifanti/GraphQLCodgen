...
/**
 * A data structure for a draft object of class Risposta.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliRispostaDraftDTO implements java.io.Serializable {
    ...
    private CliRisposta_possibileDraftRoleRefsDTO risposta_possibile_multipla;

    public CliRispostaDraftDTO() {
    }
    ...
    public CliRisposta_possibileDraftRoleRefsDTO getRisposta_possibile_multipla() {
        return risposta_possibile_multipla;
    }
    public void setRisposta_possibile_multipla(CliRisposta_possibileDraftRoleRefsDTO risposta_possibile_multipla) {
    ...
    public static CliRispostaDraftDTO.Builder builder() {
        return new CliRispostaDraftDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setRisposta_possibile_multipla(CliRisposta_possibileDraftRoleRefsDTO risposta_possibile_multipla) {
            this.risposta_possibile_multipla = risposta_possibile_multipla;
            return this;
        }


        public CliRispostaDraftDTO build() {
            CliRispostaDraftDTO result = new CliRispostaDraftDTO();

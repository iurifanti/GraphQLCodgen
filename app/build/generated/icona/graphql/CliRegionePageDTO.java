...
/**
 * Represents a collection of objects of class Regione.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliRegionePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliRegioneDTO> items;
    ...
    public CliRegionePageDTO() {
    }


    /**
     * An array containing the actual objects of class Regione.
     */
    public java.util.List<CliRegioneDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Regione.
     */
    public void setItems(java.util.List<CliRegioneDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Regione present in the database.
     */
    ...
    public static CliRegionePageDTO.Builder builder() {
        return new CliRegionePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Regione.
         */
        public Builder setItems(java.util.List<CliRegioneDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliRegionePageDTO build() {
            CliRegionePageDTO result = new CliRegionePageDTO();

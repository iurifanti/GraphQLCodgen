...
public class Centro_provenienza___getPageQueryRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Centro_provenienza___getPage";
    ...
    public Centro_provenienza___getPageQueryRequest() {
    }

    public Centro_provenienza___getPageQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Centro_provenienza___getPageQueryRequest.Builder builder() {
        return new Centro_provenienza___getPageQueryRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Centro_provenienza___getPageQueryRequest build() {
            Centro_provenienza___getPageQueryRequest obj = new Centro_provenienza___getPageQueryRequest($alias);

...
/**
 * Represents a collection of objects of class Tipo_marker.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliTipo_markerPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliTipo_markerDTO> items;
    ...
    public CliTipo_markerPageDTO() {
    }


    /**
     * An array containing the actual objects of class Tipo_marker.
     */
    public java.util.List<CliTipo_markerDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Tipo_marker.
     */
    public void setItems(java.util.List<CliTipo_markerDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Tipo_marker present in the database.
     */
    ...
    public static CliTipo_markerPageDTO.Builder builder() {
        return new CliTipo_markerPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Tipo_marker.
         */
        public Builder setItems(java.util.List<CliTipo_markerDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliTipo_markerPageDTO build() {
            CliTipo_markerPageDTO result = new CliTipo_markerPageDTO();

...
/**
 * Represents a collection of objects of class Etnia.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliEtniaPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliEtniaDTO> items;
    ...
    public CliEtniaPageDTO() {
    }


    /**
     * An array containing the actual objects of class Etnia.
     */
    public java.util.List<CliEtniaDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Etnia.
     */
    public void setItems(java.util.List<CliEtniaDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Etnia present in the database.
     */
    ...
    public static CliEtniaPageDTO.Builder builder() {
        return new CliEtniaPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Etnia.
         */
        public Builder setItems(java.util.List<CliEtniaDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliEtniaPageDTO build() {
            CliEtniaPageDTO result = new CliEtniaPageDTO();

...
public class Tipo_visita_mpv___updateBulkMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Tipo_visita_mpv___updateBulk";
    ...
    public Tipo_visita_mpv___updateBulkMutationRequest() {
    }

    public Tipo_visita_mpv___updateBulkMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliTipo_visita_mpvUpdateBulkDTO data) {
    ...
    public static Tipo_visita_mpv___updateBulkMutationRequest.Builder builder() {
        return new Tipo_visita_mpv___updateBulkMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliTipo_visita_mpvUpdateBulkDTO data;
        ...
        public Builder setData(CliTipo_visita_mpvUpdateBulkDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Tipo_visita_mpv___updateBulkMutationRequest build() {
            Tipo_visita_mpv___updateBulkMutationRequest obj = new Tipo_visita_mpv___updateBulkMutationRequest($alias);
            obj.setData(data);

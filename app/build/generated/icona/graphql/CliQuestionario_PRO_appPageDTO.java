...
/**
 * Represents a collection of objects of class Questionario_PRO_app.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliQuestionario_PRO_appPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliQuestionario_PRO_appDTO> items;
    ...
    public CliQuestionario_PRO_appPageDTO() {
    }


    /**
     * An array containing the actual objects of class Questionario_PRO_app.
     */
    public java.util.List<CliQuestionario_PRO_appDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Questionario_PRO_app.
     */
    public void setItems(java.util.List<CliQuestionario_PRO_appDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Questionario_PRO_app present in the database.
     */
    ...
    public static CliQuestionario_PRO_appPageDTO.Builder builder() {
        return new CliQuestionario_PRO_appPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Questionario_PRO_app.
         */
        public Builder setItems(java.util.List<CliQuestionario_PRO_appDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliQuestionario_PRO_appPageDTO build() {
            CliQuestionario_PRO_appPageDTO result = new CliQuestionario_PRO_appPageDTO();

...
/**
 * Represents a collection of objects of class Centro_sequenziatore.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliCentro_sequenziatorePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliCentro_sequenziatoreDTO> items;
    ...
    public CliCentro_sequenziatorePageDTO() {
    }


    /**
     * An array containing the actual objects of class Centro_sequenziatore.
     */
    public java.util.List<CliCentro_sequenziatoreDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Centro_sequenziatore.
     */
    public void setItems(java.util.List<CliCentro_sequenziatoreDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Centro_sequenziatore present in the database.
     */
    ...
    public static CliCentro_sequenziatorePageDTO.Builder builder() {
        return new CliCentro_sequenziatorePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Centro_sequenziatore.
         */
        public Builder setItems(java.util.List<CliCentro_sequenziatoreDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliCentro_sequenziatorePageDTO build() {
            CliCentro_sequenziatorePageDTO result = new CliCentro_sequenziatorePageDTO();

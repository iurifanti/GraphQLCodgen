...
public class Paziente___saveMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Paziente___save";
    ...
    public Paziente___saveMutationRequest() {
    }

    public Paziente___saveMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Paziente___saveMutationRequest.Builder builder() {
        return new Paziente___saveMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Paziente___saveMutationRequest build() {
            Paziente___saveMutationRequest obj = new Paziente___saveMutationRequest($alias);
            obj.setData(data);

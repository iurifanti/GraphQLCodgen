...
/**
 * Represents a collection of objects of class Visita_mpv.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliVisita_mpvPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliVisita_mpvDTO> items;
    ...
    public CliVisita_mpvPageDTO() {
    }


    /**
     * An array containing the actual objects of class Visita_mpv.
     */
    public java.util.List<CliVisita_mpvDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Visita_mpv.
     */
    public void setItems(java.util.List<CliVisita_mpvDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Visita_mpv present in the database.
     */
    ...
    public static CliVisita_mpvPageDTO.Builder builder() {
        return new CliVisita_mpvPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Visita_mpv.
         */
        public Builder setItems(java.util.List<CliVisita_mpvDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliVisita_mpvPageDTO build() {
            CliVisita_mpvPageDTO result = new CliVisita_mpvPageDTO();

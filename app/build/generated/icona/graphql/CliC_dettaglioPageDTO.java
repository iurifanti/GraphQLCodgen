...
/**
 * Represents a collection of objects of class C_dettaglio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliC_dettaglioPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliC_dettaglioDTO> items;
    ...
    public CliC_dettaglioPageDTO() {
    }


    /**
     * An array containing the actual objects of class C_dettaglio.
     */
    public java.util.List<CliC_dettaglioDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class C_dettaglio.
     */
    public void setItems(java.util.List<CliC_dettaglioDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class C_dettaglio present in the database.
     */
    ...
    public static CliC_dettaglioPageDTO.Builder builder() {
        return new CliC_dettaglioPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class C_dettaglio.
         */
        public Builder setItems(java.util.List<CliC_dettaglioDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliC_dettaglioPageDTO build() {
            CliC_dettaglioPageDTO result = new CliC_dettaglioPageDTO();

...
/**
 * A data structure for objects of class Paziente.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliPazienteUpdateBulkDTO implements java.io.Serializable {
    ...
    private CliAnamnesiRoleObjectDTO anamnesi;
    private CliC_dettaglioRoleObjectDTO c_dettaglio_;
    ...
    private CliCodice_studioRoleObjectsDTO codice_studio_;
    private CliCondizione_lavorativaRoleRefDTO condizione_lavorativa;
    private CliControllo_clinicoRoleObjectsDTO controllo_clinico;
    private CliDropoutRoleObjectsDTO dropout;
    private CliEsame_strumentaleRoleObjectsDTO esame_strumentale_;
    private CliEtniaRoleRefDTO etnia;
    private CliEventoRoleObjectsDTO evento;
    private CliEvento_epaticoRoleObjectsDTO evento_epatico_;
    private CliFattore_di_rischioRoleRefDTO fattore_di_rischio;
    private CliGilbertRoleRefDTO gilbert_;
    private CliGravidanzaRoleObjectsDTO gravidanza_;
    private CliIdentita_genereRoleRefDTO identita_genere_;
    private CliL_dettaglioRoleObjectsDTO l_dettaglio_;
    private CliMarkers_HBVRoleObjectsDTO markers_HBV;
    private CliMarkers_HCVRoleObjectsDTO markers_HCV;
    private CliMarkers_HDVRoleObjectsDTO markers_HDV_;
    private CliMarkers_HIVRoleObjectsDTO markers_HIV;
    private CliMarkers_altriRoleObjectsDTO markers_altri_;
    private CliNazioneRoleRefDTO nazione_;
    private CliQuestionario_PRORoleObjectsDTO questionario_PRO_;
    private CliQuestionario_PRO_appRoleObjectsDTO questionario_PRO_app;
    private CliRegioneRoleRefDTO regione_;
    private CliRicoveroRoleObjectsDTO ricovero;
    private CliSVRRoleObjectsDTO sVR_;
    private CliSequenza_genomicaRoleRefsDTO sequenza_genomica;
    private CliStudio_questionarioRoleRefsDTO studio_questionario_;
    private CliTerapia_ARVRoleObjectsDTO terapia_ARV;
    private CliTerapia_altroRoleObjectsDTO terapia_altro;
    private CliTerapia_altroRoleObjectsDTO terapia_epatica;
    private CliTrattamento_antitumoraleRoleObjectsDTO trattamento_antitumorale_;
    private CliV_dettaglioRoleObjectDTO v_dettaglio_;
    private CliVisita_mpvRoleObjectsDTO visita_mpv_;

    public CliPazienteUpdateBulkDTO() {
    }
    ...
    public CliAnamnesiRoleObjectDTO getAnamnesi() {
        return anamnesi;
    }
    public void setAnamnesi(CliAnamnesiRoleObjectDTO anamnesi) {
        this.anamnesi = anamnesi;
    }

    public CliC_dettaglioRoleObjectDTO getC_dettaglio_() {
        return c_dettaglio_;
    }
    public void setC_dettaglio_(CliC_dettaglioRoleObjectDTO c_dettaglio_) {
    ...
    public CliCodice_studioRoleObjectsDTO getCodice_studio_() {
        return codice_studio_;
    }
    public void setCodice_studio_(CliCodice_studioRoleObjectsDTO codice_studio_) {
    ...
    public CliControllo_clinicoRoleObjectsDTO getControllo_clinico() {
        return controllo_clinico;
    }
    public void setControllo_clinico(CliControllo_clinicoRoleObjectsDTO controllo_clinico) {
        this.controllo_clinico = controllo_clinico;
    }

    public CliDropoutRoleObjectsDTO getDropout() {
        return dropout;
    }
    public void setDropout(CliDropoutRoleObjectsDTO dropout) {
        this.dropout = dropout;
    }

    public CliEsame_strumentaleRoleObjectsDTO getEsame_strumentale_() {
        return esame_strumentale_;
    }
    public void setEsame_strumentale_(CliEsame_strumentaleRoleObjectsDTO esame_strumentale_) {
    ...
    public CliEventoRoleObjectsDTO getEvento() {
        return evento;
    }
    public void setEvento(CliEventoRoleObjectsDTO evento) {
        this.evento = evento;
    }

    public CliEvento_epaticoRoleObjectsDTO getEvento_epatico_() {
        return evento_epatico_;
    }
    public void setEvento_epatico_(CliEvento_epaticoRoleObjectsDTO evento_epatico_) {
    ...
    public CliGravidanzaRoleObjectsDTO getGravidanza_() {
        return gravidanza_;
    }
    public void setGravidanza_(CliGravidanzaRoleObjectsDTO gravidanza_) {
    ...
    public CliL_dettaglioRoleObjectsDTO getL_dettaglio_() {
        return l_dettaglio_;
    }
    public void setL_dettaglio_(CliL_dettaglioRoleObjectsDTO l_dettaglio_) {
        this.l_dettaglio_ = l_dettaglio_;
    }

    public CliMarkers_HBVRoleObjectsDTO getMarkers_HBV() {
        return markers_HBV;
    }
    public void setMarkers_HBV(CliMarkers_HBVRoleObjectsDTO markers_HBV) {
        this.markers_HBV = markers_HBV;
    }

    public CliMarkers_HCVRoleObjectsDTO getMarkers_HCV() {
        return markers_HCV;
    }
    public void setMarkers_HCV(CliMarkers_HCVRoleObjectsDTO markers_HCV) {
        this.markers_HCV = markers_HCV;
    }

    public CliMarkers_HDVRoleObjectsDTO getMarkers_HDV_() {
        return markers_HDV_;
    }
    public void setMarkers_HDV_(CliMarkers_HDVRoleObjectsDTO markers_HDV_) {
        this.markers_HDV_ = markers_HDV_;
    }

    public CliMarkers_HIVRoleObjectsDTO getMarkers_HIV() {
        return markers_HIV;
    }
    public void setMarkers_HIV(CliMarkers_HIVRoleObjectsDTO markers_HIV) {
        this.markers_HIV = markers_HIV;
    }

    public CliMarkers_altriRoleObjectsDTO getMarkers_altri_() {
        return markers_altri_;
    }
    public void setMarkers_altri_(CliMarkers_altriRoleObjectsDTO markers_altri_) {
    ...
    public CliQuestionario_PRORoleObjectsDTO getQuestionario_PRO_() {
        return questionario_PRO_;
    }
    public void setQuestionario_PRO_(CliQuestionario_PRORoleObjectsDTO questionario_PRO_) {
        this.questionario_PRO_ = questionario_PRO_;
    }

    public CliQuestionario_PRO_appRoleObjectsDTO getQuestionario_PRO_app() {
        return questionario_PRO_app;
    }
    public void setQuestionario_PRO_app(CliQuestionario_PRO_appRoleObjectsDTO questionario_PRO_app) {
    ...
    public CliRicoveroRoleObjectsDTO getRicovero() {
        return ricovero;
    }
    public void setRicovero(CliRicoveroRoleObjectsDTO ricovero) {
        this.ricovero = ricovero;
    }

    public CliSVRRoleObjectsDTO getSVR_() {
        return sVR_;
    }
    public void setSVR_(CliSVRRoleObjectsDTO sVR_) {
        this.sVR_ = sVR_;
    }
    ...
    public CliTerapia_ARVRoleObjectsDTO getTerapia_ARV() {
        return terapia_ARV;
    }
    public void setTerapia_ARV(CliTerapia_ARVRoleObjectsDTO terapia_ARV) {
        this.terapia_ARV = terapia_ARV;
    }

    public CliTerapia_altroRoleObjectsDTO getTerapia_altro() {
        return terapia_altro;
    }
    public void setTerapia_altro(CliTerapia_altroRoleObjectsDTO terapia_altro) {
        this.terapia_altro = terapia_altro;
    }

    public CliTerapia_altroRoleObjectsDTO getTerapia_epatica() {
        return terapia_epatica;
    }
    public void setTerapia_epatica(CliTerapia_altroRoleObjectsDTO terapia_epatica) {
        this.terapia_epatica = terapia_epatica;
    }

    public CliTrattamento_antitumoraleRoleObjectsDTO getTrattamento_antitumorale_() {
        return trattamento_antitumorale_;
    }
    public void setTrattamento_antitumorale_(CliTrattamento_antitumoraleRoleObjectsDTO trattamento_antitumorale_) {
        this.trattamento_antitumorale_ = trattamento_antitumorale_;
    }

    public CliV_dettaglioRoleObjectDTO getV_dettaglio_() {
        return v_dettaglio_;
    }
    public void setV_dettaglio_(CliV_dettaglioRoleObjectDTO v_dettaglio_) {
        this.v_dettaglio_ = v_dettaglio_;
    }

    public CliVisita_mpvRoleObjectsDTO getVisita_mpv_() {
        return visita_mpv_;
    }
    public void setVisita_mpv_(CliVisita_mpvRoleObjectsDTO visita_mpv_) {
    ...
    public static CliPazienteUpdateBulkDTO.Builder builder() {
        return new CliPazienteUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setAnamnesi(CliAnamnesiRoleObjectDTO anamnesi) {
            this.anamnesi = anamnesi;
            return this;
        }

        public Builder setC_dettaglio_(CliC_dettaglioRoleObjectDTO c_dettaglio_) {
            this.c_dettaglio_ = c_dettaglio_;
            return this;
        }
        ...
        public Builder setCodice_studio_(CliCodice_studioRoleObjectsDTO codice_studio_) {
            this.codice_studio_ = codice_studio_;
            return this;
        }
        ...
        public Builder setControllo_clinico(CliControllo_clinicoRoleObjectsDTO controllo_clinico) {
            this.controllo_clinico = controllo_clinico;
            return this;
        }

        public Builder setDropout(CliDropoutRoleObjectsDTO dropout) {
            this.dropout = dropout;
            return this;
        }

        public Builder setEsame_strumentale_(CliEsame_strumentaleRoleObjectsDTO esame_strumentale_) {
            this.esame_strumentale_ = esame_strumentale_;
            return this;
        }
        ...
        public Builder setEvento(CliEventoRoleObjectsDTO evento) {
            this.evento = evento;
            return this;
        }

        public Builder setEvento_epatico_(CliEvento_epaticoRoleObjectsDTO evento_epatico_) {
            this.evento_epatico_ = evento_epatico_;
            return this;
        }
        ...
        public Builder setGravidanza_(CliGravidanzaRoleObjectsDTO gravidanza_) {
            this.gravidanza_ = gravidanza_;
            return this;
        }
        ...
        public Builder setL_dettaglio_(CliL_dettaglioRoleObjectsDTO l_dettaglio_) {
            this.l_dettaglio_ = l_dettaglio_;
            return this;
        }

        public Builder setMarkers_HBV(CliMarkers_HBVRoleObjectsDTO markers_HBV) {
            this.markers_HBV = markers_HBV;
            return this;
        }

        public Builder setMarkers_HCV(CliMarkers_HCVRoleObjectsDTO markers_HCV) {
            this.markers_HCV = markers_HCV;
            return this;
        }

        public Builder setMarkers_HDV_(CliMarkers_HDVRoleObjectsDTO markers_HDV_) {
            this.markers_HDV_ = markers_HDV_;
            return this;
        }

        public Builder setMarkers_HIV(CliMarkers_HIVRoleObjectsDTO markers_HIV) {
            this.markers_HIV = markers_HIV;
            return this;
        }

        public Builder setMarkers_altri_(CliMarkers_altriRoleObjectsDTO markers_altri_) {
            this.markers_altri_ = markers_altri_;
            return this;
        }
        ...
        public Builder setQuestionario_PRO_(CliQuestionario_PRORoleObjectsDTO questionario_PRO_) {
            this.questionario_PRO_ = questionario_PRO_;
            return this;
        }

        public Builder setQuestionario_PRO_app(CliQuestionario_PRO_appRoleObjectsDTO questionario_PRO_app) {
            this.questionario_PRO_app = questionario_PRO_app;
            return this;
        }
        ...
        public Builder setRicovero(CliRicoveroRoleObjectsDTO ricovero) {
            this.ricovero = ricovero;
            return this;
        }

        public Builder setSVR_(CliSVRRoleObjectsDTO sVR_) {
            this.sVR_ = sVR_;
            return this;
        }
        ...
        public Builder setTerapia_ARV(CliTerapia_ARVRoleObjectsDTO terapia_ARV) {
            this.terapia_ARV = terapia_ARV;
            return this;
        }

        public Builder setTerapia_altro(CliTerapia_altroRoleObjectsDTO terapia_altro) {
            this.terapia_altro = terapia_altro;
            return this;
        }

        public Builder setTerapia_epatica(CliTerapia_altroRoleObjectsDTO terapia_epatica) {
            this.terapia_epatica = terapia_epatica;
            return this;
        }

        public Builder setTrattamento_antitumorale_(CliTrattamento_antitumoraleRoleObjectsDTO trattamento_antitumorale_) {
            this.trattamento_antitumorale_ = trattamento_antitumorale_;
            return this;
        }

        public Builder setV_dettaglio_(CliV_dettaglioRoleObjectDTO v_dettaglio_) {
            this.v_dettaglio_ = v_dettaglio_;
            return this;
        }

        public Builder setVisita_mpv_(CliVisita_mpvRoleObjectsDTO visita_mpv_) {
            this.visita_mpv_ = visita_mpv_;
            return this;
        }


        public CliPazienteUpdateBulkDTO build() {
            CliPazienteUpdateBulkDTO result = new CliPazienteUpdateBulkDTO();

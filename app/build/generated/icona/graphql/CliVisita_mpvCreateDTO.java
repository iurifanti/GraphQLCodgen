...
/**
 * A data structure for objects of Visita_mpv.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliVisita_mpvCreateDTO implements java.io.Serializable {
    ...
    private java.util.List<CliDose_mpvCreateDTO> dose_mpv_;
    private java.util.List<CliEpisodio_MPOXCreateDTO> episodio_MPOX_;
    ...
    public java.util.List<CliDose_mpvCreateDTO> getDose_mpv_() {
        return dose_mpv_;
    }
    public void setDose_mpv_(java.util.List<CliDose_mpvCreateDTO> dose_mpv_) {
        this.dose_mpv_ = dose_mpv_;
    }

    public java.util.List<CliEpisodio_MPOXCreateDTO> getEpisodio_MPOX_() {
        return episodio_MPOX_;
    }
    public void setEpisodio_MPOX_(java.util.List<CliEpisodio_MPOXCreateDTO> episodio_MPOX_) {
    ...
    public static CliVisita_mpvCreateDTO.Builder builder() {
        return new CliVisita_mpvCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setDose_mpv_(java.util.List<CliDose_mpvCreateDTO> dose_mpv_) {
            this.dose_mpv_ = dose_mpv_;
            return this;
        }

        public Builder setEpisodio_MPOX_(java.util.List<CliEpisodio_MPOXCreateDTO> episodio_MPOX_) {
            this.episodio_MPOX_ = episodio_MPOX_;
            return this;
        }
        ...
        public CliVisita_mpvCreateDTO build() {
            CliVisita_mpvCreateDTO result = new CliVisita_mpvCreateDTO();

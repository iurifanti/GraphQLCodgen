...
/**
 * Represents a collection of objects of class Motivazione_naive.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliMotivazione_naivePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliMotivazione_naiveDTO> items;
    ...
    public CliMotivazione_naivePageDTO() {
    }


    /**
     * An array containing the actual objects of class Motivazione_naive.
     */
    public java.util.List<CliMotivazione_naiveDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Motivazione_naive.
     */
    public void setItems(java.util.List<CliMotivazione_naiveDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Motivazione_naive present in the database.
     */
    ...
    public static CliMotivazione_naivePageDTO.Builder builder() {
        return new CliMotivazione_naivePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Motivazione_naive.
         */
        public Builder setItems(java.util.List<CliMotivazione_naiveDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliMotivazione_naivePageDTO build() {
            CliMotivazione_naivePageDTO result = new CliMotivazione_naivePageDTO();

...
public class CliC_dettaglioCursorDTO implements java.io.Serializable {
    ...
    public CliC_dettaglioCursorDTO() {
    }
    ...
    public static CliC_dettaglioCursorDTO.Builder builder() {
        return new CliC_dettaglioCursorDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public CliC_dettaglioCursorDTO build() {
            CliC_dettaglioCursorDTO result = new CliC_dettaglioCursorDTO();

...
/**
 * A data structure for draft create objects of class Dose_vaccino_covid.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliDose_vaccino_covidDraftCreateDTO implements java.io.Serializable {
    ...
    private java.util.List<String> eventi_vaccino_covid;
    private String motivazioni_seconda_dose_;
    private String tempo_dose_vaccino_;
    private String vaccino_covid;

    public CliDose_vaccino_covidDraftCreateDTO() {
    }
    ...
    public java.util.List<String> getEventi_vaccino_covid() {
        return eventi_vaccino_covid;
    }
    public void setEventi_vaccino_covid(java.util.List<String> eventi_vaccino_covid) {
        this.eventi_vaccino_covid = eventi_vaccino_covid;
    }

    public String getMotivazioni_seconda_dose_() {
        return motivazioni_seconda_dose_;
    }
    public void setMotivazioni_seconda_dose_(String motivazioni_seconda_dose_) {
        this.motivazioni_seconda_dose_ = motivazioni_seconda_dose_;
    }

    public String getTempo_dose_vaccino_() {
        return tempo_dose_vaccino_;
    }
    public void setTempo_dose_vaccino_(String tempo_dose_vaccino_) {
        this.tempo_dose_vaccino_ = tempo_dose_vaccino_;
    }

    public String getVaccino_covid() {
        return vaccino_covid;
    }
    public void setVaccino_covid(String vaccino_covid) {
    ...
    public static CliDose_vaccino_covidDraftCreateDTO.Builder builder() {
        return new CliDose_vaccino_covidDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setEventi_vaccino_covid(java.util.List<String> eventi_vaccino_covid) {
            this.eventi_vaccino_covid = eventi_vaccino_covid;
            return this;
        }

        public Builder setMotivazioni_seconda_dose_(String motivazioni_seconda_dose_) {
            this.motivazioni_seconda_dose_ = motivazioni_seconda_dose_;
            return this;
        }

        public Builder setTempo_dose_vaccino_(String tempo_dose_vaccino_) {
            this.tempo_dose_vaccino_ = tempo_dose_vaccino_;
            return this;
        }

        public Builder setVaccino_covid(String vaccino_covid) {
            this.vaccino_covid = vaccino_covid;
            return this;
        }


        public CliDose_vaccino_covidDraftCreateDTO build() {
            CliDose_vaccino_covidDraftCreateDTO result = new CliDose_vaccino_covidDraftCreateDTO();

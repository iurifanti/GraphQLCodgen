...
/**
 * Represents a collection of objects of class H_Paziente.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliH_PazientePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliH_PazienteDTO> items;
    ...
    public CliH_PazientePageDTO() {
    }


    /**
     * An array containing the actual objects of class H_Paziente.
     */
    public java.util.List<CliH_PazienteDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class H_Paziente.
     */
    public void setItems(java.util.List<CliH_PazienteDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class H_Paziente present in the database.
     */
    ...
    public static CliH_PazientePageDTO.Builder builder() {
        return new CliH_PazientePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class H_Paziente.
         */
        public Builder setItems(java.util.List<CliH_PazienteDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliH_PazientePageDTO build() {
            CliH_PazientePageDTO result = new CliH_PazientePageDTO();

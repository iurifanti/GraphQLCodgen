...
/**
 * Represents a collection of objects of class Evento.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliEventoPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliEventoDTO> items;
    ...
    public CliEventoPageDTO() {
    }


    /**
     * An array containing the actual objects of class Evento.
     */
    public java.util.List<CliEventoDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Evento.
     */
    public void setItems(java.util.List<CliEventoDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Evento present in the database.
     */
    ...
    public static CliEventoPageDTO.Builder builder() {
        return new CliEventoPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Evento.
         */
        public Builder setItems(java.util.List<CliEventoDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliEventoPageDTO build() {
            CliEventoPageDTO result = new CliEventoPageDTO();

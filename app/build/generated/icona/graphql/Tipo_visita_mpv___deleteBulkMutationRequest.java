...
public class Tipo_visita_mpv___deleteBulkMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Tipo_visita_mpv___deleteBulk";
    ...
    public Tipo_visita_mpv___deleteBulkMutationRequest() {
    }

    public Tipo_visita_mpv___deleteBulkMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Tipo_visita_mpv___deleteBulkMutationRequest.Builder builder() {
        return new Tipo_visita_mpv___deleteBulkMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Tipo_visita_mpv___deleteBulkMutationRequest build() {
            Tipo_visita_mpv___deleteBulkMutationRequest obj = new Tipo_visita_mpv___deleteBulkMutationRequest($alias);

...
/**
 * Represents a collection of objects of class Tempo_sierologia_covid.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliTempo_sierologia_covidPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliTempo_sierologia_covidDTO> items;
    ...
    public CliTempo_sierologia_covidPageDTO() {
    }


    /**
     * An array containing the actual objects of class Tempo_sierologia_covid.
     */
    public java.util.List<CliTempo_sierologia_covidDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Tempo_sierologia_covid.
     */
    public void setItems(java.util.List<CliTempo_sierologia_covidDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Tempo_sierologia_covid present in the database.
     */
    ...
    public static CliTempo_sierologia_covidPageDTO.Builder builder() {
        return new CliTempo_sierologia_covidPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Tempo_sierologia_covid.
         */
        public Builder setItems(java.util.List<CliTempo_sierologia_covidDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliTempo_sierologia_covidPageDTO build() {
            CliTempo_sierologia_covidPageDTO result = new CliTempo_sierologia_covidPageDTO();

...
public class Sequenza_genomica___getPageQueryRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Sequenza_genomica___getPage";
    ...
    public Sequenza_genomica___getPageQueryRequest() {
    }

    public Sequenza_genomica___getPageQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Sequenza_genomica___getPageQueryRequest.Builder builder() {
        return new Sequenza_genomica___getPageQueryRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Sequenza_genomica___getPageQueryRequest build() {
            Sequenza_genomica___getPageQueryRequest obj = new Sequenza_genomica___getPageQueryRequest($alias);

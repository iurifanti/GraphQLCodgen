...
/**
 * A data structure for a draft object of class V_dettaglio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliV_dettaglioDraftDTO implements java.io.Serializable {
    ...
    private CliDose_vaccino_covidDraftRoleObjectsDTO dose_vaccino_covid_;
    private CliPatologiaDraftRoleRefsDTO eventi_prima_dose;
    private CliPatologiaDraftRoleRefsDTO eventi_seconda_dose;
    private String motivazioni_seconda_dose_1;
    private CliSierologie_covidDraftRoleObjectsDTO sierologie_covid_;
    private CliPatologiaDraftRoleRefsDTO sintomo_covid_post;
    private CliPatologiaDraftRoleRefsDTO sintomo_covid_pre;
    private String vaccino_covid_prima;
    private String vaccino_covid_seconda;

    public CliV_dettaglioDraftDTO() {
    }
    ...
    public CliDose_vaccino_covidDraftRoleObjectsDTO getDose_vaccino_covid_() {
        return dose_vaccino_covid_;
    }
    public void setDose_vaccino_covid_(CliDose_vaccino_covidDraftRoleObjectsDTO dose_vaccino_covid_) {
        this.dose_vaccino_covid_ = dose_vaccino_covid_;
    }

    public CliPatologiaDraftRoleRefsDTO getEventi_prima_dose() {
        return eventi_prima_dose;
    }
    public void setEventi_prima_dose(CliPatologiaDraftRoleRefsDTO eventi_prima_dose) {
        this.eventi_prima_dose = eventi_prima_dose;
    }

    public CliPatologiaDraftRoleRefsDTO getEventi_seconda_dose() {
        return eventi_seconda_dose;
    }
    public void setEventi_seconda_dose(CliPatologiaDraftRoleRefsDTO eventi_seconda_dose) {
    ...
    public CliPatologiaDraftRoleRefsDTO getSintomo_covid_post() {
        return sintomo_covid_post;
    }
    public void setSintomo_covid_post(CliPatologiaDraftRoleRefsDTO sintomo_covid_post) {
        this.sintomo_covid_post = sintomo_covid_post;
    }

    public CliPatologiaDraftRoleRefsDTO getSintomo_covid_pre() {
        return sintomo_covid_pre;
    }
    public void setSintomo_covid_pre(CliPatologiaDraftRoleRefsDTO sintomo_covid_pre) {
    ...
    public static CliV_dettaglioDraftDTO.Builder builder() {
        return new CliV_dettaglioDraftDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setDose_vaccino_covid_(CliDose_vaccino_covidDraftRoleObjectsDTO dose_vaccino_covid_) {
            this.dose_vaccino_covid_ = dose_vaccino_covid_;
            return this;
        }

        public Builder setEventi_prima_dose(CliPatologiaDraftRoleRefsDTO eventi_prima_dose) {
            this.eventi_prima_dose = eventi_prima_dose;
            return this;
        }

        public Builder setEventi_seconda_dose(CliPatologiaDraftRoleRefsDTO eventi_seconda_dose) {
            this.eventi_seconda_dose = eventi_seconda_dose;
            return this;
        }
        ...
        public Builder setSintomo_covid_post(CliPatologiaDraftRoleRefsDTO sintomo_covid_post) {
            this.sintomo_covid_post = sintomo_covid_post;
            return this;
        }

        public Builder setSintomo_covid_pre(CliPatologiaDraftRoleRefsDTO sintomo_covid_pre) {
            this.sintomo_covid_pre = sintomo_covid_pre;
            return this;
        }
        ...
        public CliV_dettaglioDraftDTO build() {
            CliV_dettaglioDraftDTO result = new CliV_dettaglioDraftDTO();

...
/**
 * A data structure for draft create objects of class Visita_mpv.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliVisita_mpvDraftCreateDTO implements java.io.Serializable {
    ...
    private java.util.List<String> comorbidita_mpv_;
    private java.util.List<CliDose_mpvDraftCreateDTO> dose_mpv_;
    private java.util.List<CliEpisodio_MPOXDraftCreateDTO> episodio_MPOX_;
    ...
    public CliVisita_mpvDraftCreateDTO() {
    }
    ...
    public java.util.List<String> getComorbidita_mpv_() {
        return comorbidita_mpv_;
    }
    public void setComorbidita_mpv_(java.util.List<String> comorbidita_mpv_) {
        this.comorbidita_mpv_ = comorbidita_mpv_;
    }

    public java.util.List<CliDose_mpvDraftCreateDTO> getDose_mpv_() {
        return dose_mpv_;
    }
    public void setDose_mpv_(java.util.List<CliDose_mpvDraftCreateDTO> dose_mpv_) {
        this.dose_mpv_ = dose_mpv_;
    }

    public java.util.List<CliEpisodio_MPOXDraftCreateDTO> getEpisodio_MPOX_() {
        return episodio_MPOX_;
    }
    public void setEpisodio_MPOX_(java.util.List<CliEpisodio_MPOXDraftCreateDTO> episodio_MPOX_) {
    ...
    public static CliVisita_mpvDraftCreateDTO.Builder builder() {
        return new CliVisita_mpvDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setComorbidita_mpv_(java.util.List<String> comorbidita_mpv_) {
            this.comorbidita_mpv_ = comorbidita_mpv_;
            return this;
        }

        public Builder setDose_mpv_(java.util.List<CliDose_mpvDraftCreateDTO> dose_mpv_) {
            this.dose_mpv_ = dose_mpv_;
            return this;
        }

        public Builder setEpisodio_MPOX_(java.util.List<CliEpisodio_MPOXDraftCreateDTO> episodio_MPOX_) {
            this.episodio_MPOX_ = episodio_MPOX_;
            return this;
        }
        ...
        public CliVisita_mpvDraftCreateDTO build() {
            CliVisita_mpvDraftCreateDTO result = new CliVisita_mpvDraftCreateDTO();

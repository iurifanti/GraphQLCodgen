...
/**
 * A data structure for a draft object of class Evento_epatico.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliEvento_epaticoDraftDTO implements java.io.Serializable {
    ...
    private CliPatologiaDraftRoleRefsDTO biopsia_epatica;
    private CliPatologiaDraftRoleRefsDTO patologia_epatica;
    private String patologia_epatica_dad1;

    public CliEvento_epaticoDraftDTO() {
    }
    ...
    public CliPatologiaDraftRoleRefsDTO getBiopsia_epatica() {
        return biopsia_epatica;
    }
    public void setBiopsia_epatica(CliPatologiaDraftRoleRefsDTO biopsia_epatica) {
        this.biopsia_epatica = biopsia_epatica;
    }

    public CliPatologiaDraftRoleRefsDTO getPatologia_epatica() {
        return patologia_epatica;
    }
    public void setPatologia_epatica(CliPatologiaDraftRoleRefsDTO patologia_epatica) {
    ...
    public static CliEvento_epaticoDraftDTO.Builder builder() {
        return new CliEvento_epaticoDraftDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setBiopsia_epatica(CliPatologiaDraftRoleRefsDTO biopsia_epatica) {
            this.biopsia_epatica = biopsia_epatica;
            return this;
        }

        public Builder setPatologia_epatica(CliPatologiaDraftRoleRefsDTO patologia_epatica) {
            this.patologia_epatica = patologia_epatica;
            return this;
        }
        ...
        public CliEvento_epaticoDraftDTO build() {
            CliEvento_epaticoDraftDTO result = new CliEvento_epaticoDraftDTO();

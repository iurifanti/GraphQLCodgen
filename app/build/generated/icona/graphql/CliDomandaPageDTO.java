...
/**
 * Represents a collection of objects of class Domanda.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliDomandaPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliDomandaDTO> items;
    ...
    public CliDomandaPageDTO() {
    }


    /**
     * An array containing the actual objects of class Domanda.
     */
    public java.util.List<CliDomandaDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Domanda.
     */
    public void setItems(java.util.List<CliDomandaDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Domanda present in the database.
     */
    ...
    public static CliDomandaPageDTO.Builder builder() {
        return new CliDomandaPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Domanda.
         */
        public Builder setItems(java.util.List<CliDomandaDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliDomandaPageDTO build() {
            CliDomandaPageDTO result = new CliDomandaPageDTO();

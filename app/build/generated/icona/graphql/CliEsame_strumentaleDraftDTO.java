...
/**
 * A data structure for a draft object of class Esame_strumentale.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliEsame_strumentaleDraftDTO implements java.io.Serializable {
    ...
    private CliPatologiaDraftRoleRefsDTO esito_biopsia;

    public CliEsame_strumentaleDraftDTO() {
    }
    ...
    public CliPatologiaDraftRoleRefsDTO getEsito_biopsia() {
        return esito_biopsia;
    }
    public void setEsito_biopsia(CliPatologiaDraftRoleRefsDTO esito_biopsia) {
    ...
    public static CliEsame_strumentaleDraftDTO.Builder builder() {
        return new CliEsame_strumentaleDraftDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setEsito_biopsia(CliPatologiaDraftRoleRefsDTO esito_biopsia) {
            this.esito_biopsia = esito_biopsia;
            return this;
        }


        public CliEsame_strumentaleDraftDTO build() {
            CliEsame_strumentaleDraftDTO result = new CliEsame_strumentaleDraftDTO();

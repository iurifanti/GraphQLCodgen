...
/**
 * Define a specific filter for objects of type Tipo_esame.
...
public class CliTipo_esameFilterDTO implements java.io.Serializable {
    ...
    private java.util.List<CliTipo_esameFilterDTO> AND;
    private java.util.List<CliTipo_esameFilterDTO> OR;
    private CliTipo_esameFilterDTO NOT;

    public CliTipo_esameFilterDTO() {
    }
    ...
    public java.util.List<CliTipo_esameFilterDTO> getAND() {
        return AND;
    }
    public void setAND(java.util.List<CliTipo_esameFilterDTO> AND) {
        this.AND = AND;
    }

    public java.util.List<CliTipo_esameFilterDTO> getOR() {
        return OR;
    }
    public void setOR(java.util.List<CliTipo_esameFilterDTO> OR) {
        this.OR = OR;
    }

    public CliTipo_esameFilterDTO getNOT() {
        return NOT;
    }
    public void setNOT(CliTipo_esameFilterDTO NOT) {
        this.NOT = NOT;
    }
    ...
    public static CliTipo_esameFilterDTO.Builder builder() {
        return new CliTipo_esameFilterDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setAND(java.util.List<CliTipo_esameFilterDTO> AND) {
            this.AND = AND;
            return this;
        }

        public Builder setOR(java.util.List<CliTipo_esameFilterDTO> OR) {
            this.OR = OR;
            return this;
        }

        public Builder setNOT(CliTipo_esameFilterDTO NOT) {
            this.NOT = NOT;
            return this;
        }


        public CliTipo_esameFilterDTO build() {
            CliTipo_esameFilterDTO result = new CliTipo_esameFilterDTO();

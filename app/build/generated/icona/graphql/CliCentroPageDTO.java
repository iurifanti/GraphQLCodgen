...
/**
 * Represents a collection of objects of class Centro.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliCentroPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliCentroDTO> items;
    ...
    public CliCentroPageDTO() {
    }


    /**
     * An array containing the actual objects of class Centro.
     */
    public java.util.List<CliCentroDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Centro.
     */
    public void setItems(java.util.List<CliCentroDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Centro present in the database.
     */
    ...
    public static CliCentroPageDTO.Builder builder() {
        return new CliCentroPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Centro.
         */
        public Builder setItems(java.util.List<CliCentroDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliCentroPageDTO build() {
            CliCentroPageDTO result = new CliCentroPageDTO();

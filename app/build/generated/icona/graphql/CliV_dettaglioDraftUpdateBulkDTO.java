...
/**
 * A data structure for a draft update objects of class V_dettaglio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliV_dettaglioDraftUpdateBulkDTO implements java.io.Serializable {
    ...
    private CliDose_vaccino_covidDraftUpdateRoleObjectsDTO dose_vaccino_covid_;
    ...
    private CliSierologie_covidDraftUpdateRoleObjectsDTO sierologie_covid_;
    ...
    public CliV_dettaglioDraftUpdateBulkDTO() {
    }
    ...
    public CliDose_vaccino_covidDraftUpdateRoleObjectsDTO getDose_vaccino_covid_() {
        return dose_vaccino_covid_;
    }
    public void setDose_vaccino_covid_(CliDose_vaccino_covidDraftUpdateRoleObjectsDTO dose_vaccino_covid_) {
    ...
    public CliSierologie_covidDraftUpdateRoleObjectsDTO getSierologie_covid_() {
        return sierologie_covid_;
    }
    public void setSierologie_covid_(CliSierologie_covidDraftUpdateRoleObjectsDTO sierologie_covid_) {
    ...
    public static CliV_dettaglioDraftUpdateBulkDTO.Builder builder() {
        return new CliV_dettaglioDraftUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setDose_vaccino_covid_(CliDose_vaccino_covidDraftUpdateRoleObjectsDTO dose_vaccino_covid_) {
            this.dose_vaccino_covid_ = dose_vaccino_covid_;
            return this;
        }
        ...
        public Builder setSierologie_covid_(CliSierologie_covidDraftUpdateRoleObjectsDTO sierologie_covid_) {
            this.sierologie_covid_ = sierologie_covid_;
            return this;
        }
        ...
        public CliV_dettaglioDraftUpdateBulkDTO build() {
            CliV_dettaglioDraftUpdateBulkDTO result = new CliV_dettaglioDraftUpdateBulkDTO();

...
/**
 * Represents a collection of objects of class Sede_biobanca.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliSede_biobancaPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliSede_biobancaDTO> items;
    ...
    public CliSede_biobancaPageDTO() {
    }


    /**
     * An array containing the actual objects of class Sede_biobanca.
     */
    public java.util.List<CliSede_biobancaDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Sede_biobanca.
     */
    public void setItems(java.util.List<CliSede_biobancaDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Sede_biobanca present in the database.
     */
    ...
    public static CliSede_biobancaPageDTO.Builder builder() {
        return new CliSede_biobancaPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Sede_biobanca.
         */
        public Builder setItems(java.util.List<CliSede_biobancaDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliSede_biobancaPageDTO build() {
            CliSede_biobancaPageDTO result = new CliSede_biobancaPageDTO();

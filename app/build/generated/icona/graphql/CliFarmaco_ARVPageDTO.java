...
/**
 * Represents a collection of objects of class Farmaco_ARV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliFarmaco_ARVPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliFarmaco_ARVDTO> items;
    ...
    public CliFarmaco_ARVPageDTO() {
    }


    /**
     * An array containing the actual objects of class Farmaco_ARV.
     */
    public java.util.List<CliFarmaco_ARVDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Farmaco_ARV.
     */
    public void setItems(java.util.List<CliFarmaco_ARVDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Farmaco_ARV present in the database.
     */
    ...
    public static CliFarmaco_ARVPageDTO.Builder builder() {
        return new CliFarmaco_ARVPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Farmaco_ARV.
         */
        public Builder setItems(java.util.List<CliFarmaco_ARVDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliFarmaco_ARVPageDTO build() {
            CliFarmaco_ARVPageDTO result = new CliFarmaco_ARVPageDTO();

...
public class Paziente___createMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Paziente___create";
    ...
    public Paziente___createMutationRequest() {
    }

    public Paziente___createMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliPazienteCreateDTO data) {
    ...
    public static Paziente___createMutationRequest.Builder builder() {
        return new Paziente___createMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliPazienteCreateDTO data;
        ...
        public Builder setData(CliPazienteCreateDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Paziente___createMutationRequest build() {
            Paziente___createMutationRequest obj = new Paziente___createMutationRequest($alias);
            obj.setData(data);

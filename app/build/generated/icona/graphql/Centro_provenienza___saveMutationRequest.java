...
public class Centro_provenienza___saveMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Centro_provenienza___save";
    ...
    public Centro_provenienza___saveMutationRequest() {
    }

    public Centro_provenienza___saveMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Centro_provenienza___saveMutationRequest.Builder builder() {
        return new Centro_provenienza___saveMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Centro_provenienza___saveMutationRequest build() {
            Centro_provenienza___saveMutationRequest obj = new Centro_provenienza___saveMutationRequest($alias);
            obj.setData(data);

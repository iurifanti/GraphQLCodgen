...
/**
 * Represents a collection of objects of class Terapia_ARV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliTerapia_ARVPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliTerapia_ARVDTO> items;
    ...
    public CliTerapia_ARVPageDTO() {
    }


    /**
     * An array containing the actual objects of class Terapia_ARV.
     */
    public java.util.List<CliTerapia_ARVDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Terapia_ARV.
     */
    public void setItems(java.util.List<CliTerapia_ARVDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Terapia_ARV present in the database.
     */
    ...
    public static CliTerapia_ARVPageDTO.Builder builder() {
        return new CliTerapia_ARVPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Terapia_ARV.
         */
        public Builder setItems(java.util.List<CliTerapia_ARVDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliTerapia_ARVPageDTO build() {
            CliTerapia_ARVPageDTO result = new CliTerapia_ARVPageDTO();

...
public class Cli_UserDraftUpdateBulkDTO implements java.io.Serializable {
    ...
    public Cli_UserDraftUpdateBulkDTO() {
    }
    ...
    public static Cli_UserDraftUpdateBulkDTO.Builder builder() {
        return new Cli_UserDraftUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Cli_UserDraftUpdateBulkDTO build() {
            Cli_UserDraftUpdateBulkDTO result = new Cli_UserDraftUpdateBulkDTO();

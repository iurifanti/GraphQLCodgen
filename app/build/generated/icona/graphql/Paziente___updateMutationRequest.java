...
public class Paziente___updateMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Paziente___update";
    ...
    public Paziente___updateMutationRequest() {
    }

    public Paziente___updateMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliPazienteUpdateDTO data) {
    ...
    public static Paziente___updateMutationRequest.Builder builder() {
        return new Paziente___updateMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliPazienteUpdateDTO data;
        ...
        public Builder setData(CliPazienteUpdateDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Paziente___updateMutationRequest build() {
            Paziente___updateMutationRequest obj = new Paziente___updateMutationRequest($alias);
            obj.setData(data);

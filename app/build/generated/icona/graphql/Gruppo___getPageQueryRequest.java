...
public class Gruppo___getPageQueryRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Gruppo___getPage";
    ...
    public Gruppo___getPageQueryRequest() {
    }

    public Gruppo___getPageQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Gruppo___getPageQueryRequest.Builder builder() {
        return new Gruppo___getPageQueryRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Gruppo___getPageQueryRequest build() {
            Gruppo___getPageQueryRequest obj = new Gruppo___getPageQueryRequest($alias);

...
/**
 * Represents a collection of objects of class Metodica_HIVRNA.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliMetodica_HIVRNAPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliMetodica_HIVRNADTO> items;
    ...
    public CliMetodica_HIVRNAPageDTO() {
    }


    /**
     * An array containing the actual objects of class Metodica_HIVRNA.
     */
    public java.util.List<CliMetodica_HIVRNADTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Metodica_HIVRNA.
     */
    public void setItems(java.util.List<CliMetodica_HIVRNADTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Metodica_HIVRNA present in the database.
     */
    ...
    public static CliMetodica_HIVRNAPageDTO.Builder builder() {
        return new CliMetodica_HIVRNAPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Metodica_HIVRNA.
         */
        public Builder setItems(java.util.List<CliMetodica_HIVRNADTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliMetodica_HIVRNAPageDTO build() {
            CliMetodica_HIVRNAPageDTO result = new CliMetodica_HIVRNAPageDTO();

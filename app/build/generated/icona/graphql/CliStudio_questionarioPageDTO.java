...
/**
 * Represents a collection of objects of class Studio_questionario.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliStudio_questionarioPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliStudio_questionarioDTO> items;
    ...
    public CliStudio_questionarioPageDTO() {
    }


    /**
     * An array containing the actual objects of class Studio_questionario.
     */
    public java.util.List<CliStudio_questionarioDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Studio_questionario.
     */
    public void setItems(java.util.List<CliStudio_questionarioDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Studio_questionario present in the database.
     */
    ...
    public static CliStudio_questionarioPageDTO.Builder builder() {
        return new CliStudio_questionarioPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Studio_questionario.
         */
        public Builder setItems(java.util.List<CliStudio_questionarioDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliStudio_questionarioPageDTO build() {
            CliStudio_questionarioPageDTO result = new CliStudio_questionarioPageDTO();

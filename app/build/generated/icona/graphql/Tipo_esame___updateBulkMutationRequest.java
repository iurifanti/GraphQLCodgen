...
public class Tipo_esame___updateBulkMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Tipo_esame___updateBulk";
    ...
    public Tipo_esame___updateBulkMutationRequest() {
    }

    public Tipo_esame___updateBulkMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliTipo_esameUpdateBulkDTO data) {
    ...
    public static Tipo_esame___updateBulkMutationRequest.Builder builder() {
        return new Tipo_esame___updateBulkMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliTipo_esameUpdateBulkDTO data;
        ...
        public Builder setData(CliTipo_esameUpdateBulkDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Tipo_esame___updateBulkMutationRequest build() {
            Tipo_esame___updateBulkMutationRequest obj = new Tipo_esame___updateBulkMutationRequest($alias);
            obj.setData(data);

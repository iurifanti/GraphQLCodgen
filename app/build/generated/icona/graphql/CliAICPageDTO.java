...
/**
 * Represents a collection of objects of class AIC.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliAICPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliAICDTO> items;
    ...
    public CliAICPageDTO() {
    }


    /**
     * An array containing the actual objects of class AIC.
     */
    public java.util.List<CliAICDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class AIC.
     */
    public void setItems(java.util.List<CliAICDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class AIC present in the database.
     */
    ...
    public static CliAICPageDTO.Builder builder() {
        return new CliAICPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class AIC.
         */
        public Builder setItems(java.util.List<CliAICDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliAICPageDTO build() {
            CliAICPageDTO result = new CliAICPageDTO();

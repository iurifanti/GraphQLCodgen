...
/**
 * A data structure for draft create objects of class P_Paziente.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliP_PazienteDraftCreateDTO implements java.io.Serializable {
    ...
    private java.util.List<CliQuestionario_PRO_appDraftCreateDTO> questionario_PRO_app_;
    private java.util.List<String> studio_questionario_;

    public CliP_PazienteDraftCreateDTO() {
    }
    ...
    public java.util.List<CliQuestionario_PRO_appDraftCreateDTO> getQuestionario_PRO_app_() {
        return questionario_PRO_app_;
    }
    public void setQuestionario_PRO_app_(java.util.List<CliQuestionario_PRO_appDraftCreateDTO> questionario_PRO_app_) {
    ...
    public static CliP_PazienteDraftCreateDTO.Builder builder() {
        return new CliP_PazienteDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setQuestionario_PRO_app_(java.util.List<CliQuestionario_PRO_appDraftCreateDTO> questionario_PRO_app_) {
            this.questionario_PRO_app_ = questionario_PRO_app_;
            return this;
        }
        ...
        public CliP_PazienteDraftCreateDTO build() {
            CliP_PazienteDraftCreateDTO result = new CliP_PazienteDraftCreateDTO();

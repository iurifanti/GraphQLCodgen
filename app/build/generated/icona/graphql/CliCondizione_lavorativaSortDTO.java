...
public enum CliCondizione_lavorativaSortDTO {
    ...
    probul___ASC("probul___ASC"),
    probul___DESC("probul___DESC");

    private final String graphqlName;

    private CliCondizione_lavorativaSortDTO(String graphqlName) {

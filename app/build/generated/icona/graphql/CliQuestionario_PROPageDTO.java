...
/**
 * Represents a collection of objects of class Questionario_PRO.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliQuestionario_PROPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliQuestionario_PRODTO> items;
    ...
    public CliQuestionario_PROPageDTO() {
    }


    /**
     * An array containing the actual objects of class Questionario_PRO.
     */
    public java.util.List<CliQuestionario_PRODTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Questionario_PRO.
     */
    public void setItems(java.util.List<CliQuestionario_PRODTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Questionario_PRO present in the database.
     */
    ...
    public static CliQuestionario_PROPageDTO.Builder builder() {
        return new CliQuestionario_PROPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Questionario_PRO.
         */
        public Builder setItems(java.util.List<CliQuestionario_PRODTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliQuestionario_PROPageDTO build() {
            CliQuestionario_PROPageDTO result = new CliQuestionario_PROPageDTO();

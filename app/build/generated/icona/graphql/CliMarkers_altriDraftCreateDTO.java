...
/**
 * A data structure for draft create objects of class Markers_altri.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliMarkers_altriDraftCreateDTO implements java.io.Serializable {
    ...
    private String tipo_marker_;

    public CliMarkers_altriDraftCreateDTO() {
    }
    ...
    public String getTipo_marker_() {
        return tipo_marker_;
    }
    public void setTipo_marker_(String tipo_marker_) {
    ...
    public static CliMarkers_altriDraftCreateDTO.Builder builder() {
        return new CliMarkers_altriDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setTipo_marker_(String tipo_marker_) {
            this.tipo_marker_ = tipo_marker_;
            return this;
        }


        public CliMarkers_altriDraftCreateDTO build() {
            CliMarkers_altriDraftCreateDTO result = new CliMarkers_altriDraftCreateDTO();

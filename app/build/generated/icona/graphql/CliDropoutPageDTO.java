...
/**
 * Represents a collection of objects of class Dropout.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliDropoutPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliDropoutDTO> items;
    ...
    public CliDropoutPageDTO() {
    }


    /**
     * An array containing the actual objects of class Dropout.
     */
    public java.util.List<CliDropoutDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Dropout.
     */
    public void setItems(java.util.List<CliDropoutDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Dropout present in the database.
     */
    ...
    public static CliDropoutPageDTO.Builder builder() {
        return new CliDropoutPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Dropout.
         */
        public Builder setItems(java.util.List<CliDropoutDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliDropoutPageDTO build() {
            CliDropoutPageDTO result = new CliDropoutPageDTO();

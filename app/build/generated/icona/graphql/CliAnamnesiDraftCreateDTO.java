...
/**
 * A data structure for draft create objects of class Anamnesi.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliAnamnesiDraftCreateDTO implements java.io.Serializable {
    ...
    private String luogo_test_HIV_;
    private String motivazione_naive;

    public CliAnamnesiDraftCreateDTO() {
    }
    ...
    public String getLuogo_test_HIV_() {
        return luogo_test_HIV_;
    }
    public void setLuogo_test_HIV_(String luogo_test_HIV_) {
        this.luogo_test_HIV_ = luogo_test_HIV_;
    }

    public String getMotivazione_naive() {
        return motivazione_naive;
    }
    public void setMotivazione_naive(String motivazione_naive) {
    ...
    public static CliAnamnesiDraftCreateDTO.Builder builder() {
        return new CliAnamnesiDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setLuogo_test_HIV_(String luogo_test_HIV_) {
            this.luogo_test_HIV_ = luogo_test_HIV_;
            return this;
        }

        public Builder setMotivazione_naive(String motivazione_naive) {
            this.motivazione_naive = motivazione_naive;
            return this;
        }


        public CliAnamnesiDraftCreateDTO build() {
            CliAnamnesiDraftCreateDTO result = new CliAnamnesiDraftCreateDTO();

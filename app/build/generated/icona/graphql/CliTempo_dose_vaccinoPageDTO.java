...
/**
 * Represents a collection of objects of class Tempo_dose_vaccino.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliTempo_dose_vaccinoPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliTempo_dose_vaccinoDTO> items;
    ...
    public CliTempo_dose_vaccinoPageDTO() {
    }


    /**
     * An array containing the actual objects of class Tempo_dose_vaccino.
     */
    public java.util.List<CliTempo_dose_vaccinoDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Tempo_dose_vaccino.
     */
    public void setItems(java.util.List<CliTempo_dose_vaccinoDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Tempo_dose_vaccino present in the database.
     */
    ...
    public static CliTempo_dose_vaccinoPageDTO.Builder builder() {
        return new CliTempo_dose_vaccinoPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Tempo_dose_vaccino.
         */
        public Builder setItems(java.util.List<CliTempo_dose_vaccinoDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliTempo_dose_vaccinoPageDTO build() {
            CliTempo_dose_vaccinoPageDTO result = new CliTempo_dose_vaccinoPageDTO();

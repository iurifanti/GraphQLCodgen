...
/**
 * Define a specific filter for objects of type Metodica_sierologia_covid.
...
public class CliMetodica_sierologia_covidFilterDTO implements java.io.Serializable {
    ...
    private java.util.List<CliMetodica_sierologia_covidFilterDTO> AND;
    private java.util.List<CliMetodica_sierologia_covidFilterDTO> OR;
    private CliMetodica_sierologia_covidFilterDTO NOT;

    public CliMetodica_sierologia_covidFilterDTO() {
    }
    ...
    public java.util.List<CliMetodica_sierologia_covidFilterDTO> getAND() {
        return AND;
    }
    public void setAND(java.util.List<CliMetodica_sierologia_covidFilterDTO> AND) {
        this.AND = AND;
    }

    public java.util.List<CliMetodica_sierologia_covidFilterDTO> getOR() {
        return OR;
    }
    public void setOR(java.util.List<CliMetodica_sierologia_covidFilterDTO> OR) {
        this.OR = OR;
    }

    public CliMetodica_sierologia_covidFilterDTO getNOT() {
        return NOT;
    }
    public void setNOT(CliMetodica_sierologia_covidFilterDTO NOT) {
        this.NOT = NOT;
    }
    ...
    public static CliMetodica_sierologia_covidFilterDTO.Builder builder() {
        return new CliMetodica_sierologia_covidFilterDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setAND(java.util.List<CliMetodica_sierologia_covidFilterDTO> AND) {
            this.AND = AND;
            return this;
        }

        public Builder setOR(java.util.List<CliMetodica_sierologia_covidFilterDTO> OR) {
            this.OR = OR;
            return this;
        }

        public Builder setNOT(CliMetodica_sierologia_covidFilterDTO NOT) {
            this.NOT = NOT;
            return this;
        }


        public CliMetodica_sierologia_covidFilterDTO build() {
            CliMetodica_sierologia_covidFilterDTO result = new CliMetodica_sierologia_covidFilterDTO();

...
public class CliCentro_provenienzaCursorDTO implements java.io.Serializable {
    ...
    public CliCentro_provenienzaCursorDTO() {
    }
    ...
    public static CliCentro_provenienzaCursorDTO.Builder builder() {
        return new CliCentro_provenienzaCursorDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public CliCentro_provenienzaCursorDTO build() {
            CliCentro_provenienzaCursorDTO result = new CliCentro_provenienzaCursorDTO();

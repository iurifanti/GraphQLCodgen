...
public class Tipo_esame___createMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Tipo_esame___create";
    ...
    public Tipo_esame___createMutationRequest() {
    }

    public Tipo_esame___createMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliTipo_esameCreateDTO data) {
    ...
    public static Tipo_esame___createMutationRequest.Builder builder() {
        return new Tipo_esame___createMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliTipo_esameCreateDTO data;
        ...
        public Builder setData(CliTipo_esameCreateDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Tipo_esame___createMutationRequest build() {
            Tipo_esame___createMutationRequest obj = new Tipo_esame___createMutationRequest($alias);
            obj.setData(data);

...
/**
 * A data structure for draft create objects of class Terapia_ARV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliTerapia_ARVDraftCreateDTO implements java.io.Serializable {
    ...
    private String farmaco_ARV;
    private String motivazione_fine_ARV_princ;
    private String motivazione_fine_ARV_sec;
    private String motivazione_inizio_ARV;
    private java.util.List<String> warning_;

    public CliTerapia_ARVDraftCreateDTO() {
    }
    ...
    public String getFarmaco_ARV() {
        return farmaco_ARV;
    }
    public void setFarmaco_ARV(String farmaco_ARV) {
        this.farmaco_ARV = farmaco_ARV;
    }

    public String getMotivazione_fine_ARV_princ() {
        return motivazione_fine_ARV_princ;
    }
    public void setMotivazione_fine_ARV_princ(String motivazione_fine_ARV_princ) {
        this.motivazione_fine_ARV_princ = motivazione_fine_ARV_princ;
    }

    public String getMotivazione_fine_ARV_sec() {
        return motivazione_fine_ARV_sec;
    }
    public void setMotivazione_fine_ARV_sec(String motivazione_fine_ARV_sec) {
        this.motivazione_fine_ARV_sec = motivazione_fine_ARV_sec;
    }

    public String getMotivazione_inizio_ARV() {
        return motivazione_inizio_ARV;
    }
    public void setMotivazione_inizio_ARV(String motivazione_inizio_ARV) {
        this.motivazione_inizio_ARV = motivazione_inizio_ARV;
    }

    public java.util.List<String> getWarning_() {
        return warning_;
    }
    public void setWarning_(java.util.List<String> warning_) {
    ...
    public static CliTerapia_ARVDraftCreateDTO.Builder builder() {
        return new CliTerapia_ARVDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setFarmaco_ARV(String farmaco_ARV) {
            this.farmaco_ARV = farmaco_ARV;
            return this;
        }

        public Builder setMotivazione_fine_ARV_princ(String motivazione_fine_ARV_princ) {
            this.motivazione_fine_ARV_princ = motivazione_fine_ARV_princ;
            return this;
        }

        public Builder setMotivazione_fine_ARV_sec(String motivazione_fine_ARV_sec) {
            this.motivazione_fine_ARV_sec = motivazione_fine_ARV_sec;
            return this;
        }

        public Builder setMotivazione_inizio_ARV(String motivazione_inizio_ARV) {
            this.motivazione_inizio_ARV = motivazione_inizio_ARV;
            return this;
        }

        public Builder setWarning_(java.util.List<String> warning_) {
            this.warning_ = warning_;
            return this;
        }


        public CliTerapia_ARVDraftCreateDTO build() {
            CliTerapia_ARVDraftCreateDTO result = new CliTerapia_ARVDraftCreateDTO();

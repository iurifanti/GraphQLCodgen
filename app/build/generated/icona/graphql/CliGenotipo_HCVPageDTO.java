...
/**
 * Represents a collection of objects of class Genotipo_HCV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliGenotipo_HCVPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliGenotipo_HCVDTO> items;
    ...
    public CliGenotipo_HCVPageDTO() {
    }


    /**
     * An array containing the actual objects of class Genotipo_HCV.
     */
    public java.util.List<CliGenotipo_HCVDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Genotipo_HCV.
     */
    public void setItems(java.util.List<CliGenotipo_HCVDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Genotipo_HCV present in the database.
     */
    ...
    public static CliGenotipo_HCVPageDTO.Builder builder() {
        return new CliGenotipo_HCVPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Genotipo_HCV.
         */
        public Builder setItems(java.util.List<CliGenotipo_HCVDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliGenotipo_HCVPageDTO build() {
            CliGenotipo_HCVPageDTO result = new CliGenotipo_HCVPageDTO();

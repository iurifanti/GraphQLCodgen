...
/**
 * Represents a collection of objects of class Unita_di_misura_viremia.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliUnita_di_misura_viremiaPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliUnita_di_misura_viremiaDTO> items;
    ...
    public CliUnita_di_misura_viremiaPageDTO() {
    }


    /**
     * An array containing the actual objects of class Unita_di_misura_viremia.
     */
    public java.util.List<CliUnita_di_misura_viremiaDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Unita_di_misura_viremia.
     */
    public void setItems(java.util.List<CliUnita_di_misura_viremiaDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Unita_di_misura_viremia present in the database.
     */
    ...
    public static CliUnita_di_misura_viremiaPageDTO.Builder builder() {
        return new CliUnita_di_misura_viremiaPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Unita_di_misura_viremia.
         */
        public Builder setItems(java.util.List<CliUnita_di_misura_viremiaDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliUnita_di_misura_viremiaPageDTO build() {
            CliUnita_di_misura_viremiaPageDTO result = new CliUnita_di_misura_viremiaPageDTO();

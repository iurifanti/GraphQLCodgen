...
/**
 * Represents a collection of objects of class Testo_intro.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliTesto_introPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliTesto_introDTO> items;
    ...
    public CliTesto_introPageDTO() {
    }


    /**
     * An array containing the actual objects of class Testo_intro.
     */
    public java.util.List<CliTesto_introDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Testo_intro.
     */
    public void setItems(java.util.List<CliTesto_introDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Testo_intro present in the database.
     */
    ...
    public static CliTesto_introPageDTO.Builder builder() {
        return new CliTesto_introPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Testo_intro.
         */
        public Builder setItems(java.util.List<CliTesto_introDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliTesto_introPageDTO build() {
            CliTesto_introPageDTO result = new CliTesto_introPageDTO();

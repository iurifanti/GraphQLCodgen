...
/**
 * A data structure for a draft update objects of class C_dettaglio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliC_dettaglioDraftUpdateBulkDTO implements java.io.Serializable {
    ...
    private CliEventoDraftUpdateRoleObjectsDTO evento_covid;
    ...
    private CliTerapia_covidDraftUpdateRoleObjectsDTO terapia_covid_;

    public CliC_dettaglioDraftUpdateBulkDTO() {
    }
    ...
    public CliEventoDraftUpdateRoleObjectsDTO getEvento_covid() {
        return evento_covid;
    }
    public void setEvento_covid(CliEventoDraftUpdateRoleObjectsDTO evento_covid) {
    ...
    public CliTerapia_covidDraftUpdateRoleObjectsDTO getTerapia_covid_() {
        return terapia_covid_;
    }
    public void setTerapia_covid_(CliTerapia_covidDraftUpdateRoleObjectsDTO terapia_covid_) {
    ...
    public static CliC_dettaglioDraftUpdateBulkDTO.Builder builder() {
        return new CliC_dettaglioDraftUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setEvento_covid(CliEventoDraftUpdateRoleObjectsDTO evento_covid) {
            this.evento_covid = evento_covid;
            return this;
        }
        ...
        public Builder setTerapia_covid_(CliTerapia_covidDraftUpdateRoleObjectsDTO terapia_covid_) {
            this.terapia_covid_ = terapia_covid_;
            return this;
        }


        public CliC_dettaglioDraftUpdateBulkDTO build() {
            CliC_dettaglioDraftUpdateBulkDTO result = new CliC_dettaglioDraftUpdateBulkDTO();

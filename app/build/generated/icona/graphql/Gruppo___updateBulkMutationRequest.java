...
public class Gruppo___updateBulkMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Gruppo___updateBulk";
    ...
    public Gruppo___updateBulkMutationRequest() {
    }

    public Gruppo___updateBulkMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliGruppoUpdateBulkDTO data) {
    ...
    public static Gruppo___updateBulkMutationRequest.Builder builder() {
        return new Gruppo___updateBulkMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliGruppoUpdateBulkDTO data;
        ...
        public Builder setData(CliGruppoUpdateBulkDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Gruppo___updateBulkMutationRequest build() {
            Gruppo___updateBulkMutationRequest obj = new Gruppo___updateBulkMutationRequest($alias);
            obj.setData(data);

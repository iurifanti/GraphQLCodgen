...
/**
 * A data structure for a draft update objects of class Dropout.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliDropoutDraftUpdateBulkDTO implements java.io.Serializable {
    ...
    private CliCausa_decessoRoleRefDTO causa_decesso;
    private CliCausa_decessoRoleRefDTO causa_decesso_sec;
    private CliCausa_decessoRoleRefDTO causa_decesso_stimata;
    private CliMotivazione_dropoutRoleRefDTO motivazione_dropout;
    private CliRelazione_decessoRoleRefDTO relazione_decesso_1;
    private CliRelazione_decessoRoleRefDTO relazione_decesso_2;
    private CliSede_decessoRoleRefDTO sede_decesso;

    public CliDropoutDraftUpdateBulkDTO() {
    }
    ...
    public CliCausa_decessoRoleRefDTO getCausa_decesso() {
        return causa_decesso;
    }
    public void setCausa_decesso(CliCausa_decessoRoleRefDTO causa_decesso) {
        this.causa_decesso = causa_decesso;
    }

    public CliCausa_decessoRoleRefDTO getCausa_decesso_sec() {
        return causa_decesso_sec;
    }
    public void setCausa_decesso_sec(CliCausa_decessoRoleRefDTO causa_decesso_sec) {
        this.causa_decesso_sec = causa_decesso_sec;
    }

    public CliCausa_decessoRoleRefDTO getCausa_decesso_stimata() {
        return causa_decesso_stimata;
    }
    public void setCausa_decesso_stimata(CliCausa_decessoRoleRefDTO causa_decesso_stimata) {
        this.causa_decesso_stimata = causa_decesso_stimata;
    }

    public CliMotivazione_dropoutRoleRefDTO getMotivazione_dropout() {
        return motivazione_dropout;
    }
    public void setMotivazione_dropout(CliMotivazione_dropoutRoleRefDTO motivazione_dropout) {
        this.motivazione_dropout = motivazione_dropout;
    }

    public CliRelazione_decessoRoleRefDTO getRelazione_decesso_1() {
        return relazione_decesso_1;
    }
    public void setRelazione_decesso_1(CliRelazione_decessoRoleRefDTO relazione_decesso_1) {
        this.relazione_decesso_1 = relazione_decesso_1;
    }

    public CliRelazione_decessoRoleRefDTO getRelazione_decesso_2() {
        return relazione_decesso_2;
    }
    public void setRelazione_decesso_2(CliRelazione_decessoRoleRefDTO relazione_decesso_2) {
        this.relazione_decesso_2 = relazione_decesso_2;
    }

    public CliSede_decessoRoleRefDTO getSede_decesso() {
        return sede_decesso;
    }
    public void setSede_decesso(CliSede_decessoRoleRefDTO sede_decesso) {
    ...
    public static CliDropoutDraftUpdateBulkDTO.Builder builder() {
        return new CliDropoutDraftUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setCausa_decesso(CliCausa_decessoRoleRefDTO causa_decesso) {
            this.causa_decesso = causa_decesso;
            return this;
        }

        public Builder setCausa_decesso_sec(CliCausa_decessoRoleRefDTO causa_decesso_sec) {
            this.causa_decesso_sec = causa_decesso_sec;
            return this;
        }

        public Builder setCausa_decesso_stimata(CliCausa_decessoRoleRefDTO causa_decesso_stimata) {
            this.causa_decesso_stimata = causa_decesso_stimata;
            return this;
        }

        public Builder setMotivazione_dropout(CliMotivazione_dropoutRoleRefDTO motivazione_dropout) {
            this.motivazione_dropout = motivazione_dropout;
            return this;
        }

        public Builder setRelazione_decesso_1(CliRelazione_decessoRoleRefDTO relazione_decesso_1) {
            this.relazione_decesso_1 = relazione_decesso_1;
            return this;
        }

        public Builder setRelazione_decesso_2(CliRelazione_decessoRoleRefDTO relazione_decesso_2) {
            this.relazione_decesso_2 = relazione_decesso_2;
            return this;
        }

        public Builder setSede_decesso(CliSede_decessoRoleRefDTO sede_decesso) {
            this.sede_decesso = sede_decesso;
            return this;
        }


        public CliDropoutDraftUpdateBulkDTO build() {
            CliDropoutDraftUpdateBulkDTO result = new CliDropoutDraftUpdateBulkDTO();

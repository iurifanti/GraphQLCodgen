...
/**
 * Represents a collection of objects of class Farmaco_altro.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliFarmaco_altroPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliFarmaco_altroDTO> items;
    ...
    public CliFarmaco_altroPageDTO() {
    }


    /**
     * An array containing the actual objects of class Farmaco_altro.
     */
    public java.util.List<CliFarmaco_altroDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Farmaco_altro.
     */
    public void setItems(java.util.List<CliFarmaco_altroDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Farmaco_altro present in the database.
     */
    ...
    public static CliFarmaco_altroPageDTO.Builder builder() {
        return new CliFarmaco_altroPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Farmaco_altro.
         */
        public Builder setItems(java.util.List<CliFarmaco_altroDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliFarmaco_altroPageDTO build() {
            CliFarmaco_altroPageDTO result = new CliFarmaco_altroPageDTO();

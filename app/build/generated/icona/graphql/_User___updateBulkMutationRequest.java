...
public class _User___updateBulkMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "_User___updateBulk";
    ...
    public _User___updateBulkMutationRequest() {
    }

    public _User___updateBulkMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(Cli_UserUpdateBulkDTO data) {
    ...
    public static _User___updateBulkMutationRequest.Builder builder() {
        return new _User___updateBulkMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private Cli_UserUpdateBulkDTO data;
        ...
        public Builder setData(Cli_UserUpdateBulkDTO data) {
            this.data = data;
            return this;
        }
        ...
        public _User___updateBulkMutationRequest build() {
            _User___updateBulkMutationRequest obj = new _User___updateBulkMutationRequest($alias);
            obj.setData(data);

...
/**
 * Represents a collection of objects of class Questionario.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliQuestionarioPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliQuestionarioDTO> items;
    ...
    public CliQuestionarioPageDTO() {
    }


    /**
     * An array containing the actual objects of class Questionario.
     */
    public java.util.List<CliQuestionarioDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Questionario.
     */
    public void setItems(java.util.List<CliQuestionarioDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Questionario present in the database.
     */
    ...
    public static CliQuestionarioPageDTO.Builder builder() {
        return new CliQuestionarioPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Questionario.
         */
        public Builder setItems(java.util.List<CliQuestionarioDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliQuestionarioPageDTO build() {
            CliQuestionarioPageDTO result = new CliQuestionarioPageDTO();

...
public class Centro_provenienza___updateBulkMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Centro_provenienza___updateBulk";
    ...
    public Centro_provenienza___updateBulkMutationRequest() {
    }

    public Centro_provenienza___updateBulkMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliCentro_provenienzaUpdateBulkDTO data) {
    ...
    public static Centro_provenienza___updateBulkMutationRequest.Builder builder() {
        return new Centro_provenienza___updateBulkMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliCentro_provenienzaUpdateBulkDTO data;
        ...
        public Builder setData(CliCentro_provenienzaUpdateBulkDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Centro_provenienza___updateBulkMutationRequest build() {
            Centro_provenienza___updateBulkMutationRequest obj = new Centro_provenienza___updateBulkMutationRequest($alias);
            obj.setData(data);

...
/**
 * Represents a collection of objects of class Controllo_clinico.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliControllo_clinicoPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliControllo_clinicoDTO> items;
    ...
    public CliControllo_clinicoPageDTO() {
    }


    /**
     * An array containing the actual objects of class Controllo_clinico.
     */
    public java.util.List<CliControllo_clinicoDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Controllo_clinico.
     */
    public void setItems(java.util.List<CliControllo_clinicoDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Controllo_clinico present in the database.
     */
    ...
    public static CliControllo_clinicoPageDTO.Builder builder() {
        return new CliControllo_clinicoPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Controllo_clinico.
         */
        public Builder setItems(java.util.List<CliControllo_clinicoDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliControllo_clinicoPageDTO build() {
            CliControllo_clinicoPageDTO result = new CliControllo_clinicoPageDTO();

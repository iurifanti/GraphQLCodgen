...
public class Comorbidita_mpv___getPageQueryRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Comorbidita_mpv___getPage";
    ...
    public Comorbidita_mpv___getPageQueryRequest() {
    }

    public Comorbidita_mpv___getPageQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Comorbidita_mpv___getPageQueryRequest.Builder builder() {
        return new Comorbidita_mpv___getPageQueryRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Comorbidita_mpv___getPageQueryRequest build() {
            Comorbidita_mpv___getPageQueryRequest obj = new Comorbidita_mpv___getPageQueryRequest($alias);

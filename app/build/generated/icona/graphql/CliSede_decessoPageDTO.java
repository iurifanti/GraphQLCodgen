...
/**
 * Represents a collection of objects of class Sede_decesso.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliSede_decessoPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliSede_decessoDTO> items;
    ...
    public CliSede_decessoPageDTO() {
    }


    /**
     * An array containing the actual objects of class Sede_decesso.
     */
    public java.util.List<CliSede_decessoDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Sede_decesso.
     */
    public void setItems(java.util.List<CliSede_decessoDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Sede_decesso present in the database.
     */
    ...
    public static CliSede_decessoPageDTO.Builder builder() {
        return new CliSede_decessoPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Sede_decesso.
         */
        public Builder setItems(java.util.List<CliSede_decessoDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliSede_decessoPageDTO build() {
            CliSede_decessoPageDTO result = new CliSede_decessoPageDTO();

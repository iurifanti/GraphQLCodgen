...
/**
 * Represents a collection of objects of class Fattore_di_rischio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliFattore_di_rischioPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliFattore_di_rischioDTO> items;
    ...
    public CliFattore_di_rischioPageDTO() {
    }


    /**
     * An array containing the actual objects of class Fattore_di_rischio.
     */
    public java.util.List<CliFattore_di_rischioDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Fattore_di_rischio.
     */
    public void setItems(java.util.List<CliFattore_di_rischioDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Fattore_di_rischio present in the database.
     */
    ...
    public static CliFattore_di_rischioPageDTO.Builder builder() {
        return new CliFattore_di_rischioPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Fattore_di_rischio.
         */
        public Builder setItems(java.util.List<CliFattore_di_rischioDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliFattore_di_rischioPageDTO build() {
            CliFattore_di_rischioPageDTO result = new CliFattore_di_rischioPageDTO();

...
/**
 * Represents a collection of objects of class Metodica_genotipo.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliMetodica_genotipoPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliMetodica_genotipoDTO> items;
    ...
    public CliMetodica_genotipoPageDTO() {
    }


    /**
     * An array containing the actual objects of class Metodica_genotipo.
     */
    public java.util.List<CliMetodica_genotipoDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Metodica_genotipo.
     */
    public void setItems(java.util.List<CliMetodica_genotipoDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Metodica_genotipo present in the database.
     */
    ...
    public static CliMetodica_genotipoPageDTO.Builder builder() {
        return new CliMetodica_genotipoPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Metodica_genotipo.
         */
        public Builder setItems(java.util.List<CliMetodica_genotipoDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliMetodica_genotipoPageDTO build() {
            CliMetodica_genotipoPageDTO result = new CliMetodica_genotipoPageDTO();

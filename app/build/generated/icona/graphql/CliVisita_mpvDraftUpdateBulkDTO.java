...
/**
 * A data structure for a draft update objects of class Visita_mpv.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliVisita_mpvDraftUpdateBulkDTO implements java.io.Serializable {
    ...
    private CliCentro_provenienzaRoleRefDTO centro_provenienza_;
    private CliComorbidita_mpvRoleRefsDTO comorbidita_mpv_;
    private CliDose_mpvDraftUpdateRoleObjectsDTO dose_mpv_;
    private CliEpisodio_MPOXDraftUpdateRoleObjectsDTO episodio_MPOX_;
    private CliGruppoRoleRefDTO gruppo_;
    private CliModalita_somministrazioneRoleRefDTO modalita_somministrazione_pre1;
    private CliModalita_somministrazioneRoleRefDTO modalita_somministrazione_pre2;
    private CliTipo_visita_mpvRoleRefDTO tipo_visita_mp_;
    private CliTipo_visita_mpvRoleRefDTO tipo_visita_mp_booster;

    public CliVisita_mpvDraftUpdateBulkDTO() {
    }
    ...
    public CliCentro_provenienzaRoleRefDTO getCentro_provenienza_() {
        return centro_provenienza_;
    }
    public void setCentro_provenienza_(CliCentro_provenienzaRoleRefDTO centro_provenienza_) {
        this.centro_provenienza_ = centro_provenienza_;
    }

    public CliComorbidita_mpvRoleRefsDTO getComorbidita_mpv_() {
        return comorbidita_mpv_;
    }
    public void setComorbidita_mpv_(CliComorbidita_mpvRoleRefsDTO comorbidita_mpv_) {
        this.comorbidita_mpv_ = comorbidita_mpv_;
    }

    public CliDose_mpvDraftUpdateRoleObjectsDTO getDose_mpv_() {
        return dose_mpv_;
    }
    public void setDose_mpv_(CliDose_mpvDraftUpdateRoleObjectsDTO dose_mpv_) {
        this.dose_mpv_ = dose_mpv_;
    }

    public CliEpisodio_MPOXDraftUpdateRoleObjectsDTO getEpisodio_MPOX_() {
        return episodio_MPOX_;
    }
    public void setEpisodio_MPOX_(CliEpisodio_MPOXDraftUpdateRoleObjectsDTO episodio_MPOX_) {
        this.episodio_MPOX_ = episodio_MPOX_;
    }

    public CliGruppoRoleRefDTO getGruppo_() {
        return gruppo_;
    }
    public void setGruppo_(CliGruppoRoleRefDTO gruppo_) {
        this.gruppo_ = gruppo_;
    }

    public CliModalita_somministrazioneRoleRefDTO getModalita_somministrazione_pre1() {
        return modalita_somministrazione_pre1;
    }
    public void setModalita_somministrazione_pre1(CliModalita_somministrazioneRoleRefDTO modalita_somministrazione_pre1) {
        this.modalita_somministrazione_pre1 = modalita_somministrazione_pre1;
    }

    public CliModalita_somministrazioneRoleRefDTO getModalita_somministrazione_pre2() {
        return modalita_somministrazione_pre2;
    }
    public void setModalita_somministrazione_pre2(CliModalita_somministrazioneRoleRefDTO modalita_somministrazione_pre2) {
        this.modalita_somministrazione_pre2 = modalita_somministrazione_pre2;
    }

    public CliTipo_visita_mpvRoleRefDTO getTipo_visita_mp_() {
        return tipo_visita_mp_;
    }
    public void setTipo_visita_mp_(CliTipo_visita_mpvRoleRefDTO tipo_visita_mp_) {
        this.tipo_visita_mp_ = tipo_visita_mp_;
    }

    public CliTipo_visita_mpvRoleRefDTO getTipo_visita_mp_booster() {
        return tipo_visita_mp_booster;
    }
    public void setTipo_visita_mp_booster(CliTipo_visita_mpvRoleRefDTO tipo_visita_mp_booster) {
    ...
    public static CliVisita_mpvDraftUpdateBulkDTO.Builder builder() {
        return new CliVisita_mpvDraftUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setCentro_provenienza_(CliCentro_provenienzaRoleRefDTO centro_provenienza_) {
            this.centro_provenienza_ = centro_provenienza_;
            return this;
        }

        public Builder setComorbidita_mpv_(CliComorbidita_mpvRoleRefsDTO comorbidita_mpv_) {
            this.comorbidita_mpv_ = comorbidita_mpv_;
            return this;
        }

        public Builder setDose_mpv_(CliDose_mpvDraftUpdateRoleObjectsDTO dose_mpv_) {
            this.dose_mpv_ = dose_mpv_;
            return this;
        }

        public Builder setEpisodio_MPOX_(CliEpisodio_MPOXDraftUpdateRoleObjectsDTO episodio_MPOX_) {
            this.episodio_MPOX_ = episodio_MPOX_;
            return this;
        }

        public Builder setGruppo_(CliGruppoRoleRefDTO gruppo_) {
            this.gruppo_ = gruppo_;
            return this;
        }

        public Builder setModalita_somministrazione_pre1(CliModalita_somministrazioneRoleRefDTO modalita_somministrazione_pre1) {
            this.modalita_somministrazione_pre1 = modalita_somministrazione_pre1;
            return this;
        }

        public Builder setModalita_somministrazione_pre2(CliModalita_somministrazioneRoleRefDTO modalita_somministrazione_pre2) {
            this.modalita_somministrazione_pre2 = modalita_somministrazione_pre2;
            return this;
        }

        public Builder setTipo_visita_mp_(CliTipo_visita_mpvRoleRefDTO tipo_visita_mp_) {
            this.tipo_visita_mp_ = tipo_visita_mp_;
            return this;
        }

        public Builder setTipo_visita_mp_booster(CliTipo_visita_mpvRoleRefDTO tipo_visita_mp_booster) {
            this.tipo_visita_mp_booster = tipo_visita_mp_booster;
            return this;
        }


        public CliVisita_mpvDraftUpdateBulkDTO build() {
            CliVisita_mpvDraftUpdateBulkDTO result = new CliVisita_mpvDraftUpdateBulkDTO();

...
public class _User___saveMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "_User___save";
    ...
    public _User___saveMutationRequest() {
    }

    public _User___saveMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static _User___saveMutationRequest.Builder builder() {
        return new _User___saveMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public _User___saveMutationRequest build() {
            _User___saveMutationRequest obj = new _User___saveMutationRequest($alias);
            obj.setData(data);

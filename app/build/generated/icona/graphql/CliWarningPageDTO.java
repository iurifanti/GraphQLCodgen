...
/**
 * Represents a collection of objects of class Warning.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliWarningPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliWarningDTO> items;
    ...
    public CliWarningPageDTO() {
    }


    /**
     * An array containing the actual objects of class Warning.
     */
    public java.util.List<CliWarningDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Warning.
     */
    public void setItems(java.util.List<CliWarningDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Warning present in the database.
     */
    ...
    public static CliWarningPageDTO.Builder builder() {
        return new CliWarningPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Warning.
         */
        public Builder setItems(java.util.List<CliWarningDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliWarningPageDTO build() {
            CliWarningPageDTO result = new CliWarningPageDTO();

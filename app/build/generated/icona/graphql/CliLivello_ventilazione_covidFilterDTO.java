...
/**
 * Define a specific filter for objects of type Livello_ventilazione_covid.
...
public class CliLivello_ventilazione_covidFilterDTO implements java.io.Serializable {
    ...
    private java.util.List<CliLivello_ventilazione_covidFilterDTO> AND;
    private java.util.List<CliLivello_ventilazione_covidFilterDTO> OR;
    private CliLivello_ventilazione_covidFilterDTO NOT;

    public CliLivello_ventilazione_covidFilterDTO() {
    }
    ...
    public java.util.List<CliLivello_ventilazione_covidFilterDTO> getAND() {
        return AND;
    }
    public void setAND(java.util.List<CliLivello_ventilazione_covidFilterDTO> AND) {
        this.AND = AND;
    }

    public java.util.List<CliLivello_ventilazione_covidFilterDTO> getOR() {
        return OR;
    }
    public void setOR(java.util.List<CliLivello_ventilazione_covidFilterDTO> OR) {
        this.OR = OR;
    }

    public CliLivello_ventilazione_covidFilterDTO getNOT() {
        return NOT;
    }
    public void setNOT(CliLivello_ventilazione_covidFilterDTO NOT) {
        this.NOT = NOT;
    }
    ...
    public static CliLivello_ventilazione_covidFilterDTO.Builder builder() {
        return new CliLivello_ventilazione_covidFilterDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setAND(java.util.List<CliLivello_ventilazione_covidFilterDTO> AND) {
            this.AND = AND;
            return this;
        }

        public Builder setOR(java.util.List<CliLivello_ventilazione_covidFilterDTO> OR) {
            this.OR = OR;
            return this;
        }

        public Builder setNOT(CliLivello_ventilazione_covidFilterDTO NOT) {
            this.NOT = NOT;
            return this;
        }


        public CliLivello_ventilazione_covidFilterDTO build() {
            CliLivello_ventilazione_covidFilterDTO result = new CliLivello_ventilazione_covidFilterDTO();

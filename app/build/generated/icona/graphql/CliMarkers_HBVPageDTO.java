...
/**
 * Represents a collection of objects of class Markers_HBV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliMarkers_HBVPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliMarkers_HBVDTO> items;
    ...
    public CliMarkers_HBVPageDTO() {
    }


    /**
     * An array containing the actual objects of class Markers_HBV.
     */
    public java.util.List<CliMarkers_HBVDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Markers_HBV.
     */
    public void setItems(java.util.List<CliMarkers_HBVDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Markers_HBV present in the database.
     */
    ...
    public static CliMarkers_HBVPageDTO.Builder builder() {
        return new CliMarkers_HBVPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Markers_HBV.
         */
        public Builder setItems(java.util.List<CliMarkers_HBVDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliMarkers_HBVPageDTO build() {
            CliMarkers_HBVPageDTO result = new CliMarkers_HBVPageDTO();

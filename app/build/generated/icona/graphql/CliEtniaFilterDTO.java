...
/**
 * Define a specific filter for objects of type Etnia.
...
public class CliEtniaFilterDTO implements java.io.Serializable {
    ...
    private Boolean covicona___eq;
    private Boolean covicona___ne;
    private Boolean covicona___null;
    private Boolean covicona___not___null;
    ...
    private java.util.List<CliEtniaFilterDTO> AND;
    private java.util.List<CliEtniaFilterDTO> OR;
    private CliEtniaFilterDTO NOT;

    public CliEtniaFilterDTO() {
    }
    ...
    public Boolean getCovicona___eq() {
        return covicona___eq;
    }
    public void setCovicona___eq(Boolean covicona___eq) {
        this.covicona___eq = covicona___eq;
    }

    public Boolean getCovicona___ne() {
        return covicona___ne;
    }
    public void setCovicona___ne(Boolean covicona___ne) {
        this.covicona___ne = covicona___ne;
    }

    public Boolean getCovicona___null() {
        return covicona___null;
    }
    public void setCovicona___null(Boolean covicona___null) {
        this.covicona___null = covicona___null;
    }

    public Boolean getCovicona___not___null() {
        return covicona___not___null;
    }
    public void setCovicona___not___null(Boolean covicona___not___null) {
        this.covicona___not___null = covicona___not___null;
    }
    ...
    public java.util.List<CliEtniaFilterDTO> getAND() {
        return AND;
    }
    public void setAND(java.util.List<CliEtniaFilterDTO> AND) {
        this.AND = AND;
    }

    public java.util.List<CliEtniaFilterDTO> getOR() {
        return OR;
    }
    public void setOR(java.util.List<CliEtniaFilterDTO> OR) {
        this.OR = OR;
    }

    public CliEtniaFilterDTO getNOT() {
        return NOT;
    }
    public void setNOT(CliEtniaFilterDTO NOT) {
        this.NOT = NOT;
    }
    ...
    public String toString() {
        ...
        if (covicona___eq != null) {
            joiner.add("covicona___eq: " + GraphQLRequestSerializer.getEntry(covicona___eq));
        }
        if (covicona___ne != null) {
            joiner.add("covicona___ne: " + GraphQLRequestSerializer.getEntry(covicona___ne));
        }
        if (covicona___null != null) {
            joiner.add("covicona___null: " + GraphQLRequestSerializer.getEntry(covicona___null));
        }
        if (covicona___not___null != null) {
            joiner.add("covicona___not___null: " + GraphQLRequestSerializer.getEntry(covicona___not___null));
        }
        if (nome___eq != null) {
    ...
    public static CliEtniaFilterDTO.Builder builder() {
        return new CliEtniaFilterDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setCovicona___eq(Boolean covicona___eq) {
            this.covicona___eq = covicona___eq;
            return this;
        }

        public Builder setCovicona___ne(Boolean covicona___ne) {
            this.covicona___ne = covicona___ne;
            return this;
        }

        public Builder setCovicona___null(Boolean covicona___null) {
            this.covicona___null = covicona___null;
            return this;
        }

        public Builder setCovicona___not___null(Boolean covicona___not___null) {
            this.covicona___not___null = covicona___not___null;
            return this;
        }
        ...
        public Builder setAND(java.util.List<CliEtniaFilterDTO> AND) {
            this.AND = AND;
            return this;
        }

        public Builder setOR(java.util.List<CliEtniaFilterDTO> OR) {
            this.OR = OR;
            return this;
        }

        public Builder setNOT(CliEtniaFilterDTO NOT) {
            this.NOT = NOT;
            return this;
        }


        public CliEtniaFilterDTO build() {
            CliEtniaFilterDTO result = new CliEtniaFilterDTO();
            ...
            result.setCovicona___eq(this.covicona___eq);
            result.setCovicona___ne(this.covicona___ne);
            result.setCovicona___null(this.covicona___null);
            result.setCovicona___not___null(this.covicona___not___null);

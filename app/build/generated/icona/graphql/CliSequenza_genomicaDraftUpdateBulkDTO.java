...
/**
 * A data structure for a draft update objects of class Sequenza_genomica.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliSequenza_genomicaDraftUpdateBulkDTO implements java.io.Serializable {
    ...
    private CliCentro_sequenziatoreRoleRefDTO centro_sequenziatore;
    private CliMetodica_genotipoRoleRefDTO metodica_genotipo;
    private CliMutazioneDraftUpdateRoleObjectsDTO mutazione;
    private CliPazienteRoleRefDTO paziente;

    public CliSequenza_genomicaDraftUpdateBulkDTO() {
    }
    ...
    public CliCentro_sequenziatoreRoleRefDTO getCentro_sequenziatore() {
        return centro_sequenziatore;
    }
    public void setCentro_sequenziatore(CliCentro_sequenziatoreRoleRefDTO centro_sequenziatore) {
        this.centro_sequenziatore = centro_sequenziatore;
    }

    public CliMetodica_genotipoRoleRefDTO getMetodica_genotipo() {
        return metodica_genotipo;
    }
    public void setMetodica_genotipo(CliMetodica_genotipoRoleRefDTO metodica_genotipo) {
        this.metodica_genotipo = metodica_genotipo;
    }

    public CliMutazioneDraftUpdateRoleObjectsDTO getMutazione() {
        return mutazione;
    }
    public void setMutazione(CliMutazioneDraftUpdateRoleObjectsDTO mutazione) {
        this.mutazione = mutazione;
    }

    public CliPazienteRoleRefDTO getPaziente() {
        return paziente;
    }
    public void setPaziente(CliPazienteRoleRefDTO paziente) {
    ...
    public static CliSequenza_genomicaDraftUpdateBulkDTO.Builder builder() {
        return new CliSequenza_genomicaDraftUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setCentro_sequenziatore(CliCentro_sequenziatoreRoleRefDTO centro_sequenziatore) {
            this.centro_sequenziatore = centro_sequenziatore;
            return this;
        }

        public Builder setMetodica_genotipo(CliMetodica_genotipoRoleRefDTO metodica_genotipo) {
            this.metodica_genotipo = metodica_genotipo;
            return this;
        }

        public Builder setMutazione(CliMutazioneDraftUpdateRoleObjectsDTO mutazione) {
            this.mutazione = mutazione;
            return this;
        }

        public Builder setPaziente(CliPazienteRoleRefDTO paziente) {
            this.paziente = paziente;
            return this;
        }


        public CliSequenza_genomicaDraftUpdateBulkDTO build() {
            CliSequenza_genomicaDraftUpdateBulkDTO result = new CliSequenza_genomicaDraftUpdateBulkDTO();

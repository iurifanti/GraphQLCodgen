...
/**
 * Represents a collection of objects of class Classificazione_farmaco_ATC.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliClassificazione_farmaco_ATCPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliClassificazione_farmaco_ATCDTO> items;
    ...
    public CliClassificazione_farmaco_ATCPageDTO() {
    }


    /**
     * An array containing the actual objects of class Classificazione_farmaco_ATC.
     */
    public java.util.List<CliClassificazione_farmaco_ATCDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Classificazione_farmaco_ATC.
     */
    public void setItems(java.util.List<CliClassificazione_farmaco_ATCDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Classificazione_farmaco_ATC present in the database.
     */
    ...
    public static CliClassificazione_farmaco_ATCPageDTO.Builder builder() {
        return new CliClassificazione_farmaco_ATCPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Classificazione_farmaco_ATC.
         */
        public Builder setItems(java.util.List<CliClassificazione_farmaco_ATCDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliClassificazione_farmaco_ATCPageDTO build() {
            CliClassificazione_farmaco_ATCPageDTO result = new CliClassificazione_farmaco_ATCPageDTO();

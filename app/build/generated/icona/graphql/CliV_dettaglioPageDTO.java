...
/**
 * Represents a collection of objects of class V_dettaglio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliV_dettaglioPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliV_dettaglioDTO> items;
    ...
    public CliV_dettaglioPageDTO() {
    }


    /**
     * An array containing the actual objects of class V_dettaglio.
     */
    public java.util.List<CliV_dettaglioDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class V_dettaglio.
     */
    public void setItems(java.util.List<CliV_dettaglioDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class V_dettaglio present in the database.
     */
    ...
    public static CliV_dettaglioPageDTO.Builder builder() {
        return new CliV_dettaglioPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class V_dettaglio.
         */
        public Builder setItems(java.util.List<CliV_dettaglioDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliV_dettaglioPageDTO build() {
            CliV_dettaglioPageDTO result = new CliV_dettaglioPageDTO();

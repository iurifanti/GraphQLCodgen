...
/**
 * Represents a collection of objects of class Dose_vaccino_covid.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliDose_vaccino_covidPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliDose_vaccino_covidDTO> items;
    ...
    public CliDose_vaccino_covidPageDTO() {
    }


    /**
     * An array containing the actual objects of class Dose_vaccino_covid.
     */
    public java.util.List<CliDose_vaccino_covidDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Dose_vaccino_covid.
     */
    public void setItems(java.util.List<CliDose_vaccino_covidDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Dose_vaccino_covid present in the database.
     */
    ...
    public static CliDose_vaccino_covidPageDTO.Builder builder() {
        return new CliDose_vaccino_covidPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Dose_vaccino_covid.
         */
        public Builder setItems(java.util.List<CliDose_vaccino_covidDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliDose_vaccino_covidPageDTO build() {
            CliDose_vaccino_covidPageDTO result = new CliDose_vaccino_covidPageDTO();

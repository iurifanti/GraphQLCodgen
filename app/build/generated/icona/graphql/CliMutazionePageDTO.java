...
/**
 * Represents a collection of objects of class Mutazione.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliMutazionePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliMutazioneDTO> items;
    ...
    public CliMutazionePageDTO() {
    }


    /**
     * An array containing the actual objects of class Mutazione.
     */
    public java.util.List<CliMutazioneDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Mutazione.
     */
    public void setItems(java.util.List<CliMutazioneDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Mutazione present in the database.
     */
    ...
    public static CliMutazionePageDTO.Builder builder() {
        return new CliMutazionePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Mutazione.
         */
        public Builder setItems(java.util.List<CliMutazioneDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliMutazionePageDTO build() {
            CliMutazionePageDTO result = new CliMutazionePageDTO();

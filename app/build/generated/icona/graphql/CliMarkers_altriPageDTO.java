...
/**
 * Represents a collection of objects of class Markers_altri.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliMarkers_altriPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliMarkers_altriDTO> items;
    ...
    public CliMarkers_altriPageDTO() {
    }


    /**
     * An array containing the actual objects of class Markers_altri.
     */
    public java.util.List<CliMarkers_altriDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Markers_altri.
     */
    public void setItems(java.util.List<CliMarkers_altriDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Markers_altri present in the database.
     */
    ...
    public static CliMarkers_altriPageDTO.Builder builder() {
        return new CliMarkers_altriPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Markers_altri.
         */
        public Builder setItems(java.util.List<CliMarkers_altriDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliMarkers_altriPageDTO build() {
            CliMarkers_altriPageDTO result = new CliMarkers_altriPageDTO();

...
public class CliExcelImporterUpdateBulkDTO implements java.io.Serializable {
    ...
    public CliExcelImporterUpdateBulkDTO() {
    }
    ...
    public static CliExcelImporterUpdateBulkDTO.Builder builder() {
        return new CliExcelImporterUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public CliExcelImporterUpdateBulkDTO build() {
            CliExcelImporterUpdateBulkDTO result = new CliExcelImporterUpdateBulkDTO();

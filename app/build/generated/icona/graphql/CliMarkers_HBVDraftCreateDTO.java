...
/**
 * A data structure for draft create objects of class Markers_HBV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliMarkers_HBVDraftCreateDTO implements java.io.Serializable {
    ...
    private String metodica_genoma_HBV;
    private String unita_di_misura_viremia;

    public CliMarkers_HBVDraftCreateDTO() {
    }
    ...
    public String getMetodica_genoma_HBV() {
        return metodica_genoma_HBV;
    }
    public void setMetodica_genoma_HBV(String metodica_genoma_HBV) {
    ...
    public static CliMarkers_HBVDraftCreateDTO.Builder builder() {
        return new CliMarkers_HBVDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setMetodica_genoma_HBV(String metodica_genoma_HBV) {
            this.metodica_genoma_HBV = metodica_genoma_HBV;
            return this;
        }
        ...
        public CliMarkers_HBVDraftCreateDTO build() {
            CliMarkers_HBVDraftCreateDTO result = new CliMarkers_HBVDraftCreateDTO();

...
public class CliMarkers_HBVCursorDTO implements java.io.Serializable {
    ...
    public CliMarkers_HBVCursorDTO() {
    }
    ...
    public static CliMarkers_HBVCursorDTO.Builder builder() {
        return new CliMarkers_HBVCursorDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public CliMarkers_HBVCursorDTO build() {
            CliMarkers_HBVCursorDTO result = new CliMarkers_HBVCursorDTO();

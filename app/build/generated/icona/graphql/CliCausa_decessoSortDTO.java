...
public enum CliCausa_decessoSortDTO {
    ...
    patologie_check___ASC("patologie_check___ASC"),
    patologie_check___DESC("patologie_check___DESC");

    private final String graphqlName;

    private CliCausa_decessoSortDTO(String graphqlName) {

...
/**
 * A data structure for a draft update objects of class Evento_epatico.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliEvento_epaticoDraftUpdateBulkDTO implements java.io.Serializable {
    ...
    private CliPatologiaRoleRefsDTO biopsia_epatica;
    private CliPatologiaRoleRefsDTO patologia_epatica;
    private CliPatologiaRoleRefDTO patologia_epatica_dad1;

    public CliEvento_epaticoDraftUpdateBulkDTO() {
    }
    ...
    public CliPatologiaRoleRefsDTO getBiopsia_epatica() {
        return biopsia_epatica;
    }
    public void setBiopsia_epatica(CliPatologiaRoleRefsDTO biopsia_epatica) {
        this.biopsia_epatica = biopsia_epatica;
    }

    public CliPatologiaRoleRefsDTO getPatologia_epatica() {
        return patologia_epatica;
    }
    public void setPatologia_epatica(CliPatologiaRoleRefsDTO patologia_epatica) {
        this.patologia_epatica = patologia_epatica;
    }

    public CliPatologiaRoleRefDTO getPatologia_epatica_dad1() {
        return patologia_epatica_dad1;
    }
    public void setPatologia_epatica_dad1(CliPatologiaRoleRefDTO patologia_epatica_dad1) {
    ...
    public static CliEvento_epaticoDraftUpdateBulkDTO.Builder builder() {
        return new CliEvento_epaticoDraftUpdateBulkDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setBiopsia_epatica(CliPatologiaRoleRefsDTO biopsia_epatica) {
            this.biopsia_epatica = biopsia_epatica;
            return this;
        }

        public Builder setPatologia_epatica(CliPatologiaRoleRefsDTO patologia_epatica) {
            this.patologia_epatica = patologia_epatica;
            return this;
        }

        public Builder setPatologia_epatica_dad1(CliPatologiaRoleRefDTO patologia_epatica_dad1) {
            this.patologia_epatica_dad1 = patologia_epatica_dad1;
            return this;
        }


        public CliEvento_epaticoDraftUpdateBulkDTO build() {
            CliEvento_epaticoDraftUpdateBulkDTO result = new CliEvento_epaticoDraftUpdateBulkDTO();

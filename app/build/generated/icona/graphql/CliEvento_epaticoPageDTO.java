...
/**
 * Represents a collection of objects of class Evento_epatico.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliEvento_epaticoPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliEvento_epaticoDTO> items;
    ...
    public CliEvento_epaticoPageDTO() {
    }


    /**
     * An array containing the actual objects of class Evento_epatico.
     */
    public java.util.List<CliEvento_epaticoDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Evento_epatico.
     */
    public void setItems(java.util.List<CliEvento_epaticoDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Evento_epatico present in the database.
     */
    ...
    public static CliEvento_epaticoPageDTO.Builder builder() {
        return new CliEvento_epaticoPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Evento_epatico.
         */
        public Builder setItems(java.util.List<CliEvento_epaticoDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliEvento_epaticoPageDTO build() {
            CliEvento_epaticoPageDTO result = new CliEvento_epaticoPageDTO();

...
/**
 * A data structure for draft create objects of class V_dettaglio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliV_dettaglioDraftCreateDTO implements java.io.Serializable {
    ...
    private java.util.List<CliDose_vaccino_covidDraftCreateDTO> dose_vaccino_covid_;
    private java.util.List<String> eventi_prima_dose;
    private java.util.List<String> eventi_seconda_dose;
    private String motivazioni_seconda_dose_1;
    private java.util.List<CliSierologie_covidDraftCreateDTO> sierologie_covid_;
    private java.util.List<String> sintomo_covid_post;
    private java.util.List<String> sintomo_covid_pre;
    private String vaccino_covid_prima;
    private String vaccino_covid_seconda;

    public CliV_dettaglioDraftCreateDTO() {
    }
    ...
    public java.util.List<CliDose_vaccino_covidDraftCreateDTO> getDose_vaccino_covid_() {
        return dose_vaccino_covid_;
    }
    public void setDose_vaccino_covid_(java.util.List<CliDose_vaccino_covidDraftCreateDTO> dose_vaccino_covid_) {
        this.dose_vaccino_covid_ = dose_vaccino_covid_;
    }

    public java.util.List<String> getEventi_prima_dose() {
        return eventi_prima_dose;
    }
    public void setEventi_prima_dose(java.util.List<String> eventi_prima_dose) {
        this.eventi_prima_dose = eventi_prima_dose;
    }

    public java.util.List<String> getEventi_seconda_dose() {
        return eventi_seconda_dose;
    }
    public void setEventi_seconda_dose(java.util.List<String> eventi_seconda_dose) {
        this.eventi_seconda_dose = eventi_seconda_dose;
    }

    public String getMotivazioni_seconda_dose_1() {
        return motivazioni_seconda_dose_1;
    }
    public void setMotivazioni_seconda_dose_1(String motivazioni_seconda_dose_1) {
        this.motivazioni_seconda_dose_1 = motivazioni_seconda_dose_1;
    }

    public java.util.List<CliSierologie_covidDraftCreateDTO> getSierologie_covid_() {
        return sierologie_covid_;
    }
    public void setSierologie_covid_(java.util.List<CliSierologie_covidDraftCreateDTO> sierologie_covid_) {
        this.sierologie_covid_ = sierologie_covid_;
    }

    public java.util.List<String> getSintomo_covid_post() {
        return sintomo_covid_post;
    }
    public void setSintomo_covid_post(java.util.List<String> sintomo_covid_post) {
        this.sintomo_covid_post = sintomo_covid_post;
    }

    public java.util.List<String> getSintomo_covid_pre() {
        return sintomo_covid_pre;
    }
    public void setSintomo_covid_pre(java.util.List<String> sintomo_covid_pre) {
        this.sintomo_covid_pre = sintomo_covid_pre;
    }

    public String getVaccino_covid_prima() {
        return vaccino_covid_prima;
    }
    public void setVaccino_covid_prima(String vaccino_covid_prima) {
        this.vaccino_covid_prima = vaccino_covid_prima;
    }

    public String getVaccino_covid_seconda() {
        return vaccino_covid_seconda;
    }
    public void setVaccino_covid_seconda(String vaccino_covid_seconda) {
    ...
    public static CliV_dettaglioDraftCreateDTO.Builder builder() {
        return new CliV_dettaglioDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setDose_vaccino_covid_(java.util.List<CliDose_vaccino_covidDraftCreateDTO> dose_vaccino_covid_) {
            this.dose_vaccino_covid_ = dose_vaccino_covid_;
            return this;
        }

        public Builder setEventi_prima_dose(java.util.List<String> eventi_prima_dose) {
            this.eventi_prima_dose = eventi_prima_dose;
            return this;
        }

        public Builder setEventi_seconda_dose(java.util.List<String> eventi_seconda_dose) {
            this.eventi_seconda_dose = eventi_seconda_dose;
            return this;
        }

        public Builder setMotivazioni_seconda_dose_1(String motivazioni_seconda_dose_1) {
            this.motivazioni_seconda_dose_1 = motivazioni_seconda_dose_1;
            return this;
        }

        public Builder setSierologie_covid_(java.util.List<CliSierologie_covidDraftCreateDTO> sierologie_covid_) {
            this.sierologie_covid_ = sierologie_covid_;
            return this;
        }

        public Builder setSintomo_covid_post(java.util.List<String> sintomo_covid_post) {
            this.sintomo_covid_post = sintomo_covid_post;
            return this;
        }

        public Builder setSintomo_covid_pre(java.util.List<String> sintomo_covid_pre) {
            this.sintomo_covid_pre = sintomo_covid_pre;
            return this;
        }

        public Builder setVaccino_covid_prima(String vaccino_covid_prima) {
            this.vaccino_covid_prima = vaccino_covid_prima;
            return this;
        }

        public Builder setVaccino_covid_seconda(String vaccino_covid_seconda) {
            this.vaccino_covid_seconda = vaccino_covid_seconda;
            return this;
        }


        public CliV_dettaglioDraftCreateDTO build() {
            CliV_dettaglioDraftCreateDTO result = new CliV_dettaglioDraftCreateDTO();

...
/**
 * Represents a collection of objects of class Markers_HDV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliMarkers_HDVPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliMarkers_HDVDTO> items;
    ...
    public CliMarkers_HDVPageDTO() {
    }


    /**
     * An array containing the actual objects of class Markers_HDV.
     */
    public java.util.List<CliMarkers_HDVDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Markers_HDV.
     */
    public void setItems(java.util.List<CliMarkers_HDVDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Markers_HDV present in the database.
     */
    ...
    public static CliMarkers_HDVPageDTO.Builder builder() {
        return new CliMarkers_HDVPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Markers_HDV.
         */
        public Builder setItems(java.util.List<CliMarkers_HDVDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliMarkers_HDVPageDTO build() {
            CliMarkers_HDVPageDTO result = new CliMarkers_HDVPageDTO();

...
public class P_Paziente___formAction___generaCodicePrideMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "P_Paziente___formAction___generaCodicePride";
    ...
    public P_Paziente___formAction___generaCodicePrideMutationRequest() {
    }

    public P_Paziente___formAction___generaCodicePrideMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static P_Paziente___formAction___generaCodicePrideMutationRequest.Builder builder() {
        return new P_Paziente___formAction___generaCodicePrideMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public P_Paziente___formAction___generaCodicePrideMutationRequest build() {
            P_Paziente___formAction___generaCodicePrideMutationRequest obj = new P_Paziente___formAction___generaCodicePrideMutationRequest($alias);
            obj.setData(data);

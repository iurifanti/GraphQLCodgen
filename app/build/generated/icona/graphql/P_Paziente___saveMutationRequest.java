...
public class P_Paziente___saveMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "P_Paziente___save";
    ...
    public P_Paziente___saveMutationRequest() {
    }

    public P_Paziente___saveMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static P_Paziente___saveMutationRequest.Builder builder() {
        return new P_Paziente___saveMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public P_Paziente___saveMutationRequest build() {
            P_Paziente___saveMutationRequest obj = new P_Paziente___saveMutationRequest($alias);
            obj.setData(data);

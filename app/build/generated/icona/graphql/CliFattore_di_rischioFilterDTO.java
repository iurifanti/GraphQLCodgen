...
/**
 * Define a specific filter for objects of type Fattore_di_rischio.
...
public class CliFattore_di_rischioFilterDTO implements java.io.Serializable {
    ...
    private java.util.List<CliFattore_di_rischioFilterDTO> AND;
    private java.util.List<CliFattore_di_rischioFilterDTO> OR;
    private CliFattore_di_rischioFilterDTO NOT;

    public CliFattore_di_rischioFilterDTO() {
    }
    ...
    public java.util.List<CliFattore_di_rischioFilterDTO> getAND() {
        return AND;
    }
    public void setAND(java.util.List<CliFattore_di_rischioFilterDTO> AND) {
        this.AND = AND;
    }

    public java.util.List<CliFattore_di_rischioFilterDTO> getOR() {
        return OR;
    }
    public void setOR(java.util.List<CliFattore_di_rischioFilterDTO> OR) {
        this.OR = OR;
    }

    public CliFattore_di_rischioFilterDTO getNOT() {
        return NOT;
    }
    public void setNOT(CliFattore_di_rischioFilterDTO NOT) {
        this.NOT = NOT;
    }
    ...
    public static CliFattore_di_rischioFilterDTO.Builder builder() {
        return new CliFattore_di_rischioFilterDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setAND(java.util.List<CliFattore_di_rischioFilterDTO> AND) {
            this.AND = AND;
            return this;
        }

        public Builder setOR(java.util.List<CliFattore_di_rischioFilterDTO> OR) {
            this.OR = OR;
            return this;
        }

        public Builder setNOT(CliFattore_di_rischioFilterDTO NOT) {
            this.NOT = NOT;
            return this;
        }


        public CliFattore_di_rischioFilterDTO build() {
            CliFattore_di_rischioFilterDTO result = new CliFattore_di_rischioFilterDTO();

...
public enum CliComponenteSortDTO {
    ...
    classe___ASC("classe___ASC"),
    classe___DESC("classe___DESC"),
    codice___ASC("codice___ASC"),
    codice___DESC("codice___DESC"),
    codice_classe___ASC("codice_classe___ASC"),
    codice_classe___DESC("codice_classe___DESC"),
    ...
    private CliComponenteSortDTO(String graphqlName) {

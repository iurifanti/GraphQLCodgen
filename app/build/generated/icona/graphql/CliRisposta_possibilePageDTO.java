...
/**
 * Represents a collection of objects of class Risposta_possibile.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliRisposta_possibilePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliRisposta_possibileDTO> items;
    ...
    public CliRisposta_possibilePageDTO() {
    }


    /**
     * An array containing the actual objects of class Risposta_possibile.
     */
    public java.util.List<CliRisposta_possibileDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Risposta_possibile.
     */
    public void setItems(java.util.List<CliRisposta_possibileDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Risposta_possibile present in the database.
     */
    ...
    public static CliRisposta_possibilePageDTO.Builder builder() {
        return new CliRisposta_possibilePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Risposta_possibile.
         */
        public Builder setItems(java.util.List<CliRisposta_possibileDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliRisposta_possibilePageDTO build() {
            CliRisposta_possibilePageDTO result = new CliRisposta_possibilePageDTO();

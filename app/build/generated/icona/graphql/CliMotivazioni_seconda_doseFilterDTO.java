...
/**
 * Define a specific filter for objects of type Motivazioni_seconda_dose.
...
public class CliMotivazioni_seconda_doseFilterDTO implements java.io.Serializable {
    ...
    private java.util.List<CliMotivazioni_seconda_doseFilterDTO> AND;
    private java.util.List<CliMotivazioni_seconda_doseFilterDTO> OR;
    private CliMotivazioni_seconda_doseFilterDTO NOT;

    public CliMotivazioni_seconda_doseFilterDTO() {
    }
    ...
    public java.util.List<CliMotivazioni_seconda_doseFilterDTO> getAND() {
        return AND;
    }
    public void setAND(java.util.List<CliMotivazioni_seconda_doseFilterDTO> AND) {
        this.AND = AND;
    }

    public java.util.List<CliMotivazioni_seconda_doseFilterDTO> getOR() {
        return OR;
    }
    public void setOR(java.util.List<CliMotivazioni_seconda_doseFilterDTO> OR) {
        this.OR = OR;
    }

    public CliMotivazioni_seconda_doseFilterDTO getNOT() {
        return NOT;
    }
    public void setNOT(CliMotivazioni_seconda_doseFilterDTO NOT) {
        this.NOT = NOT;
    }
    ...
    public static CliMotivazioni_seconda_doseFilterDTO.Builder builder() {
        return new CliMotivazioni_seconda_doseFilterDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setAND(java.util.List<CliMotivazioni_seconda_doseFilterDTO> AND) {
            this.AND = AND;
            return this;
        }

        public Builder setOR(java.util.List<CliMotivazioni_seconda_doseFilterDTO> OR) {
            this.OR = OR;
            return this;
        }

        public Builder setNOT(CliMotivazioni_seconda_doseFilterDTO NOT) {
            this.NOT = NOT;
            return this;
        }


        public CliMotivazioni_seconda_doseFilterDTO build() {
            CliMotivazioni_seconda_doseFilterDTO result = new CliMotivazioni_seconda_doseFilterDTO();

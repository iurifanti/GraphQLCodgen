...
/**
 * Represents a collection of objects of class Episodio_MPOX.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliEpisodio_MPOXPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliEpisodio_MPOXDTO> items;
    ...
    public CliEpisodio_MPOXPageDTO() {
    }


    /**
     * An array containing the actual objects of class Episodio_MPOX.
     */
    public java.util.List<CliEpisodio_MPOXDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Episodio_MPOX.
     */
    public void setItems(java.util.List<CliEpisodio_MPOXDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Episodio_MPOX present in the database.
     */
    ...
    public static CliEpisodio_MPOXPageDTO.Builder builder() {
        return new CliEpisodio_MPOXPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Episodio_MPOX.
         */
        public Builder setItems(java.util.List<CliEpisodio_MPOXDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliEpisodio_MPOXPageDTO build() {
            CliEpisodio_MPOXPageDTO result = new CliEpisodio_MPOXPageDTO();

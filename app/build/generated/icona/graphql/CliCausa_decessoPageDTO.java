...
/**
 * Represents a collection of objects of class Causa_decesso.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliCausa_decessoPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliCausa_decessoDTO> items;
    ...
    public CliCausa_decessoPageDTO() {
    }


    /**
     * An array containing the actual objects of class Causa_decesso.
     */
    public java.util.List<CliCausa_decessoDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Causa_decesso.
     */
    public void setItems(java.util.List<CliCausa_decessoDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Causa_decesso present in the database.
     */
    ...
    public static CliCausa_decessoPageDTO.Builder builder() {
        return new CliCausa_decessoPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Causa_decesso.
         */
        public Builder setItems(java.util.List<CliCausa_decessoDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliCausa_decessoPageDTO build() {
            CliCausa_decessoPageDTO result = new CliCausa_decessoPageDTO();

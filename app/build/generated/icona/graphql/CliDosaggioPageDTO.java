...
/**
 * Represents a collection of objects of class dosaggio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliDosaggioPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliDosaggioDTO> items;
    ...
    public CliDosaggioPageDTO() {
    }


    /**
     * An array containing the actual objects of class dosaggio.
     */
    public java.util.List<CliDosaggioDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class dosaggio.
     */
    public void setItems(java.util.List<CliDosaggioDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class dosaggio present in the database.
     */
    ...
    public static CliDosaggioPageDTO.Builder builder() {
        return new CliDosaggioPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class dosaggio.
         */
        public Builder setItems(java.util.List<CliDosaggioDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliDosaggioPageDTO build() {
            CliDosaggioPageDTO result = new CliDosaggioPageDTO();

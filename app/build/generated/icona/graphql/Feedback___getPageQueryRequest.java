...
public class Feedback___getPageQueryRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Feedback___getPage";
    ...
    public Feedback___getPageQueryRequest() {
    }

    public Feedback___getPageQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Feedback___getPageQueryRequest.Builder builder() {
        return new Feedback___getPageQueryRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Feedback___getPageQueryRequest build() {
            Feedback___getPageQueryRequest obj = new Feedback___getPageQueryRequest($alias);

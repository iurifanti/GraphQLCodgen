...
/**
 * A data structure for objects of Sequenza_genomica.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliSequenza_genomicaCreateDTO implements java.io.Serializable {
    ...
    private java.util.List<CliMutazioneCreateDTO> mutazione;
    private String paziente;

    public CliSequenza_genomicaCreateDTO() {
    }
    ...
    public java.util.List<CliMutazioneCreateDTO> getMutazione() {
        return mutazione;
    }
    public void setMutazione(java.util.List<CliMutazioneCreateDTO> mutazione) {
    ...
    public static CliSequenza_genomicaCreateDTO.Builder builder() {
        return new CliSequenza_genomicaCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setMutazione(java.util.List<CliMutazioneCreateDTO> mutazione) {
            this.mutazione = mutazione;
            return this;
        }
        ...
        public CliSequenza_genomicaCreateDTO build() {
            CliSequenza_genomicaCreateDTO result = new CliSequenza_genomicaCreateDTO();

...
public class Gruppo___createMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Gruppo___create";
    ...
    public Gruppo___createMutationRequest() {
    }

    public Gruppo___createMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliGruppoCreateDTO data) {
    ...
    public static Gruppo___createMutationRequest.Builder builder() {
        return new Gruppo___createMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliGruppoCreateDTO data;
        ...
        public Builder setData(CliGruppoCreateDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Gruppo___createMutationRequest build() {
            Gruppo___createMutationRequest obj = new Gruppo___createMutationRequest($alias);
            obj.setData(data);

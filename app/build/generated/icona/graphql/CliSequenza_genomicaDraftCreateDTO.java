...
/**
 * A data structure for draft create objects of class Sequenza_genomica.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliSequenza_genomicaDraftCreateDTO implements java.io.Serializable {
    ...
    private java.util.List<CliMutazioneDraftCreateDTO> mutazione;
    private String paziente;

    public CliSequenza_genomicaDraftCreateDTO() {
    }
    ...
    public java.util.List<CliMutazioneDraftCreateDTO> getMutazione() {
        return mutazione;
    }
    public void setMutazione(java.util.List<CliMutazioneDraftCreateDTO> mutazione) {
    ...
    public static CliSequenza_genomicaDraftCreateDTO.Builder builder() {
        return new CliSequenza_genomicaDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setMutazione(java.util.List<CliMutazioneDraftCreateDTO> mutazione) {
            this.mutazione = mutazione;
            return this;
        }
        ...
        public CliSequenza_genomicaDraftCreateDTO build() {
            CliSequenza_genomicaDraftCreateDTO result = new CliSequenza_genomicaDraftCreateDTO();

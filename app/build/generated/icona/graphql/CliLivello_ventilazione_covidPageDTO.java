...
/**
 * Represents a collection of objects of class Livello_ventilazione_covid.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliLivello_ventilazione_covidPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliLivello_ventilazione_covidDTO> items;
    ...
    public CliLivello_ventilazione_covidPageDTO() {
    }


    /**
     * An array containing the actual objects of class Livello_ventilazione_covid.
     */
    public java.util.List<CliLivello_ventilazione_covidDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Livello_ventilazione_covid.
     */
    public void setItems(java.util.List<CliLivello_ventilazione_covidDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Livello_ventilazione_covid present in the database.
     */
    ...
    public static CliLivello_ventilazione_covidPageDTO.Builder builder() {
        return new CliLivello_ventilazione_covidPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Livello_ventilazione_covid.
         */
        public Builder setItems(java.util.List<CliLivello_ventilazione_covidDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliLivello_ventilazione_covidPageDTO build() {
            CliLivello_ventilazione_covidPageDTO result = new CliLivello_ventilazione_covidPageDTO();

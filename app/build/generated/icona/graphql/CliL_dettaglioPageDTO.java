...
/**
 * Represents a collection of objects of class L_dettaglio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:42+0100"
)
public class CliL_dettaglioPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliL_dettaglioDTO> items;
    ...
    public CliL_dettaglioPageDTO() {
    }


    /**
     * An array containing the actual objects of class L_dettaglio.
     */
    public java.util.List<CliL_dettaglioDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class L_dettaglio.
     */
    public void setItems(java.util.List<CliL_dettaglioDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class L_dettaglio present in the database.
     */
    ...
    public static CliL_dettaglioPageDTO.Builder builder() {
        return new CliL_dettaglioPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class L_dettaglio.
         */
        public Builder setItems(java.util.List<CliL_dettaglioDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliL_dettaglioPageDTO build() {
            CliL_dettaglioPageDTO result = new CliL_dettaglioPageDTO();

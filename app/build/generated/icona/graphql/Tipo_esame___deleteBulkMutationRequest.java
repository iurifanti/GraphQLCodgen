...
public class Tipo_esame___deleteBulkMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Tipo_esame___deleteBulk";
    ...
    public Tipo_esame___deleteBulkMutationRequest() {
    }

    public Tipo_esame___deleteBulkMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Tipo_esame___deleteBulkMutationRequest.Builder builder() {
        return new Tipo_esame___deleteBulkMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Tipo_esame___deleteBulkMutationRequest build() {
            Tipo_esame___deleteBulkMutationRequest obj = new Tipo_esame___deleteBulkMutationRequest($alias);

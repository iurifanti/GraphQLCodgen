...
/**
 * Represents a collection of objects of class Classe.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliClassePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliClasseDTO> items;
    ...
    public CliClassePageDTO() {
    }


    /**
     * An array containing the actual objects of class Classe.
     */
    public java.util.List<CliClasseDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Classe.
     */
    public void setItems(java.util.List<CliClasseDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Classe present in the database.
     */
    ...
    public static CliClassePageDTO.Builder builder() {
        return new CliClassePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Classe.
         */
        public Builder setItems(java.util.List<CliClasseDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliClassePageDTO build() {
            CliClassePageDTO result = new CliClassePageDTO();

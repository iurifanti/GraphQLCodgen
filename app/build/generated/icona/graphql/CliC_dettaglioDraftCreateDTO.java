...
/**
 * A data structure for draft create objects of class C_dettaglio.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:44+0100"
)
public class CliC_dettaglioDraftCreateDTO implements java.io.Serializable {
    ...
    private java.util.List<CliEventoDraftCreateDTO> evento_covid;
    private String livello_ventilazione_covid_;
    private String outcome_covid_;
    private java.util.List<CliTerapia_covidDraftCreateDTO> terapia_covid_;

    public CliC_dettaglioDraftCreateDTO() {
    }
    ...
    public java.util.List<CliEventoDraftCreateDTO> getEvento_covid() {
        return evento_covid;
    }
    public void setEvento_covid(java.util.List<CliEventoDraftCreateDTO> evento_covid) {
        this.evento_covid = evento_covid;
    }

    public String getLivello_ventilazione_covid_() {
        return livello_ventilazione_covid_;
    }
    public void setLivello_ventilazione_covid_(String livello_ventilazione_covid_) {
        this.livello_ventilazione_covid_ = livello_ventilazione_covid_;
    }

    public String getOutcome_covid_() {
        return outcome_covid_;
    }
    public void setOutcome_covid_(String outcome_covid_) {
        this.outcome_covid_ = outcome_covid_;
    }

    public java.util.List<CliTerapia_covidDraftCreateDTO> getTerapia_covid_() {
        return terapia_covid_;
    }
    public void setTerapia_covid_(java.util.List<CliTerapia_covidDraftCreateDTO> terapia_covid_) {
    ...
    public static CliC_dettaglioDraftCreateDTO.Builder builder() {
        return new CliC_dettaglioDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setEvento_covid(java.util.List<CliEventoDraftCreateDTO> evento_covid) {
            this.evento_covid = evento_covid;
            return this;
        }

        public Builder setLivello_ventilazione_covid_(String livello_ventilazione_covid_) {
            this.livello_ventilazione_covid_ = livello_ventilazione_covid_;
            return this;
        }

        public Builder setOutcome_covid_(String outcome_covid_) {
            this.outcome_covid_ = outcome_covid_;
            return this;
        }

        public Builder setTerapia_covid_(java.util.List<CliTerapia_covidDraftCreateDTO> terapia_covid_) {
            this.terapia_covid_ = terapia_covid_;
            return this;
        }


        public CliC_dettaglioDraftCreateDTO build() {
            CliC_dettaglioDraftCreateDTO result = new CliC_dettaglioDraftCreateDTO();

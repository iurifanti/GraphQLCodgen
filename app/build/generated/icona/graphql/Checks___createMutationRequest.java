...
public class Checks___createMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Checks___create";
    ...
    public Checks___createMutationRequest() {
    }

    public Checks___createMutationRequest(String alias) {
        this.alias = alias;
    }

    public void setData(CliChecksCreateDTO data) {
    ...
    public static Checks___createMutationRequest.Builder builder() {
        return new Checks___createMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private String $alias;
        private CliChecksCreateDTO data;
        ...
        public Builder setData(CliChecksCreateDTO data) {
            this.data = data;
            return this;
        }
        ...
        public Checks___createMutationRequest build() {
            Checks___createMutationRequest obj = new Checks___createMutationRequest($alias);
            obj.setData(data);

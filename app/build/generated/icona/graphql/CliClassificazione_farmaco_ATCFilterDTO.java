...
/**
 * Define a specific filter for objects of type Classificazione_farmaco_ATC.
...
public class CliClassificazione_farmaco_ATCFilterDTO implements java.io.Serializable {
    ...
    private java.util.List<CliClassificazione_farmaco_ATCFilterDTO> AND;
    private java.util.List<CliClassificazione_farmaco_ATCFilterDTO> OR;
    private CliClassificazione_farmaco_ATCFilterDTO NOT;

    public CliClassificazione_farmaco_ATCFilterDTO() {
    }
    ...
    public java.util.List<CliClassificazione_farmaco_ATCFilterDTO> getAND() {
        return AND;
    }
    public void setAND(java.util.List<CliClassificazione_farmaco_ATCFilterDTO> AND) {
        this.AND = AND;
    }

    public java.util.List<CliClassificazione_farmaco_ATCFilterDTO> getOR() {
        return OR;
    }
    public void setOR(java.util.List<CliClassificazione_farmaco_ATCFilterDTO> OR) {
        this.OR = OR;
    }

    public CliClassificazione_farmaco_ATCFilterDTO getNOT() {
        return NOT;
    }
    public void setNOT(CliClassificazione_farmaco_ATCFilterDTO NOT) {
        this.NOT = NOT;
    }
    ...
    public static CliClassificazione_farmaco_ATCFilterDTO.Builder builder() {
        return new CliClassificazione_farmaco_ATCFilterDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setAND(java.util.List<CliClassificazione_farmaco_ATCFilterDTO> AND) {
            this.AND = AND;
            return this;
        }

        public Builder setOR(java.util.List<CliClassificazione_farmaco_ATCFilterDTO> OR) {
            this.OR = OR;
            return this;
        }

        public Builder setNOT(CliClassificazione_farmaco_ATCFilterDTO NOT) {
            this.NOT = NOT;
            return this;
        }


        public CliClassificazione_farmaco_ATCFilterDTO build() {
            CliClassificazione_farmaco_ATCFilterDTO result = new CliClassificazione_farmaco_ATCFilterDTO();

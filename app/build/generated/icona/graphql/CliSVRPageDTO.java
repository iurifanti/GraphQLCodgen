...
/**
 * Represents a collection of objects of class SVR.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliSVRPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliSVRDTO> items;
    ...
    public CliSVRPageDTO() {
    }


    /**
     * An array containing the actual objects of class SVR.
     */
    public java.util.List<CliSVRDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class SVR.
     */
    public void setItems(java.util.List<CliSVRDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class SVR present in the database.
     */
    ...
    public static CliSVRPageDTO.Builder builder() {
        return new CliSVRPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class SVR.
         */
        public Builder setItems(java.util.List<CliSVRDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliSVRPageDTO build() {
            CliSVRPageDTO result = new CliSVRPageDTO();

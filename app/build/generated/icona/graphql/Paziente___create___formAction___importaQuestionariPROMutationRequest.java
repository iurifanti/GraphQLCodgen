...
public class Paziente___create___formAction___importaQuestionariPROMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Paziente___create___formAction___importaQuestionariPRO";
    ...
    public Paziente___create___formAction___importaQuestionariPROMutationRequest() {
    }

    public Paziente___create___formAction___importaQuestionariPROMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Paziente___create___formAction___importaQuestionariPROMutationRequest.Builder builder() {
        return new Paziente___create___formAction___importaQuestionariPROMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Paziente___create___formAction___importaQuestionariPROMutationRequest build() {
            Paziente___create___formAction___importaQuestionariPROMutationRequest obj = new Paziente___create___formAction___importaQuestionariPROMutationRequest($alias);
            obj.setData(data);

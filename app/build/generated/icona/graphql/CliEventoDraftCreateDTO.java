...
/**
 * A data structure for draft create objects of class Evento.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliEventoDraftCreateDTO implements java.io.Serializable {
    ...
    private String classificazione_ICD10_;
    private String patologia;

    public CliEventoDraftCreateDTO() {
    }
    ...
    public String getClassificazione_ICD10_() {
        return classificazione_ICD10_;
    }
    public void setClassificazione_ICD10_(String classificazione_ICD10_) {
    ...
    public static CliEventoDraftCreateDTO.Builder builder() {
        return new CliEventoDraftCreateDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setClassificazione_ICD10_(String classificazione_ICD10_) {
            this.classificazione_ICD10_ = classificazione_ICD10_;
            return this;
        }

        public Builder setPatologia(String patologia) {
            this.patologia = patologia;
            return this;
        }


        public CliEventoDraftCreateDTO build() {
            CliEventoDraftCreateDTO result = new CliEventoDraftCreateDTO();

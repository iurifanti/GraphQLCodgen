...
/**
 * Represents a collection of objects of class Luogo_test_HIV.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliLuogo_test_HIVPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliLuogo_test_HIVDTO> items;
    ...
    public CliLuogo_test_HIVPageDTO() {
    }


    /**
     * An array containing the actual objects of class Luogo_test_HIV.
     */
    public java.util.List<CliLuogo_test_HIVDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Luogo_test_HIV.
     */
    public void setItems(java.util.List<CliLuogo_test_HIVDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Luogo_test_HIV present in the database.
     */
    ...
    public static CliLuogo_test_HIVPageDTO.Builder builder() {
        return new CliLuogo_test_HIVPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Luogo_test_HIV.
         */
        public Builder setItems(java.util.List<CliLuogo_test_HIVDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliLuogo_test_HIVPageDTO build() {
            CliLuogo_test_HIVPageDTO result = new CliLuogo_test_HIVPageDTO();

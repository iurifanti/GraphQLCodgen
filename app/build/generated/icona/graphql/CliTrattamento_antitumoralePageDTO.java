...
/**
 * Represents a collection of objects of class Trattamento_antitumorale.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliTrattamento_antitumoralePageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliTrattamento_antitumoraleDTO> items;
    ...
    public CliTrattamento_antitumoralePageDTO() {
    }


    /**
     * An array containing the actual objects of class Trattamento_antitumorale.
     */
    public java.util.List<CliTrattamento_antitumoraleDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Trattamento_antitumorale.
     */
    public void setItems(java.util.List<CliTrattamento_antitumoraleDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Trattamento_antitumorale present in the database.
     */
    ...
    public static CliTrattamento_antitumoralePageDTO.Builder builder() {
        return new CliTrattamento_antitumoralePageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Trattamento_antitumorale.
         */
        public Builder setItems(java.util.List<CliTrattamento_antitumoraleDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliTrattamento_antitumoralePageDTO build() {
            CliTrattamento_antitumoralePageDTO result = new CliTrattamento_antitumoralePageDTO();

...
public class Gruppo___saveMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Gruppo___save";
    ...
    public Gruppo___saveMutationRequest() {
    }

    public Gruppo___saveMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Gruppo___saveMutationRequest.Builder builder() {
        return new Gruppo___saveMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Gruppo___saveMutationRequest build() {
            Gruppo___saveMutationRequest obj = new Gruppo___saveMutationRequest($alias);
            obj.setData(data);

...
public class Tipo_visita_mpv___saveMutationRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "Tipo_visita_mpv___save";
    ...
    public Tipo_visita_mpv___saveMutationRequest() {
    }

    public Tipo_visita_mpv___saveMutationRequest(String alias) {
        this.alias = alias;
    }
    ...
    public static Tipo_visita_mpv___saveMutationRequest.Builder builder() {
        return new Tipo_visita_mpv___saveMutationRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Tipo_visita_mpv___saveMutationRequest build() {
            Tipo_visita_mpv___saveMutationRequest obj = new Tipo_visita_mpv___saveMutationRequest($alias);
            obj.setData(data);

...
/**
 * A data structure for a draft object of class P_Paziente.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliP_PazienteDraftDTO implements java.io.Serializable {
    ...
    private CliQuestionario_PRO_appDraftRoleObjectsDTO questionario_PRO_app_;
    private CliStudio_questionarioDraftRoleRefsDTO studio_questionario_;

    public CliP_PazienteDraftDTO() {
    }
    ...
    public CliQuestionario_PRO_appDraftRoleObjectsDTO getQuestionario_PRO_app_() {
        return questionario_PRO_app_;
    }
    public void setQuestionario_PRO_app_(CliQuestionario_PRO_appDraftRoleObjectsDTO questionario_PRO_app_) {
    ...
    public static CliP_PazienteDraftDTO.Builder builder() {
        return new CliP_PazienteDraftDTO.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setQuestionario_PRO_app_(CliQuestionario_PRO_appDraftRoleObjectsDTO questionario_PRO_app_) {
            this.questionario_PRO_app_ = questionario_PRO_app_;
            return this;
        }
        ...
        public CliP_PazienteDraftDTO build() {
            CliP_PazienteDraftDTO result = new CliP_PazienteDraftDTO();

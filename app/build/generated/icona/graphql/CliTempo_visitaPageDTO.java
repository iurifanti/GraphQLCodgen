...
/**
 * Represents a collection of objects of class Tempo_visita.
 */
@javax.annotation.processing.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2025-12-28T01:33:43+0100"
)
public class CliTempo_visitaPageDTO implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    @javax.validation.constraints.NotNull
    private java.util.List<CliTempo_visitaDTO> items;
    ...
    public CliTempo_visitaPageDTO() {
    }


    /**
     * An array containing the actual objects of class Tempo_visita.
     */
    public java.util.List<CliTempo_visitaDTO> getItems() {
        return items;
    }
    /**
     * An array containing the actual objects of class Tempo_visita.
     */
    public void setItems(java.util.List<CliTempo_visitaDTO> items) {
        this.items = items;
    }

    /**
     * The total number of objects of class Tempo_visita present in the database.
     */
    ...
    public static CliTempo_visitaPageDTO.Builder builder() {
        return new CliTempo_visitaPageDTO.Builder();
    }
    ...
    public static class Builder {
         ...
         * An array containing the actual objects of class Tempo_visita.
         */
        public Builder setItems(java.util.List<CliTempo_visitaDTO> items) {
            this.items = items;
            return this;
        }
        ...
        public CliTempo_visitaPageDTO build() {
            CliTempo_visitaPageDTO result = new CliTempo_visitaPageDTO();
